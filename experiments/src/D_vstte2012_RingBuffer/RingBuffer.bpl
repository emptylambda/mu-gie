...
// Command Line Options: /compile:0 /noVerify /print:RingBuffer.bpl RingBuffer.dfy
...
implementation CheckWellformed$$_module.RingBuffer.Valid(_module.RingBuffer$T: Ty, this: ref)
{
  ...
  var b$reqreads#34: bool;
    ...
    assume {:captureState "RingBuffer.dfy(17,12): initial state"} true;
    ...
    else
    {
             ...
             == read($Heap, this, _module.RingBuffer.N))
        {
            ...
            {
                b$reqreads#9 := $_Frame[this, _module.RingBuffer.len];
                ...
                if (read($Heap, this, _module.RingBuffer.len)
                   ...
                   && read($Heap, this, _module.RingBuffer.start) == LitInt(0))
                {
                    b$reqreads#12 := $_Frame[this, _module.RingBuffer.Contents];
                }
            }
        }
        ...
        if (read($Heap, this, _module.RingBuffer.Repr)[$Box(this)]
           ...
           && (read($Heap, this, _module.RingBuffer.N) == LitInt(0)
             ==> read($Heap, this, _module.RingBuffer.len)
               ...
               && Seq#Equal(read($Heap, this, _module.RingBuffer.Contents), Seq#Empty(): Seq Box)))
        {
            b$reqreads#13 := $_Frame[this, _module.RingBuffer.N];
            if (read($Heap, this, _module.RingBuffer.N) != 0)
            {
                b$reqreads#14 := $_Frame[this, _module.RingBuffer.len];
                b$reqreads#15 := $_Frame[this, _module.RingBuffer.N];
                if (read($Heap, this, _module.RingBuffer.len)
                   <= read($Heap, this, _module.RingBuffer.N))
                {
                    b$reqreads#16 := $_Frame[this, _module.RingBuffer.start];
                    b$reqreads#17 := $_Frame[this, _module.RingBuffer.N];
                }
            }
        }
           ...
           && (read($Heap, this, _module.RingBuffer.N) != 0
             ==> read($Heap, this, _module.RingBuffer.len)
               ...
               && read($Heap, this, _module.RingBuffer.start)
                 < read($Heap, this, _module.RingBuffer.N)))
        {
            b$reqreads#18 := $_Frame[this, _module.RingBuffer.Contents];
            b$reqreads#19 := $_Frame[this, _module.RingBuffer.start];
            b$reqreads#20 := $_Frame[this, _module.RingBuffer.len];
            b$reqreads#21 := $_Frame[this, _module.RingBuffer.N];
            if (read($Heap, this, _module.RingBuffer.start)
                 + read($Heap, this, _module.RingBuffer.len)
               <= read($Heap, this, _module.RingBuffer.N))
            {
                b$reqreads#22 := $_Frame[this, _module.RingBuffer.data];
                assert read($Heap, this, _module.RingBuffer.data) != null;
                ...
                b$reqreads#25 := $_Frame[this, _module.RingBuffer.len];
            ...
            {
                b$reqreads#27 := $_Frame[this, _module.RingBuffer.data];
                assert read($Heap, this, _module.RingBuffer.data) != null;
                b$reqreads#28 := $_Frame[this, _module.RingBuffer.start];
                assert 0 <= read($Heap, this, _module.RingBuffer.start)
                   && read($Heap, this, _module.RingBuffer.start)
                     <= _System.array.Length(read($Heap, this, _module.RingBuffer.data));
                b$reqreads#29 := (forall $i: int ::
                  { $_Frame[read($Heap, this, _module.RingBuffer.data), IndexField($i)] }
                  read($Heap, this, _module.RingBuffer.start) <= $i
                       && $i < _System.array.Length(read($Heap, this, _module.RingBuffer.data))
                     ==> $_Frame[read($Heap, this, _module.RingBuffer.data), IndexField($i)]);
                b$reqreads#30 := $_Frame[this, _module.RingBuffer.data];
                assert read($Heap, this, _module.RingBuffer.data) != null;
                b$reqreads#31 := $_Frame[this, _module.RingBuffer.start];
                b$reqreads#32 := $_Frame[this, _module.RingBuffer.len];
                b$reqreads#33 := $_Frame[this, _module.RingBuffer.N];
                assert 0
                     <= read($Heap, this, _module.RingBuffer.start)
                         + read($Heap, this, _module.RingBuffer.len)
                       - read($Heap, this, _module.RingBuffer.N)
...
implementation Impl$$_module.RingBuffer.Create(_module.RingBuffer$T: Ty, n#0: int) returns (this: ref, $_reverifyPost: bool)
{
  ...
  var $rhs#3: int where LitInt(0) <= $rhs#3;
    ...
    assume {:captureState "RingBuffer.dfy(32,2): initial state"} true;
    $_reverifyPost := false;
    // ----- divided block before new; ----- RingBuffer.dfy(32,3)
    // ----- assignment statement ----- RingBuffer.dfy(33,10)
    assume true;
    assert 0 <= n#0;
    havoc $nw;
    assume $nw != null
    ...
    this.data := $nw;
    assume {:captureState "RingBuffer.dfy(33,20)"} true;
    // ----- assignment statement ----- RingBuffer.dfy(34,10)
    assume true;
    assume true;
    this.Repr := Set#UnionOne(Set#UnionOne(Set#Empty(): Set Box, $Box(this)), $Box(this.data));
    assume {:captureState "RingBuffer.dfy(34,24)"} true;
    // ----- update statement ----- RingBuffer.dfy(35,16)
    assume true;
    $obj0 := this;
    assume true;
    $obj1 := this;
    ...
    this.start := $rhs#0;
    this.len := $rhs#1;
    assume {:captureState "RingBuffer.dfy(35,22)"} true;
    // ----- update statement ----- RingBuffer.dfy(36,17)
    assume true;
    $obj0 := this;
    assume true;
    $obj1 := this;
    ...
    this.Contents := $rhs#2;
    this.N := $rhs#3;
    assume {:captureState "RingBuffer.dfy(36,24)"} true;
    // ----- new; ----- RingBuffer.dfy(32,3)
    assume this != null
       &&
    ...
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    // ----- divided block after new; ----- RingBuffer.dfy(32,3)
}
...
implementation CheckWellformed$$_module.RingBuffer.Clear(_module.RingBuffer$T: Ty, this: ref)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "RingBuffer.dfy(39,9): initial state"} true;
    ...
    assume {:captureState "RingBuffer.dfy(42,20): post-state"} true;
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
...
implementation Impl$$_module.RingBuffer.Clear(_module.RingBuffer$T: Ty, this: ref) returns ($_reverifyPost: bool)
{
  ...
  var $rhs#1: Seq Box where $Is($rhs#1, TSeq(_module.RingBuffer$T));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.RingBuffer.Repr)[$Box($o)]);
    assume {:captureState "RingBuffer.dfy(44,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- RingBuffer.dfy(45,9)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "RingBuffer.dfy(45,12)"} true;
    // ----- assignment statement ----- RingBuffer.dfy(46,14)
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "RingBuffer.dfy(46,18)"} true;
}
...
implementation CheckWellformed$$_module.RingBuffer.Head(_module.RingBuffer$T: Ty, this: ref) returns (x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "RingBuffer.dfy(49,9): initial state"} true;
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assume !Seq#Equal(read($Heap, this, _module.RingBuffer.Contents), Seq#Empty(): Seq Box);
    havoc $Heap;
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc x#0;
    assume {:captureState "RingBuffer.dfy(52,14): post-state"} true;
    assert 0 <= LitInt(0)
...
implementation Impl$$_module.RingBuffer.Head(_module.RingBuffer$T: Ty, this: ref) returns (x#0: Box, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "RingBuffer.dfy(53,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- RingBuffer.dfy(54,7)
    assume true;
    assert read($Heap, this, _module.RingBuffer.data) != null;
    assert 0 <= read($Heap, this, _module.RingBuffer.start)
       && read($Heap, this, _module.RingBuffer.start)
    ...
    assume {:captureState "RingBuffer.dfy(54,20)"} true;
}
...
implementation CheckWellformed$$_module.RingBuffer.Enqueue(_module.RingBuffer$T: Ty, this: ref, x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.RingBuffer.Repr)[$Box($o)]);
    assume {:captureState "RingBuffer.dfy(57,9): initial state"} true;
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    ...
    assume (forall<alpha> $o: ref, $f: Field alpha ::
      ...
      $o != null && read(old($Heap), $o, alloc)
         ==> read($Heap, $o, $f) == read(old($Heap), $o, $f)
           || read(old($Heap), this, _module.RingBuffer.Repr)[$Box($o)]);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "RingBuffer.dfy(61,20): post-state"} true;
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assert $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume (forall $o: ref ::
...
implementation Impl$$_module.RingBuffer.Enqueue(_module.RingBuffer$T: Ty, this: ref, x#0: Box) returns ($_reverifyPost: bool)
{
  ...
  var $rhs#2: Seq Box where $Is($rhs#2, TSeq(_module.RingBuffer$T));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.RingBuffer.Repr)[$Box($o)]);
    assume {:captureState "RingBuffer.dfy(63,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- RingBuffer.dfy(64,19)
    assume true;
    assert read($Heap, this, _module.RingBuffer.data) != null;
    if (read($Heap, this, _module.RingBuffer.start)
         + read($Heap, this, _module.RingBuffer.len)
    ...
    nextEmpty#0 := (if read($Heap, this, _module.RingBuffer.start)
       ...
       then read($Heap, this, _module.RingBuffer.start)
         + read($Heap, this, _module.RingBuffer.len)
           ...
           + read($Heap, this, _module.RingBuffer.len)
         - _System.array.Length(read($Heap, this, _module.RingBuffer.data)));
    assume {:captureState "RingBuffer.dfy(65,68)"} true;
    // ----- assignment statement ----- RingBuffer.dfy(66,21)
    assert read($Heap, this, _module.RingBuffer.data) != null;
    ...
    $Heap := update($Heap,
      ...
      $rhs#0);
    assume $IsGoodHeap($Heap);
    assume {:captureState "RingBuffer.dfy(66,24)"} true;
    // ----- assignment statement ----- RingBuffer.dfy(67,9)
    assume true;
    assert $_Frame[this, _module.RingBuffer.len];
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "RingBuffer.dfy(67,18)"} true;
    // ----- assignment statement ----- RingBuffer.dfy(68,14)
    assume true;
    assert $_Frame[this, _module.RingBuffer.Contents];
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "RingBuffer.dfy(68,30)"} true;
}
...
implementation CheckWellformed$$_module.RingBuffer.Dequeue(_module.RingBuffer$T: Ty, this: ref) returns (x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.RingBuffer.Repr)[$Box($o)]);
    assume {:captureState "RingBuffer.dfy(71,9): initial state"} true;
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assume !Seq#Equal(read($Heap, this, _module.RingBuffer.Contents), Seq#Empty(): Seq Box);
    havoc $Heap;
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc x#0;
    assume {:captureState "RingBuffer.dfy(75,20): post-state"} true;
    assume _module.RingBuffer.Valid#canCall(_module.RingBuffer$T, $Heap, this);
    assume _module.RingBuffer.Valid(_module.RingBuffer$T, $Heap, this);
    assert $IsAlloc(this, Tclass._module.RingBuffer(_module.RingBuffer$T), old($Heap));
    assume (forall $o: ref ::
...
implementation Impl$$_module.RingBuffer.Dequeue(_module.RingBuffer$T: Ty, this: ref) returns (x#0: Box, $_reverifyPost: bool)
{
  ...
  var $rhs#2: Seq Box where $Is($rhs#2, TSeq(_module.RingBuffer$T));
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc)
         ==> read($Heap, this, _module.RingBuffer.Repr)[$Box($o)]);
    assume {:captureState "RingBuffer.dfy(77,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- RingBuffer.dfy(78,7)
    assume true;
    assert read($Heap, this, _module.RingBuffer.data) != null;
    assert 0 <= read($Heap, this, _module.RingBuffer.start)
       && read($Heap, this, _module.RingBuffer.start)
    ...
    x#0 := read($Heap,
      read($Heap, this, _module.RingBuffer.data),
      IndexField(read($Heap, this, _module.RingBuffer.start)));
    assume {:captureState "RingBuffer.dfy(78,20)"} true;
    // ----- assert statement ----- RingBuffer.dfy(78,24)
    assert {:subsumption 0} 0 <= LitInt(0)
       && LitInt(0) < Seq#Length(read($Heap, this, _module.RingBuffer.Contents));
    assume true;
    assert x#0 == Seq#Index(read($Heap, this, _module.RingBuffer.Contents), LitInt(0));
    // ----- update statement ----- RingBuffer.dfy(79,16)
    assume true;
    $obj0 := this;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "RingBuffer.dfy(79,76)"} true;
    // ----- assignment statement ----- RingBuffer.dfy(80,14)
    assume true;
    assert $_Frame[this, _module.RingBuffer.Contents];
    assert 0 <= LitInt(1)
    ...
    $Heap := update($Heap, this, _module.RingBuffer.Contents, $rhs#2);
    assume $IsGoodHeap($Heap);
    assume {:captureState "RingBuffer.dfy(80,29)"} true;
}
...
implementation Impl$$_module.__default.TestHarness(x#0: int, y#0: int, z#0: int) returns ($_reverifyPost: bool)
{
  ...
  var $tmp##2: Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "RingBuffer.dfy(85,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- RingBuffer.dfy(86,9)
    assume true;
    // ----- init call statement ----- RingBuffer.dfy(86,27)
    ...
    assume {:captureState "RingBuffer.dfy(86,35)"} true;
    b#0 := $nw;
    assume {:captureState "RingBuffer.dfy(86,35)"} true;
    // ----- call statement ----- RingBuffer.dfy(87,12)
    // TrCallStmt: Before ProcessCallStmt
    assert b#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "RingBuffer.dfy(87,14)"} true;
    // ----- call statement ----- RingBuffer.dfy(88,12)
    // TrCallStmt: Before ProcessCallStmt
    assert b#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "RingBuffer.dfy(88,14)"} true;
    // ----- call statement ----- RingBuffer.dfy(89,21)
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    h#0 := $rhs##0;
    assume {:captureState "RingBuffer.dfy(89,22)"} true;
    // ----- assert statement ----- RingBuffer.dfy(89,26)
    assume true;
    assert h#0 == x#0;
    // ----- call statement ----- RingBuffer.dfy(90,12)
    // TrCallStmt: Before ProcessCallStmt
    assert b#0 != null;
    assume true;
    // ProcessCallStmt: CheckSubrange
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "RingBuffer.dfy(90,14)"} true;
    // ----- call statement ----- RingBuffer.dfy(91,17)
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    h#0 := $rhs##1;
    assume {:captureState "RingBuffer.dfy(91,18)"} true;
    // ----- assert statement ----- RingBuffer.dfy(91,22)
    assume true;
    assert h#0 == y#0;
    // ----- call statement ----- RingBuffer.dfy(92,17)
    assume true;
    // TrCallStmt: Adding lhs Microsoft.Dafny.IdentifierExpr with type int
    // TrCallStmt: Before ProcessCallStmt
    assert b#0 != null;
    ...
    // TrCallStmt: After ProcessCallStmt
    h#0 := $rhs##2;
    assume {:captureState "RingBuffer.dfy(92,18)"} true;
    // ----- assert statement ----- RingBuffer.dfy(92,22)
    assume true;
    assert h#0 == z#0;
}
