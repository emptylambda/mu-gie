...
// Command Line Options: /compile:0 /noVerify /print:Two-Way-Sort.bpl Two-Way-Sort.dfy
...
implementation CheckWellformed$$_module.__default.swap(_module._default.swap$T: Ty, a#0: ref, i#0: int, j#0: int)
{
  ...
  var m#0: int;
    ...
    assume {:captureState "Two-Way-Sort.dfy(7,7): initial state"} true;
    assume a#0 != null;
    if (LitInt(0) <= i#0)
    {
    }
    ...
    assume (forall<alpha> $o: ref, $f: Field alpha ::
      { read($Heap, $o, $f) }
      $o != null && read(old($Heap), $o, alloc)
         ==> read($Heap, $o, $f) == read(old($Heap), $o, $f) || $o == a#0);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "Two-Way-Sort.dfy(11,15): post-state"} true;
    assert a#0 != null;
   ...
   returns ($_reverifyPost: bool)
{
  ...
  var $rhs#1: Box where $IsBox($rhs#1, _module._default.swap$T);
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == a#0);
    assume {:captureState "Two-Way-Sort.dfy(15,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- Two-Way-Sort.dfy(16,9)
    assume true;
    assert a#0 != null;
    assert 0 <= i#0 && i#0 < _System.array.Length(a#0);
    assume true;
    t#0 := read($Heap, a#0, IndexField(i#0));
    assume {:captureState "Two-Way-Sort.dfy(16,15)"} true;
    // ----- assignment statement ----- Two-Way-Sort.dfy(17,8)
    assert a#0 != null;
    assert 0 <= i#0 && i#0 < _System.array.Length(a#0);
    assume true;
    ...
    assume {:captureState "Two-Way-Sort.dfy(17,14)"} true;
    // ----- assignment statement ----- Two-Way-Sort.dfy(18,8)
    assert a#0 != null;
    assert 0 <= j#0 && j#0 < _System.array.Length(a#0);
    assume true;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Two-Way-Sort.dfy(18,11)"} true;
}
...
implementation CheckWellformed$$_module.__default.two__way__sort(a#0: ref)
{
  ...
  var n#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == a#0);
    assume {:captureState "Two-Way-Sort.dfy(37,7): initial state"} true;
    assume a#0 != null;
    havoc $Heap;
    assume (forall<alpha> $o: ref, $f: Field alpha ::
      { read($Heap, $o, $f) }
      $o != null && read(old($Heap), $o, alloc)
         ==> read($Heap, $o, $f) == read(old($Heap), $o, $f) || $o == a#0);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "Two-Way-Sort.dfy(40,10): post-state"} true;
    havoc m#0;
    havoc n#0;
    if (*)
    {
...
procedure Call$$_module.__default.two__way__sort(a#0: ref
  ...
  modifies $Heap, $Tick;
  // user-defined postconditions
  free ensures (forall m#1: int, n#1: int ::
    { $Unbox(read($Heap, a#0, IndexField(n#1))): bool, $Unbox(read($Heap, a#0, IndexField(m#1))): bool }
    true);
...
implementation Impl$$_module.__default.two__way__sort(a#0: ref) returns ($_reverifyPost: bool)
{
  ...
  var j##0_0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == a#0);
    assume {:captureState "Two-Way-Sort.dfy(42,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- Two-Way-Sort.dfy(43,9)
    assume true;
    assume true;
    i#0 := LitInt(0);
    assume {:captureState "Two-Way-Sort.dfy(43,12)"} true;
    // ----- assignment statement ----- Two-Way-Sort.dfy(44,9)
    assume true;
    assert a#0 != null;
    assume true;
    j#0 := _System.array.Length(a#0) - 1;
    assume {:captureState "Two-Way-Sort.dfy(44,23)"} true;
    // ----- while statement ----- Two-Way-Sort.dfy(45,3)
    ...
    while (true)
      ...
      free invariant $w$loop#0
         ==> (forall m#3: int :: { $Unbox(read($Heap, a#0, IndexField(m#3))): bool } true);
      invariant $w$loop#0
         ==> (forall m#3: int ::
          ...
          true
            ...
            LitInt(0) <= m#3 && m#3 < i#0
             ==> !$Unbox(read($Heap, a#0, IndexField(m#3))): bool);
      free invariant $w$loop#0
         ==> (forall n#3: int :: { $Unbox(read($Heap, a#0, IndexField(n#3))): bool } true);
      invariant $w$loop#0
         ==> (forall n#3: int ::
      ...
      free invariant (forall<alpha> $o: ref, $f: Field alpha ::
        { read($Heap, $o, $f) }
        $o != null && read(old($Heap), $o, alloc)
           ==> read($Heap, $o, $f) == read($PreLoopHeap$loop#0, $o, $f) || $o == a#0);
    ...
    {
        assume {:captureState "Two-Way-Sort.dfy(45,2): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            if (LitInt(0) <= i#0)
            {
            ...
            assume (forall m#3: int :: { $Unbox(read($Heap, a#0, IndexField(m#3))): bool } true);
            ...
            // End Comprehension WF check
            assume (forall n#3: int :: { $Unbox(read($Heap, a#0, IndexField(n#3))): bool } true);
        ...
        // ----- if statement ----- Two-Way-Sort.dfy(51,5)
        assert a#0 != null;
        assert 0 <= i#0 && i#0 < _System.array.Length(a#0);
        assume true;
        if (!$Unbox(read($Heap, a#0, IndexField(i#0))): bool)
        {
            // ----- assignment statement ----- Two-Way-Sort.dfy(52,9)
            assume true;
            assume true;
            i#0 := i#0 + 1;
            assume {:captureState "Two-Way-Sort.dfy(52,14)"} true;
        }
        else
        {
            // ----- if statement ----- Two-Way-Sort.dfy(53,12)
            assert a#0 != null;
            assert 0 <= j#0 && j#0 < _System.array.Length(a#0);
            assume true;
            if ($Unbox(read($Heap, a#0, IndexField(j#0))): bool)
            {
                // ----- assignment statement ----- Two-Way-Sort.dfy(54,9)
                assume true;
                assume true;
                j#0 := j#0 - 1;
                assume {:captureState "Two-Way-Sort.dfy(54,14)"} true;
            }
            else
            {
                // ----- call statement ----- Two-Way-Sort.dfy(56,11)
                ...
                assume {:captureState "Two-Way-Sort.dfy(56,19)"} true;
                // ----- assignment statement ----- Two-Way-Sort.dfy(57,9)
                assume true;
                assume true;
                i#0 := i#0 + 1;
                assume {:captureState "Two-Way-Sort.dfy(57,14)"} true;
                // ----- assignment statement ----- Two-Way-Sort.dfy(58,9)
                assume true;
                assume true;
                j#0 := j#0 - 1;
                assume {:captureState "Two-Way-Sort.dfy(58,14)"} true;
            }
        }

        // ----- loop termination check ----- Two-Way-Sort.dfy(45,3)
