// Automatically generated (12/12/2017 1:54:30.836 PM)
...
const unique BINARY_SEARCH: Type;

axiom ((BINARY_SEARCH) <: (ANY));

axiom ((forall t: Type :: { (BINARY_SEARCH) <: (t) } ((BINARY_SEARCH) <: (t)) <==> (((t) == (BINARY_SEARCH)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, BINARY_SEARCH)) == (-1));

axiom ((FieldId(closed, BINARY_SEARCH)) == (-2));

axiom ((FieldId(owner, BINARY_SEARCH)) == (-3));

axiom ((FieldId(owns, BINARY_SEARCH)) == (-4));

axiom ((FieldId(observers, BINARY_SEARCH)) == (-5));

axiom ((FieldId(subjects, BINARY_SEARCH)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, BINARY_SEARCH) } (IsModelField($f, BINARY_SEARCH)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } BINARY_SEARCH.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, BINARY_SEARCH)) ==> ((user_inv(heap, current)) <==> (BINARY_SEARCH.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, BINARY_SEARCH)) ==> ((user_inv(heap, current)) ==> (BINARY_SEARCH.user_inv(heap, current)))));

procedure BINARY_SEARCH.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, BINARY_SEARCH);



implementation BINARY_SEARCH.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.BINARY_SEARCH.default_create(Current: ref);
  free requires attached_exact(Heap, Current, BINARY_SEARCH); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.BINARY_SEARCH.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.BINARY_SEARCH.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.BINARY_SEARCH.default_create"} true;
  if (*) {
...
procedure BINARY_SEARCH.test_binary_search(Current: ref);
  free requires attached_exact(Heap, Current, BINARY_SEARCH); // info:type property for argument Current
  modifies Heap;
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH.test_binary_search(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH.test_binary_search(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.BINARY_SEARCH.test_binary_search.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation BINARY_SEARCH.test_binary_search(Current: ref)
{
  var temp_1: ref;
  var temp_2: int;
  var temp_3: int;
  var temp_4: int;
  var temp_5: int;
  var local1: ref where detachable_exact(Heap, local1, SIMPLE_ARRAY^INTEGER_32^);
  ...
  entry:
  assume {:captureState "BINARY_SEARCH.test_binary_search"} true;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:17
  // create a.init (<<-3, 5, 9, 22, 104, 105, 107, 213>>)
  call temp_1 := allocate(SIMPLE_ARRAY^INTEGER_32^); // line:-1
  call create.SIMPLE_ARRAY^INTEGER_32^.init(temp_1, Seq#Extended(Seq#Extended(Seq#Extended(Seq#Extended(Seq#Extended(Seq#Extended(Seq#Extended(Seq#Singleton(-3), 5), 9), 22), 104), 105), 107), 213)); // line:17 cid:190 rid:3247
  local1 := temp_1;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:19
  // i := binary_search_iterative (a, -3)
  call temp_2 := BINARY_SEARCH.binary_search_iterative(Current, local1, -3); // line:19 cid:404 rid:5402
  local2 := temp_2;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:20
  // check i = 1 end
  assert (local2) == (1); // type:check line:20
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:21
  // i := binary_search_recursive (a, 22)
  call temp_3 := BINARY_SEARCH.binary_search_recursive(Current, local1, 22); // line:21 cid:404 rid:5403
  local2 := temp_3;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:22
  // check i = 4 end
  assert (local2) == (4); // type:check line:22
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:23
  // i := binary_search_iterative (a, 56)
  call temp_4 := BINARY_SEARCH.binary_search_iterative(Current, local1, 56); // line:23 cid:404 rid:5402
  local2 := temp_4;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:24
  // check i = 0 end
  assert (local2) == (0); // type:check line:24
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:25
  // i := binary_search_recursive (a, 400)
  call temp_5 := BINARY_SEARCH.binary_search_recursive(Current, local1, 400); // line:25 cid:404 rid:5403
  local2 := temp_5;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:26
  // check i = 0 end
  assert (local2) == (0); // type:check line:26
}

procedure BINARY_SEARCH.binary_search_iterative(Current: ref, a: ref, value: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, BINARY_SEARCH); // info:type property for argument Current
  ...
  modifies Heap;
  requires (a) != (Void); // type:attached tag:no_overflow line:37
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:37 cid:190 rid:3249
  requires (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) < (2147483647); // type:pre tag:no_overflow line:37
  requires fun.BINARY_SEARCH.is_sorted(Heap, Current, Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence]); // type:pre tag:a_sorted line:38
  ensures (a) != (Void); // type:attached tag:present line:66
  ensures (Seq#Has(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value)) == ((Result) > (0)); // type:post tag:present line:66
  ensures (!(Seq#Has(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value))) == ((Result) == (0)); // type:post tag:not_present line:67
  ensures ((Result) > (0)) ==> ((a) != (Void)); // type:attached tag:found_if_present line:68
  ensures ((Result) > (0)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)); // type:check tag:function_precondition line:68 cid:125 rid:3286
  ensures ((Result) > (0)) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)) == (value)); // type:post tag:found_if_present line:68
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH.binary_search_iterative(Heap, Current, a, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH.binary_search_iterative(old(Heap), Current, a, value));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
function { :inline } variant.BINARY_SEARCH.binary_search_iterative.1(heap: HeapType, current: ref, a: ref, value: int) returns (ref) {
  a
}

function { :inline } variant.BINARY_SEARCH.binary_search_iterative.2(heap: HeapType, current: ref, a: ref, value: int) returns (int) {
  value
}

implementation BINARY_SEARCH.binary_search_iterative(Current: ref, a: ref, value: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "BINARY_SEARCH.binary_search_iterative"} true;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:43
  // low := 1
  local1 := 1;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:44
  // up := a.count + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:44
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:44 cid:190 rid:3249
  assert {:subsumption 0} is_integer_32((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)); // type:overflow line:44
  local2 := (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1);
  PreLoopHeap_9 := Heap;
  goto loop_head_6;
  loop_head_6:
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:46
  // low_and_up_range: 1 <= low and low <= up and up <= a.sequence.count + 1
  assert {:subsumption 0} (a) != (Void); // type:attached line:46
  assert {:subsumption 0} is_integer_32((Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])) + (1)); // type:overflow line:46
  assert ((1) <= (local1)) && ((local1) <= (local2)) && ((local2) <= ((Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])) + (1))); // type:loop_inv tag:low_and_up_range line:46
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:47
  // result_range: Result = 0 or 1 <= Result and Result <= a.sequence.count
  assert {:subsumption 0} (a) != (Void); // type:attached line:47
  assert ((Result) == (0)) || (((1) <= (Result)) && ((Result) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))); // type:loop_inv tag:result_range line:47
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:48
  // not_in_lower_part: across 1 |..| (low-1) as i all a.sequence[i.item] < value end
  assert {:subsumption 0} is_integer_32((local1) - (1)); // type:overflow line:48
  assert {:subsumption 0} (a) != (Void); // type:attached line:48
  assert (forall i_10: int :: (((1) <= (i_10)) && ((i_10) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10))); // type:check tag:function_precondition line:48 cid:125 rid:3286
  assert (forall i_10: int :: (((1) <= (i_10)) && ((i_10) <= ((local1) - (1)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10)) < (value))); // type:loop_inv tag:not_in_lower_part line:48
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:49
  // not_in_upper_part: across up |..| a.sequence.count as i all value < a.sequence[i.item] end
  assert {:subsumption 0} (a) != (Void); // type:attached line:49
  assert {:subsumption 0} (a) != (Void); // type:attached line:49
  assert (forall i_11: int :: (((local2) <= (i_11)) && ((i_11) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_11))); // type:check tag:function_precondition line:49 cid:125 rid:3286
  assert (forall i_11: int :: (((local2) <= (i_11)) && ((i_11) <= (Seq#Length(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])))) ==> ((value) < (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_11)))); // type:loop_inv tag:not_in_upper_part line:49
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:50
  // found: Result > 0 implies a.sequence[Result] = value
  assert {:subsumption 0} ((Result) > (0)) ==> ((a) != (Void)); // type:attached line:50
  assert ((Result) > (0)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)); // type:check tag:function_precondition line:50 cid:125 rid:3286
  assert ((Result) > (0)) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)) == (value)); // type:loop_inv tag:found line:50
  assume HeapSucc(PreLoopHeap_9, Heap);
  assume same_outside(old(Heap), Heap, modify.BINARY_SEARCH.binary_search_iterative(old(Heap), Current, a, value));
  assume global(Heap);
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:-1
  goto loop_body_7, loop_end_8;
  loop_body_7:
  assume !(((local1) >= (local2)) || ((Result) > (0)));
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:63
  // (a.count - Result) + (up - low)
  variant_12 := ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1));
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:54
  // middle := low + ((up - low) // 2)
  assert {:subsumption 0} is_integer_32((local2) - (local1)); // type:overflow line:54
  assert {:subsumption 0} is_integer_32((local1) + (((local2) - (local1)) div (2))); // type:overflow line:54
  local3 := (local1) + (((local2) - (local1)) div (2));
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:55
  // if a[middle] < value then
  assert {:subsumption 0} (a) != (Void); // type:attached line:55
  call temp_13 := SIMPLE_ARRAY^INTEGER_32^.item(a, local3); // line:55 cid:190 rid:3250
  if ((temp_13) < (value)) {
    // /home/caf/temp/comcom/repo-binary_search/binary_search.e:56
    // low := middle + 1
    assert {:subsumption 0} is_integer_32((local3) + (1)); // type:overflow line:56
    local1 := (local3) + (1);
  } else {
    // /home/caf/temp/comcom/repo-binary_search/binary_search.e:57
    // elseif a[middle] > value then
    assert {:subsumption 0} (a) != (Void); // type:attached line:57
    call temp_14 := SIMPLE_ARRAY^INTEGER_32^.item(a, local3); // line:57 cid:190 rid:3250
    if ((temp_14) > (value)) {
      // /home/caf/temp/comcom/repo-binary_search/binary_search.e:58
      // up := middle
      local2 := local3;
    } else {
      // /home/caf/temp/comcom/repo-binary_search/binary_search.e:60
      // Result := middle
      Result := local3;
    }
  }
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:63
  // (a.count - Result) + (up - low)
  assert {:subsumption 0} (((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1))) <= (variant_12)) && ((variant_12) <= (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1))))) || ((0) <= (variant_12)); // type:termination tag:bounded line:63 varid:1
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1))) <= (variant_12)) && (!((variant_12) <= (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (Result)) + ((local2) - (local1))))); // type:termination tag:variant_decreases line:63
  goto loop_head_6;
  loop_end_8:
  assume ((local1) >= (local2)) || ((Result) > (0));
}

procedure BINARY_SEARCH.binary_search_recursive(Current: ref, a: ref, value: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, BINARY_SEARCH); // info:type property for argument Current
  free requires detachable_exact(Heap, a, SIMPLE_ARRAY^INTEGER_32^); // info:type property for argument a
  free requires is_integer_32(value); // info:type property for argument value
  modifies Heap;
  requires (a) != (Void); // type:attached tag:no_overflow line:75
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:75 cid:190 rid:3249
  requires (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) < (2147483647); // type:pre tag:no_overflow line:75
  requires fun.BINARY_SEARCH.is_sorted(Heap, Current, Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence]); // type:pre line:76
  ensures (a) != (Void); // type:attached tag:present line:84
  ensures (Seq#Has(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value)) == ((Result) > (0)); // type:post tag:present line:84
  ensures (!(Seq#Has(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value))) == ((Result) == (0)); // type:post tag:not_present line:85
  ensures ((Result) > (0)) ==> ((a) != (Void)); // type:attached tag:found_if_present line:86
  ensures ((Result) > (0)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)); // type:check tag:function_precondition line:86 cid:125 rid:3286
  ensures ((Result) > (0)) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)) == (value)); // type:post tag:found_if_present line:86
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH.binary_search_recursive(Heap, Current, a, value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH.binary_search_recursive(old(Heap), Current, a, value));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH.binary_search_recursive(Heap, Current, a, value), readable);
  ...
  free ensures (Result) == (fun.BINARY_SEARCH.binary_search_recursive(old(Heap), Current, a, value));



function fun.BINARY_SEARCH.binary_search_recursive(heap: HeapType, current: ref, a: ref, value: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: { fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value) } (pre.fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value)) ==> (((Seq#Has(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value)) == ((fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value)) > (0))) && ((!(Seq#Has(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], value))) == ((fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value)) == (0))) && (((fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value)) > (0)) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value))) == (value))) && (is_integer_32(fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref, value: int :: { HeapSucc(h, h'), fun.BINARY_SEARCH.binary_search_recursive(h, current, a, value), fun.BINARY_SEARCH.binary_search_recursive(h', current, a, value) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH.binary_search_recursive(h, current, a, value)) && (pre.fun.BINARY_SEARCH.binary_search_recursive(h', current, a, value)) && (same_inside(h, h', read.fun.BINARY_SEARCH.binary_search_recursive(h, current, a, value)))) ==> ((fun.BINARY_SEARCH.binary_search_recursive(h, current, a, value)) == (fun.BINARY_SEARCH.binary_search_recursive(h', current, a, value)))));

function { :inline } variant.BINARY_SEARCH.binary_search_recursive.1(heap: HeapType, current: ref, a: ref, value: int) returns (ref) {
  a
}

function { :inline } variant.BINARY_SEARCH.binary_search_recursive.2(heap: HeapType, current: ref, a: ref, value: int) returns (int) {
  value
}

implementation BINARY_SEARCH.binary_search_recursive(Current: ref, a: ref, value: int) returns (Result: int)
{
  var temp_15: int;
  ...
  entry:
  assume {:captureState "BINARY_SEARCH.binary_search_recursive"} true;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:78
  // if a.count > 0 then
  assert {:subsumption 0} (a) != (Void); // type:attached line:78
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:78 cid:190 rid:3249
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:78 cid:190 rid:3249
  if ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) > (0)) {
    // /home/caf/temp/comcom/repo-binary_search/binary_search.e:79
    // Result := binary_search_recursive_step (a, value, 1, a.count)
    assert {:subsumption 0} (a) != (Void); // type:attached line:79
    assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:79 cid:190 rid:3249
    assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:79 cid:190 rid:3249
    assert Frame#Subset(read.fun.BINARY_SEARCH.binary_search_recursive_step(Heap, Current, a, value, 1, fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)), readable); // type:access tag:frame_readable line:79 cid:404 rid:5404
    call temp_15 := BINARY_SEARCH.binary_search_recursive_step(Current, a, value, 1, fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)); // line:79 cid:404 rid:5404
    Result := temp_15;
  } else {
    // /home/caf/temp/comcom/repo-binary_search/binary_search.e:81
    // Result := 0
    Result := 0;
  }
}

procedure BINARY_SEARCH.binary_search_recursive_step(Current: ref, a: ref, value: int, lower: int, upper: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, BINARY_SEARCH); // info:type property for argument Current
  free requires detachable_exact(Heap, a, SIMPLE_ARRAY^INTEGER_32^); // info:type property for argument a
  free requires is_integer_32(value); // info:type property for argument value
  ...
  modifies Heap;
  requires (a) != (Void); // type:attached tag:no_overflow line:92
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:92 cid:190 rid:3249
  requires (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) < (2147483647); // type:pre tag:no_overflow line:92
  requires fun.BINARY_SEARCH.is_sorted(Heap, Current, Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence]); // type:pre tag:sorted line:93
  requires is_integer_32((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)); // type:overflow tag:lower_in_bounds line:94
  requires ((1) <= (lower)) && ((lower) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))); // type:pre tag:lower_in_bounds line:94
  requires ((0) <= (upper)) && ((upper) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))); // type:pre tag:upper_in_bounds line:95
  ensures (a) != (Void); // type:attached tag:present line:116
  ensures (Seq#Has(Seq#Interval(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], lower, upper), value)) == ((Result) > (0)); // type:post tag:present line:116
  ensures (!(Seq#Has(Seq#Interval(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], lower, upper), value))) == ((Result) == (0)); // type:post tag:not_present line:117
  ensures ((Result) > (0)) ==> ((a) != (Void)); // type:attached tag:found_if_present line:118
  ensures ((Result) > (0)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)); // type:check tag:function_precondition line:118 cid:125 rid:3286
  ensures ((Result) > (0)) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], Result)) == (value)); // type:post tag:found_if_present line:118
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH.binary_search_recursive_step(Heap, Current, a, value, lower, upper), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH.binary_search_recursive_step(old(Heap), Current, a, value, lower, upper));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH.binary_search_recursive_step(Heap, Current, a, value, lower, upper), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  requires is_closed(Heap, a); // type:pre tag:arg_a_is_closed default:contracts
  free ensures (Result) == (fun.BINARY_SEARCH.binary_search_recursive_step(old(Heap), Current, a, value, lower, upper));



function fun.BINARY_SEARCH.binary_search_recursive_step(heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int :: { fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper) } (pre.fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper)) ==> (((Seq#Has(Seq#Interval(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], lower, upper), value)) == ((fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper)) > (0))) && ((!(Seq#Has(Seq#Interval(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], lower, upper), value))) == ((fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper)) == (0))) && (((fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper)) > (0)) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper))) == (value))) && (is_integer_32(fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref, value: int, lower: int, upper: int :: { HeapSucc(h, h'), fun.BINARY_SEARCH.binary_search_recursive_step(h, current, a, value, lower, upper), fun.BINARY_SEARCH.binary_search_recursive_step(h', current, a, value, lower, upper) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH.binary_search_recursive_step(h, current, a, value, lower, upper)) && (pre.fun.BINARY_SEARCH.binary_search_recursive_step(h', current, a, value, lower, upper)) && (same_inside(h, h', read.fun.BINARY_SEARCH.binary_search_recursive_step(h, current, a, value, lower, upper)))) ==> ((fun.BINARY_SEARCH.binary_search_recursive_step(h, current, a, value, lower, upper)) == (fun.BINARY_SEARCH.binary_search_recursive_step(h', current, a, value, lower, upper)))));

function { :inline } variant.BINARY_SEARCH.binary_search_recursive_step.1(heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int) returns (int) {
  (upper) - (lower)
}

implementation BINARY_SEARCH.binary_search_recursive_step(Current: ref, a: ref, value: int, lower: int, upper: int) returns (Result: int)
{
  var temp_16: int;
  var temp_17: int;
  var temp_18: int;
  ...
  entry:
  assume {:captureState "BINARY_SEARCH.binary_search_recursive_step"} true;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:101
  // if lower > upper then
  if ((lower) > (upper)) {
    // /home/caf/temp/comcom/repo-binary_search/binary_search.e:102
    // Result := 0
    Result := 0;
  } else {
    // /home/caf/temp/comcom/repo-binary_search/binary_search.e:104
    // mid := lower + (upper - lower) // 2
    assert {:subsumption 0} is_integer_32((upper) - (lower)); // type:overflow line:104
    assert {:subsumption 0} is_integer_32((lower) + (((upper) - (lower)) div (2))); // type:overflow line:104
    local1 := (lower) + (((upper) - (lower)) div (2));
    // /home/caf/temp/comcom/repo-binary_search/binary_search.e:105
    // if a[mid] = value then
    assert {:subsumption 0} (a) != (Void); // type:attached line:105
    assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:105 cid:190 rid:3250
    call temp_16 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:105 cid:190 rid:3250
    if ((temp_16) == (value)) {
      // /home/caf/temp/comcom/repo-binary_search/binary_search.e:106
      // Result := mid
      Result := local1;
      // /home/caf/temp/comcom/repo-binary_search/binary_search.e:107
      // check a.sequence.interval (lower, upper)[mid - lower + 1] = a.sequence[mid] end
      assert {:subsumption 0} (a) != (Void); // type:attached line:107
      assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:107 cid:190 fid:84
      assert {:subsumption 0} is_integer_32((local1) - (lower)); // type:overflow line:107
      assert {:subsumption 0} is_integer_32(((local1) - (lower)) + (1)); // type:overflow line:107
      assert pre.fun.MML_SEQUENCE^INTEGER_32^.item(Seq#Interval(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], lower, upper), ((local1) - (lower)) + (1)); // type:check tag:function_precondition line:107 cid:125 rid:3286
      assert {:subsumption 0} (a) != (Void); // type:attached line:107
      assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:107 cid:190 fid:84
      assert pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], local1); // type:check tag:function_precondition line:107 cid:125 rid:3286
      assert (Seq#Item(Seq#Interval(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], lower, upper), ((local1) - (lower)) + (1))) == (Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], local1)); // type:check line:107
    } else {
      // /home/caf/temp/comcom/repo-binary_search/binary_search.e:108
      // elseif a[mid] > value then
      assert {:subsumption 0} (a) != (Void); // type:attached line:108
      assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:108 cid:190 rid:3250
      call temp_17 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:108 cid:190 rid:3250
      if ((temp_17) > (value)) {
        // /home/caf/temp/comcom/repo-binary_search/binary_search.e:109
        // Result := binary_search_recursive_step (a, value, lower, mid - 1)
        assert {:subsumption 0} is_integer_32((local1) - (1)); // type:overflow line:109
        assert Frame#Subset(read.fun.BINARY_SEARCH.binary_search_recursive_step(Heap, Current, a, value, lower, (local1) - (1)), readable); // type:access tag:frame_readable line:109 cid:404 rid:5404
        assert {:subsumption 0} (((variant.BINARY_SEARCH.binary_search_recursive_step.1(Heap, Current, a, value, lower, (local1) - (1))) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper))) && ((variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper)) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(Heap, Current, a, value, lower, (local1) - (1))))) || ((0) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper))); // type:termination tag:bounded line:109 varid:1
        assert {:subsumption 0} ((variant.BINARY_SEARCH.binary_search_recursive_step.1(Heap, Current, a, value, lower, (local1) - (1))) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper))) && (!((variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper)) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(Heap, Current, a, value, lower, (local1) - (1))))); // type:termination tag:variant_decreases line:109
        call temp_18 := BINARY_SEARCH.binary_search_recursive_step(Current, a, value, lower, (local1) - (1)); // line:109 cid:404 rid:5404
        Result := temp_18;
        // /home/caf/temp/comcom/repo-binary_search/binary_search.e:110
        // check a.sequence.interval (lower, upper) ~ a.sequence.interval(lower, mid-1) + a.sequence.interval (mid, upper) end
        assert {:subsumption 0} (a) != (Void); // type:attached line:110
        assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:110 cid:190 fid:84
        assert {:subsumption 0} (a) != (Void); // type:attached line:110
        assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:110 cid:190 fid:84
        assert {:subsumption 0} is_integer_32((local1) - (1)); // type:overflow line:110
        assert {:subsumption 0} (a) != (Void); // type:attached line:110
        assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:110 cid:190 fid:84
        assert Seq#Equal(Seq#Interval(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], lower, upper), Seq#Concat(Seq#Interval(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], lower, (local1) - (1)), Seq#Interval(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], local1, upper))); // type:check line:110
      } else {
        // /home/caf/temp/comcom/repo-binary_search/binary_search.e:112
        // Result := binary_search_recursive_step (a, value, mid + 1, upper)
        assert {:subsumption 0} is_integer_32((local1) + (1)); // type:overflow line:112
        assert Frame#Subset(read.fun.BINARY_SEARCH.binary_search_recursive_step(Heap, Current, a, value, (local1) + (1), upper), readable); // type:access tag:frame_readable line:112 cid:404 rid:5404
        assert {:subsumption 0} (((variant.BINARY_SEARCH.binary_search_recursive_step.1(Heap, Current, a, value, (local1) + (1), upper)) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper))) && ((variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper)) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(Heap, Current, a, value, (local1) + (1), upper)))) || ((0) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper))); // type:termination tag:bounded line:112 varid:1
        assert {:subsumption 0} ((variant.BINARY_SEARCH.binary_search_recursive_step.1(Heap, Current, a, value, (local1) + (1), upper)) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper))) && (!((variant.BINARY_SEARCH.binary_search_recursive_step.1(old(Heap), Current, a, value, lower, upper)) <= (variant.BINARY_SEARCH.binary_search_recursive_step.1(Heap, Current, a, value, (local1) + (1), upper)))); // type:termination tag:variant_decreases line:112
        call temp_19 := BINARY_SEARCH.binary_search_recursive_step(Current, a, value, (local1) + (1), upper); // line:112 cid:404 rid:5404
        Result := temp_19;
      }
    }
  }
...
procedure BINARY_SEARCH.is_sorted(Current: ref, s: Seq int) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, BINARY_SEARCH); // info:type property for argument Current
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH.is_sorted(Heap, Current, s), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH.is_sorted(old(Heap), Current, s));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH.is_sorted(Heap, Current, s), readable);



function fun.BINARY_SEARCH.is_sorted(heap: HeapType, current: ref, s: Seq int) returns (bool);

function fun0.BINARY_SEARCH.is_sorted(heap: HeapType, current: ref, s: Seq int) returns (bool);

axiom ((forall heap: HeapType, current: ref, s: Seq int :: { fun.BINARY_SEARCH.is_sorted(heap, current, s) } { trigger.fun.BINARY_SEARCH.is_sorted(heap, current, s) } (pre.fun.BINARY_SEARCH.is_sorted(heap, current, s)) ==> ((fun.BINARY_SEARCH.is_sorted(heap, current, s)) == ((forall i_20: int :: (((1) <= (i_20)) && ((i_20) <= (Seq#Length(s)))) ==> ((forall i_21: int :: (((1) <= (i_21)) && ((i_21) <= (Seq#Length(s)))) ==> (((i_20) <= (i_21)) ==> ((Seq#Item(s, i_20)) <= (Seq#Item(s, i_21)))))))))));

axiom ((forall heap: HeapType, current: ref, s: Seq int :: { fun.BINARY_SEARCH.is_sorted(heap, current, s) } (fun.BINARY_SEARCH.is_sorted(heap, current, s)) == (fun0.BINARY_SEARCH.is_sorted(heap, current, s))));

axiom ((forall h: HeapType, h': HeapType, current: ref, s: Seq int :: { HeapSucc(h, h'), fun0.BINARY_SEARCH.is_sorted(h, current, s), fun0.BINARY_SEARCH.is_sorted(h', current, s) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH.is_sorted(h, current, s)) && (pre.fun.BINARY_SEARCH.is_sorted(h', current, s)) && (same_inside(h, h', read.fun.BINARY_SEARCH.is_sorted(h, current, s)))) ==> ((fun0.BINARY_SEARCH.is_sorted(h, current, s)) == (fun0.BINARY_SEARCH.is_sorted(h', current, s)))));

function { :inline } variant.BINARY_SEARCH.is_sorted.1(heap: HeapType, current: ref, s: Seq int) returns (Seq int) {
  s
}

implementation BINARY_SEARCH.is_sorted(Current: ref, s: Seq int) returns (Result: bool)
{
  ...
  entry:
  assume {:captureState "BINARY_SEARCH.is_sorted"} true;
  // /home/caf/temp/comcom/repo-binary_search/binary_search.e:128
  // Result := across 1 |..| s.count as i all
  assert (forall i_22: int :: (((1) <= (i_22)) && ((i_22) <= (Seq#Length(s)))) ==> ((true) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(s, i_22)))); // type:check tag:function_precondition line:128 cid:125 rid:3286
  assert (forall i_22: int :: (((1) <= (i_22)) && ((i_22) <= (Seq#Length(s)))) ==> ((forall i_23: int :: (((1) <= (i_23)) && ((i_23) <= (Seq#Length(s)))) ==> (((i_22) <= (i_23)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(s, i_23)))))); // type:check tag:function_precondition line:128 cid:125 rid:3286
  Result := (forall i_22: int :: (((1) <= (i_22)) && ((i_22) <= (Seq#Length(s)))) ==> ((forall i_23: int :: (((1) <= (i_23)) && ((i_23) <= (Seq#Length(s)))) ==> (((i_22) <= (i_23)) ==> ((Seq#Item(s, i_22)) <= (Seq#Item(s, i_23)))))));
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, BINARY_SEARCH)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, BINARY_SEARCH)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, BINARY_SEARCH)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.BINARY_SEARCH.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, BINARY_SEARCH)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.BINARY_SEARCH.in_observers(heap, current, v, o)))));

function modify.BINARY_SEARCH.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.BINARY_SEARCH.default_create(heap, current)[$o, $f] } (modify.BINARY_SEARCH.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.BINARY_SEARCH.test_binary_search(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.BINARY_SEARCH.test_binary_search(heap, current)[$o, $f] } (modify.BINARY_SEARCH.test_binary_search(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
axiom ((forall <T7> $f: Field T7 :: { IsModelField($f, SIMPLE_ARRAY^INTEGER_32^) } (IsModelField($f, SIMPLE_ARRAY^INTEGER_32^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));
...
function modify.BINARY_SEARCH.binary_search_iterative(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { modify.BINARY_SEARCH.binary_search_iterative(heap, current, a, value)[$o, $f] } (modify.BINARY_SEARCH.binary_search_iterative(heap, current, a, value)[$o, $f]) <==> (false)))));
...
function modify.BINARY_SEARCH.binary_search_recursive(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { modify.BINARY_SEARCH.binary_search_recursive(heap, current, a, value)[$o, $f] } (modify.BINARY_SEARCH.binary_search_recursive(heap, current, a, value)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH.binary_search_recursive(heap: HeapType, current: ref, a: ref, value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { read.fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value)[$o, $f] } (read.fun.BINARY_SEARCH.binary_search_recursive(heap, current, a, value)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH.binary_search_recursive(heap: HeapType, current: ref, a: ref, value: int) returns (bool) {
  ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) < (2147483647)) && (fun.BINARY_SEARCH.is_sorted(heap, current, heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.BINARY_SEARCH.binary_search_recursive(heap: HeapType, current: ref, a: ref, value: int) returns (bool);

function modify.BINARY_SEARCH.binary_search_recursive_step(heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { modify.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper)[$o, $f] } (modify.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH.binary_search_recursive_step(heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { read.fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper)[$o, $f] } (read.fun.BINARY_SEARCH.binary_search_recursive_step(heap, current, a, value, lower, upper)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH.binary_search_recursive_step(heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int) returns (bool) {
  ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) < (2147483647)) && (fun.BINARY_SEARCH.is_sorted(heap, current, heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])) && ((1) <= (lower)) && ((lower) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) + (1))) && ((0) <= (upper)) && ((upper) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.BINARY_SEARCH.binary_search_recursive_step(heap: HeapType, current: ref, a: ref, value: int, lower: int, upper: int) returns (bool);

function modify.BINARY_SEARCH.is_sorted(heap: HeapType, current: ref, s: Seq int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, s: Seq int :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { modify.BINARY_SEARCH.is_sorted(heap, current, s)[$o, $f] } (modify.BINARY_SEARCH.is_sorted(heap, current, s)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH.is_sorted(heap: HeapType, current: ref, s: Seq int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, s: Seq int :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { read.fun.BINARY_SEARCH.is_sorted(heap, current, s)[$o, $f] } (read.fun.BINARY_SEARCH.is_sorted(heap, current, s)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH.is_sorted(heap: HeapType, current: ref, s: Seq int) returns (bool) {
  true
}

function trigger.fun.BINARY_SEARCH.is_sorted(heap: HeapType, current: ref, s: Seq int) returns (bool);
...
procedure BINARY_SEARCH.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, BINARY_SEARCH); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_SEARCH.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_SEARCH.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_SEARCH.in_observers(Heap, Current, new_observers, o), readable);



function fun.BINARY_SEARCH.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.BINARY_SEARCH.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH.in_observers(heap, current, new_observers, o) } { trigger.fun.BINARY_SEARCH.in_observers(heap, current, new_observers, o) } (pre.fun.BINARY_SEARCH.in_observers(heap, current, new_observers, o)) ==> ((fun.BINARY_SEARCH.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_SEARCH.in_observers(heap, current, new_observers, o) } (fun.BINARY_SEARCH.in_observers(heap, current, new_observers, o)) == (fun0.BINARY_SEARCH.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.BINARY_SEARCH.in_observers(h, current, new_observers, o), fun0.BINARY_SEARCH.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.BINARY_SEARCH.in_observers(h, current, new_observers, o)) && (pre.fun.BINARY_SEARCH.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.BINARY_SEARCH.in_observers(h, current, new_observers, o)))) ==> ((fun0.BINARY_SEARCH.in_observers(h, current, new_observers, o)) == (fun0.BINARY_SEARCH.in_observers(h', current, new_observers, o)))));
...
axiom ((forall heap: HeapType, current: ref, s: Seq int :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { modify.SIMPLE_ARRAY^INTEGER_32^.init(heap, current, s)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.init(heap, current, s)[$o, $f]) <==> (($o) == (current))))));

function modify.SIMPLE_ARRAY^INTEGER_32^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T17> $o: ref, $f: Field T17 :: { modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T18> $o: ref, $f: Field T18 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T19> $o: ref, $f: Field T19 :: { modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T20> $o: ref, $f: Field T20 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
function modify.BINARY_SEARCH.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T23> $o: ref, $f: Field T23 :: { modify.BINARY_SEARCH.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.BINARY_SEARCH.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.BINARY_SEARCH.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T24> $o: ref, $f: Field T24 :: { read.fun.BINARY_SEARCH.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.BINARY_SEARCH.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_SEARCH.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.BINARY_SEARCH.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T25> $o: ref, $f: Field T25 :: { modify.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T26> $o: ref, $f: Field T26 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T27> $o: ref, $f: Field T27 :: { modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T28> $o: ref, $f: Field T28 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
