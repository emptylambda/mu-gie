// Automatically generated (12/12/2017 1:56:09.681 PM)
...
const unique BINARY_NODE: Type;

axiom ((BINARY_NODE) <: (ANY));

axiom ((forall t: Type :: { (BINARY_NODE) <: (t) } ((BINARY_NODE) <: (t)) <==> (((t) == (BINARY_NODE)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, BINARY_NODE)) == (-1));

axiom ((FieldId(closed, BINARY_NODE)) == (-2));

axiom ((FieldId(owner, BINARY_NODE)) == (-3));

axiom ((FieldId(owns, BINARY_NODE)) == (-4));

axiom ((FieldId(observers, BINARY_NODE)) == (-5));

axiom ((FieldId(subjects, BINARY_NODE)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, BINARY_NODE) } (IsModelField($f, BINARY_NODE)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } BINARY_NODE.user_inv(heap: HeapType, current: ref) returns (bool) {
  (Set#Equal(heap[current, owns], Set#Removed(Set#Extended(Set#Singleton(heap[current, BINARY_NODE.left]), heap[current, BINARY_NODE.right]), Void))) && (Seq#Equal(heap[current, BINARY_NODE.sequence], Seq#Concat(Seq#Extended((if (heap[current, BINARY_NODE.left]) == (Void) then Seq#Empty() else heap[heap[current, BINARY_NODE.left], BINARY_NODE.sequence]), heap[current, BINARY_NODE.value]), (if (heap[current, BINARY_NODE.right]) == (Void) then Seq#Empty() else heap[heap[current, BINARY_NODE.right], BINARY_NODE.sequence])))) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (admissibility2(heap, current))
}

function BINARY_NODE.owns.static(heap: HeapType, current: ref) returns (Set (ref)) {
  Set#Removed(Set#Extended(Set#Singleton(heap[current, BINARY_NODE.left]), heap[current, BINARY_NODE.right]), Void)
}

function BINARY_NODE.BINARY_NODE.sequence.static(heap: HeapType, current: ref) returns (Seq int) {
  Seq#Concat(Seq#Extended((if (heap[current, BINARY_NODE.left]) == (Void) then Seq#Empty() else heap[heap[current, BINARY_NODE.left], BINARY_NODE.sequence]), heap[current, BINARY_NODE.value]), (if (heap[current, BINARY_NODE.right]) == (Void) then Seq#Empty() else heap[heap[current, BINARY_NODE.right], BINARY_NODE.sequence]))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, BINARY_NODE)) ==> ((user_inv(heap, current)) <==> (BINARY_NODE.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, BINARY_NODE)) ==> ((user_inv(heap, current)) ==> (BINARY_NODE.user_inv(heap, current)))));

procedure BINARY_NODE.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, BINARY_NODE);



implementation BINARY_NODE.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, BINARY_NODE.left]; // type:access tag:attribute_readable line:98 cid:404 fid:83
  assert user_inv_readable(Heap, Current)[Current, BINARY_NODE.right]; // type:access tag:attribute_readable line:98 cid:404 fid:84
  assume Set#Equal(Heap[Current, owns], Set#Removed(Set#Extended(Set#Singleton(Heap[Current, BINARY_NODE.left]), Heap[Current, BINARY_NODE.right]), Void));
  assert user_inv_readable(Heap, Current)[Current, BINARY_NODE.sequence]; // type:access tag:attribute_readable line:99 cid:404 fid:86
  assert user_inv_readable(Heap, Current)[Current, BINARY_NODE.left]; // type:access tag:attribute_readable line:99 cid:404 fid:83
  assert (!((Heap[Current, BINARY_NODE.left]) == (Void))) ==> (user_inv_readable(Heap, Current)[Current, BINARY_NODE.left]); // type:access tag:attribute_readable line:99 cid:404 fid:83
  assert {:subsumption 0} (!((Heap[Current, BINARY_NODE.left]) == (Void))) ==> ((Heap[Current, BINARY_NODE.left]) != (Void)); // type:attached tag:sequence_definition line:99
  assert (!((Heap[Current, BINARY_NODE.left]) == (Void))) ==> (user_inv_readable(Heap, Current)[Heap[Current, BINARY_NODE.left], BINARY_NODE.sequence]); // type:access tag:attribute_readable line:99 cid:404 fid:86
  assert user_inv_readable(Heap, Current)[Current, BINARY_NODE.value]; // type:access tag:attribute_readable line:99 cid:404 fid:82
  assert user_inv_readable(Heap, Current)[Current, BINARY_NODE.right]; // type:access tag:attribute_readable line:99 cid:404 fid:84
  assert (!((Heap[Current, BINARY_NODE.right]) == (Void))) ==> (user_inv_readable(Heap, Current)[Current, BINARY_NODE.right]); // type:access tag:attribute_readable line:99 cid:404 fid:84
  assert {:subsumption 0} (!((Heap[Current, BINARY_NODE.right]) == (Void))) ==> ((Heap[Current, BINARY_NODE.right]) != (Void)); // type:attached tag:sequence_definition line:99
  assert (!((Heap[Current, BINARY_NODE.right]) == (Void))) ==> (user_inv_readable(Heap, Current)[Heap[Current, BINARY_NODE.right], BINARY_NODE.sequence]); // type:access tag:attribute_readable line:99 cid:404 fid:86
  assume Seq#Equal(Heap[Current, BINARY_NODE.sequence], Seq#Concat(Seq#Extended((if (Heap[Current, BINARY_NODE.left]) == (Void) then Seq#Empty() else Heap[Heap[Current, BINARY_NODE.left], BINARY_NODE.sequence]), Heap[Current, BINARY_NODE.value]), (if (Heap[Current, BINARY_NODE.right]) == (Void) then Seq#Empty() else Heap[Heap[Current, BINARY_NODE.right], BINARY_NODE.sequence])));
  return;
  a2:
...
procedure create.BINARY_NODE.make(Current: ref, a_value: int);
  free requires attached_exact(Heap, Current, BINARY_NODE); // info:type property for argument Current
  free requires is_integer_32(a_value); // info:type property for argument a_value
  modifies Heap;
  ensures (Heap[Current, BINARY_NODE.value]) == (a_value); // type:post tag:value_set line:20
  ensures (Heap[Current, BINARY_NODE.left]) == (Void); // type:post tag:no_left line:21
  ensures (Heap[Current, BINARY_NODE.right]) == (Void); // type:post tag:no_right line:22
  ...
  requires Frame#Subset(modify.BINARY_NODE.make(Heap, Current, a_value), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_NODE.make(old(Heap), Current, a_value));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.BINARY_NODE.make(Current: ref, a_value: int)
{
  entry:
  assume {:captureState "create.BINARY_NODE.make"} true;
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:17
  // value := a_value
  call update_heap(Current, BINARY_NODE.value, a_value); // line:17
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:18
  // sequence := << value >>
  call update_heap(Current, BINARY_NODE.sequence, Seq#Singleton(Heap[Current, BINARY_NODE.value])); // line:18
  if (modify.BINARY_NODE.make(Heap, Current, a_value)[Current, BINARY_NODE.sequence]) {
    call update_heap(Current, BINARY_NODE.sequence, BINARY_NODE.BINARY_NODE.sequence.static(Heap, Current)); // default:sequence line:23
  }
  if (modify.BINARY_NODE.make(Heap, Current, a_value)[Current, owns]) {
    call update_heap(Current, owns, BINARY_NODE.owns.static(Heap, Current)); // default:owns line:23
  }
  if (*) {
    assert Set#Equal(Heap[Current, owns], Set#Removed(Set#Extended(Set#Singleton(Heap[Current, BINARY_NODE.left]), Heap[Current, BINARY_NODE.right]), Void)); // type:inv tag:owns_definition line:53 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Seq#Equal(Heap[Current, BINARY_NODE.sequence], Seq#Concat(Seq#Extended((if (Heap[Current, BINARY_NODE.left]) == (Void) then Seq#Empty() else Heap[Heap[Current, BINARY_NODE.left], BINARY_NODE.sequence]), Heap[Current, BINARY_NODE.value]), (if (Heap[Current, BINARY_NODE.right]) == (Void) then Seq#Empty() else Heap[Heap[Current, BINARY_NODE.right], BINARY_NODE.sequence]))); // type:inv tag:sequence_definition line:53 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, observers]); // type:inv tag:default_observers line:53 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, subjects]); // type:inv tag:default_subjects line:53 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert admissibility2(Heap, Current); // type:inv tag:A2 line:53 cid:1 rid:55
    assume false;
  }
  call wrap(Current); // default:wrapping cid:1 rid:55 line:23
}

procedure create.BINARY_NODE.make_with_children(Current: ref, a_value: int, a_left: ref, a_right: ref);
  free requires attached_exact(Heap, Current, BINARY_NODE); // info:type property for argument Current
  free requires is_integer_32(a_value); // info:type property for argument a_value
  free requires detachable(Heap, a_left, BINARY_NODE); // info:type property for argument a_left
  free requires detachable(Heap, a_right, BINARY_NODE); // info:type property for argument a_right
  modifies Heap;
  requires (a_left) != (Void); // type:attached line:31
  requires is_wrapped(Heap, a_left); // type:pre line:31
  requires (a_right) != (Void); // type:attached line:32
  requires is_wrapped(Heap, a_right); // type:pre line:32
  ensures (Heap[Current, BINARY_NODE.value]) == (a_value); // type:post tag:value_set line:49
  ensures (Heap[Current, BINARY_NODE.left]) == (a_left); // type:post tag:left_set line:50
  ensures (Heap[Current, BINARY_NODE.right]) == (a_right); // type:post tag:right_set line:51
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_closed line:52
  requires (forall <T4> $f: Field T4 :: (($f) != (allocated)) ==> ((Heap[Current, $f]) == (Default($f))));
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_NODE.make_with_children(Heap, Current, a_value, a_left, a_right), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_NODE.make_with_children(old(Heap), Current, a_value, a_left, a_right));
  free ensures HeapSucc(old(Heap), Heap);



implementation create.BINARY_NODE.make_with_children(Current: ref, a_value: int, a_left: ref, a_right: ref)
{
  entry:
  assume {:captureState "create.BINARY_NODE.make_with_children"} true;
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:37
  // value := a_value
  call update_heap(Current, BINARY_NODE.value, a_value); // line:37
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:38
  // left := a_left
  call update_heap(Current, BINARY_NODE.left, a_left); // line:38
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:39
  // right := a_right
  call update_heap(Current, BINARY_NODE.right, a_right); // line:39
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:40
  // if left /= Void then
  if ((Heap[Current, BINARY_NODE.left]) != (Void)) {
    // /home/caf/temp/comcom/repo-treemax/binary_node.e:41
    // sequence := left.sequence & value
    assert {:subsumption 0} (Heap[Current, BINARY_NODE.left]) != (Void); // type:attached line:41
    call update_heap(Current, BINARY_NODE.sequence, Seq#Extended(Heap[Heap[Current, BINARY_NODE.left], BINARY_NODE.sequence], Heap[Current, BINARY_NODE.value])); // line:41
  } else {
    // /home/caf/temp/comcom/repo-treemax/binary_node.e:43
    // sequence := << value >>
    call update_heap(Current, BINARY_NODE.sequence, Seq#Singleton(Heap[Current, BINARY_NODE.value])); // line:43
  }
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:45
  // if right /= Void then
  if ((Heap[Current, BINARY_NODE.right]) != (Void)) {
    // /home/caf/temp/comcom/repo-treemax/binary_node.e:46
    // sequence := sequence + right.sequence
    assert {:subsumption 0} (Heap[Current, BINARY_NODE.right]) != (Void); // type:attached line:46
    call update_heap(Current, BINARY_NODE.sequence, Seq#Concat(Heap[Current, BINARY_NODE.sequence], Heap[Heap[Current, BINARY_NODE.right], BINARY_NODE.sequence])); // line:46
  }
  if (modify.BINARY_NODE.make_with_children(Heap, Current, a_value, a_left, a_right)[Current, BINARY_NODE.sequence]) {
    call update_heap(Current, BINARY_NODE.sequence, BINARY_NODE.BINARY_NODE.sequence.static(Heap, Current)); // default:sequence line:53
  }
  if (modify.BINARY_NODE.make_with_children(Heap, Current, a_value, a_left, a_right)[Current, owns]) {
    call update_heap(Current, owns, BINARY_NODE.owns.static(Heap, Current)); // default:owns line:53
  }
  if (*) {
    assert Set#Equal(Heap[Current, owns], Set#Removed(Set#Extended(Set#Singleton(Heap[Current, BINARY_NODE.left]), Heap[Current, BINARY_NODE.right]), Void)); // type:inv tag:owns_definition line:53 cid:1 rid:55
    assume false;
...
procedure BINARY_NODE.maximum(Current: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, BINARY_NODE); // info:type property for argument Current
  modifies Heap;
  ensures (forall i_1: int :: (Seq#Domain(Heap[Current, BINARY_NODE.sequence])[i_1]) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[Current, BINARY_NODE.sequence], i_1))); // type:check tag:function_precondition line:83 cid:125 rid:3286
  ensures (forall i_1: int :: (Seq#Domain(Heap[Current, BINARY_NODE.sequence])[i_1]) ==> ((Seq#Item(Heap[Current, BINARY_NODE.sequence], i_1)) <= (Result))); // type:post tag:max line:83
  ensures Seq#Has(Heap[Current, BINARY_NODE.sequence], Result); // type:post tag:exists line:84
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_NODE.maximum(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_NODE.maximum(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_NODE.maximum(Heap, Current), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.BINARY_NODE.maximum(old(Heap), Current));



function fun.BINARY_NODE.maximum(heap: HeapType, current: ref) returns (int);

axiom ((forall heap: HeapType, current: ref :: { fun.BINARY_NODE.maximum(heap, current) } (pre.fun.BINARY_NODE.maximum(heap, current)) ==> (((forall i_2: int :: (Seq#Domain(heap[current, BINARY_NODE.sequence])[i_2]) ==> ((Seq#Item(heap[current, BINARY_NODE.sequence], i_2)) <= (fun.BINARY_NODE.maximum(heap, current))))) && (Seq#Has(heap[current, BINARY_NODE.sequence], fun.BINARY_NODE.maximum(heap, current))) && (is_integer_32(fun.BINARY_NODE.maximum(heap, current))))));

axiom ((forall h: HeapType, h': HeapType, current: ref :: { HeapSucc(h, h'), fun.BINARY_NODE.maximum(h, current), fun.BINARY_NODE.maximum(h', current) } ((HeapSucc(h, h')) && (pre.fun.BINARY_NODE.maximum(h, current)) && (pre.fun.BINARY_NODE.maximum(h', current)) && (same_inside(h, h', read.fun.BINARY_NODE.maximum(h, current)))) ==> ((fun.BINARY_NODE.maximum(h, current)) == (fun.BINARY_NODE.maximum(h', current)))));

function { :inline } variant.BINARY_NODE.maximum.1(heap: HeapType, current: ref) returns (Seq int) {
  heap[current, BINARY_NODE.sequence]
}

implementation BINARY_NODE.maximum(Current: ref) returns (Result: int)
{
  var temp_3: int;
  var temp_4: int;
  ...
  entry:
  assume {:captureState "BINARY_NODE.maximum"} true;
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:73
  // Result := value
  assert readable[Current, BINARY_NODE.value]; // type:access tag:attribute_readable line:73 cid:404 rid:5403
  Result := Heap[Current, BINARY_NODE.value];
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:74
  // if left /= Void then
  assert readable[Current, BINARY_NODE.left]; // type:access tag:attribute_readable line:74 cid:404 rid:5404
  if ((Heap[Current, BINARY_NODE.left]) != (Void)) {
    // /home/caf/temp/comcom/repo-treemax/binary_node.e:75
    // check owns.has (left) end
    assert readable[Current, BINARY_NODE.left]; // type:access tag:attribute_readable line:75 cid:404 fid:83
    assert Heap[Current, owns][Heap[Current, BINARY_NODE.left]]; // type:check line:75
    // /home/caf/temp/comcom/repo-treemax/binary_node.e:76
    // Result := Result.max (left.maximum)
    assert readable[Current, BINARY_NODE.left]; // type:access tag:attribute_readable line:76 cid:404 rid:5404
    assert {:subsumption 0} (Heap[Current, BINARY_NODE.left]) != (Void); // type:attached line:76
    assert Frame#Subset(read.fun.BINARY_NODE.maximum(Heap, Heap[Current, BINARY_NODE.left]), readable); // type:access tag:frame_readable line:76 cid:404 rid:5406
    assert {:subsumption 0} (Seq#LessEqual(variant.BINARY_NODE.maximum.1(Heap, Heap[Current, BINARY_NODE.left]), variant.BINARY_NODE.maximum.1(old(Heap), Current))) && (!(Seq#LessEqual(variant.BINARY_NODE.maximum.1(old(Heap), Current), variant.BINARY_NODE.maximum.1(Heap, Heap[Current, BINARY_NODE.left])))); // type:termination tag:variant_decreases line:76
    call temp_3 := BINARY_NODE.maximum(Heap[Current, BINARY_NODE.left]); // line:76 cid:404 rid:5406
    Result := max(Result, temp_3);
  }
  // /home/caf/temp/comcom/repo-treemax/binary_node.e:78
  // if right /= Void then
  assert readable[Current, BINARY_NODE.right]; // type:access tag:attribute_readable line:78 cid:404 rid:5405
  if ((Heap[Current, BINARY_NODE.right]) != (Void)) {
    // /home/caf/temp/comcom/repo-treemax/binary_node.e:79
    // check owns.has (right) end
    assert readable[Current, BINARY_NODE.right]; // type:access tag:attribute_readable line:79 cid:404 fid:84
    assert Heap[Current, owns][Heap[Current, BINARY_NODE.right]]; // type:check line:79
    // /home/caf/temp/comcom/repo-treemax/binary_node.e:80
    // Result := Result.max (right.maximum)
    assert readable[Current, BINARY_NODE.right]; // type:access tag:attribute_readable line:80 cid:404 rid:5405
    assert {:subsumption 0} (Heap[Current, BINARY_NODE.right]) != (Void); // type:attached line:80
    assert Frame#Subset(read.fun.BINARY_NODE.maximum(Heap, Heap[Current, BINARY_NODE.right]), readable); // type:access tag:frame_readable line:80 cid:404 rid:5406
    assert {:subsumption 0} (Seq#LessEqual(variant.BINARY_NODE.maximum.1(Heap, Heap[Current, BINARY_NODE.right]), variant.BINARY_NODE.maximum.1(old(Heap), Current))) && (!(Seq#LessEqual(variant.BINARY_NODE.maximum.1(old(Heap), Current), variant.BINARY_NODE.maximum.1(Heap, Heap[Current, BINARY_NODE.right])))); // type:termination tag:variant_decreases line:80
    call temp_4 := BINARY_NODE.maximum(Heap[Current, BINARY_NODE.right]); // line:80 cid:404 rid:5406
    Result := max(Result, temp_4);
  }
}

const BINARY_NODE.left: Field (ref);

axiom ((FieldId(BINARY_NODE.left, BINARY_NODE)) == (83));

axiom ((forall heap: HeapType, o: ref :: { heap[o, BINARY_NODE.left] } ((IsHeap(heap)) && (attached(heap, o, BINARY_NODE))) ==> (detachable(heap, heap[o, BINARY_NODE.left], BINARY_NODE))));

axiom ((forall heap: HeapType, current: ref, v: ref, o: ref :: { guard(heap, current, BINARY_NODE.left, v, o) } (attached_exact(heap, current, BINARY_NODE)) ==> ((guard(heap, current, BINARY_NODE.left, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, BINARY_NODE.left := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: ref, o: ref :: { guard(heap, current, BINARY_NODE.left, v, o) } (attached(heap, current, BINARY_NODE)) ==> ((guard(heap, current, BINARY_NODE.left, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, BINARY_NODE.left := v], o))))));

const BINARY_NODE.right: Field (ref);

axiom ((FieldId(BINARY_NODE.right, BINARY_NODE)) == (84));

axiom ((forall heap: HeapType, o: ref :: { heap[o, BINARY_NODE.right] } ((IsHeap(heap)) && (attached(heap, o, BINARY_NODE))) ==> (detachable(heap, heap[o, BINARY_NODE.right], BINARY_NODE))));

axiom ((forall heap: HeapType, current: ref, v: ref, o: ref :: { guard(heap, current, BINARY_NODE.right, v, o) } (attached_exact(heap, current, BINARY_NODE)) ==> ((guard(heap, current, BINARY_NODE.right, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, BINARY_NODE.right := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: ref, o: ref :: { guard(heap, current, BINARY_NODE.right, v, o) } (attached(heap, current, BINARY_NODE)) ==> ((guard(heap, current, BINARY_NODE.right, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, BINARY_NODE.right := v], o))))));

const BINARY_NODE.sequence: Field (Seq int);

axiom ((FieldId(BINARY_NODE.sequence, BINARY_NODE)) == (86));

axiom ((forall heap: HeapType, current: ref, v: Seq int, o: ref :: { guard(heap, current, BINARY_NODE.sequence, v, o) } (attached_exact(heap, current, BINARY_NODE)) ==> ((guard(heap, current, BINARY_NODE.sequence, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, BINARY_NODE.sequence := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: Seq int, o: ref :: { guard(heap, current, BINARY_NODE.sequence, v, o) } (attached(heap, current, BINARY_NODE)) ==> ((guard(heap, current, BINARY_NODE.sequence, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, BINARY_NODE.sequence := v], o))))));

const BINARY_NODE.value: Field int;

axiom ((FieldId(BINARY_NODE.value, BINARY_NODE)) == (82));

axiom ((forall heap: HeapType, o: ref :: { heap[o, BINARY_NODE.value] } ((IsHeap(heap)) && (attached(heap, o, BINARY_NODE))) ==> (is_integer_32(heap[o, BINARY_NODE.value]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, BINARY_NODE.value, v, o) } (attached_exact(heap, current, BINARY_NODE)) ==> ((guard(heap, current, BINARY_NODE.value, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, BINARY_NODE.value := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, BINARY_NODE.value, v, o) } (attached(heap, current, BINARY_NODE)) ==> ((guard(heap, current, BINARY_NODE.value, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, BINARY_NODE.value := v], o))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, BINARY_NODE)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, BINARY_NODE)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, BINARY_NODE)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.BINARY_NODE.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, BINARY_NODE)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.BINARY_NODE.in_observers(heap, current, v, o)))));

function modify.BINARY_NODE.make(heap: HeapType, current: ref, a_value: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_value: int :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.BINARY_NODE.make(heap, current, a_value)[$o, $f] } (modify.BINARY_NODE.make(heap, current, a_value)[$o, $f]) <==> (($o) == (current))))));

function modify.BINARY_NODE.make_with_children(heap: HeapType, current: ref, a_value: int, a_left: ref, a_right: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_value: int, a_left: ref, a_right: ref :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.BINARY_NODE.make_with_children(heap, current, a_value, a_left, a_right)[$o, $f] } (modify.BINARY_NODE.make_with_children(heap, current, a_value, a_left, a_right)[$o, $f]) <==> ((((($o) == (a_left)) || (($o) == (a_right))) && (($f) == (owner))) || (($o) == (current)))))));

function modify.BINARY_NODE.maximum(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.BINARY_NODE.maximum(heap, current)[$o, $f] } (modify.BINARY_NODE.maximum(heap, current)[$o, $f]) <==> (false)))));

function read.fun.BINARY_NODE.maximum(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { read.fun.BINARY_NODE.maximum(heap, current)[$o, $f] } (read.fun.BINARY_NODE.maximum(heap, current)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_NODE.maximum(heap: HeapType, current: ref) returns (bool) {
  is_closed(heap, current)
}

function trigger.fun.BINARY_NODE.maximum(heap: HeapType, current: ref) returns (bool);
...
procedure BINARY_NODE.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, BINARY_NODE); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.BINARY_NODE.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.BINARY_NODE.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.BINARY_NODE.in_observers(Heap, Current, new_observers, o), readable);



function fun.BINARY_NODE.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.BINARY_NODE.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_NODE.in_observers(heap, current, new_observers, o) } { trigger.fun.BINARY_NODE.in_observers(heap, current, new_observers, o) } (pre.fun.BINARY_NODE.in_observers(heap, current, new_observers, o)) ==> ((fun.BINARY_NODE.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.BINARY_NODE.in_observers(heap, current, new_observers, o) } (fun.BINARY_NODE.in_observers(heap, current, new_observers, o)) == (fun0.BINARY_NODE.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.BINARY_NODE.in_observers(h, current, new_observers, o), fun0.BINARY_NODE.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.BINARY_NODE.in_observers(h, current, new_observers, o)) && (pre.fun.BINARY_NODE.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.BINARY_NODE.in_observers(h, current, new_observers, o)))) ==> ((fun0.BINARY_NODE.in_observers(h, current, new_observers, o)) == (fun0.BINARY_NODE.in_observers(h', current, new_observers, o)))));
...
function modify.BINARY_NODE.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.BINARY_NODE.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.BINARY_NODE.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.BINARY_NODE.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { read.fun.BINARY_NODE.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.BINARY_NODE.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.BINARY_NODE.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.BINARY_NODE.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
