// Automatically generated (12/12/2017 1:54:25.159 PM)
...
axiom ((forall t: Type :: { (GCD) <: (t) } ((GCD) <: (t)) <==> (((t) == (GCD)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, GCD)) == (-1));

axiom ((FieldId(closed, GCD)) == (-2));

axiom ((FieldId(owner, GCD)) == (-3));

axiom ((FieldId(owns, GCD)) == (-4));

axiom ((FieldId(observers, GCD)) == (-5));

axiom ((FieldId(subjects, GCD)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, GCD) } (IsModelField($f, GCD)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } GCD.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, GCD)) ==> ((user_inv(heap, current)) <==> (GCD.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, GCD)) ==> ((user_inv(heap, current)) ==> (GCD.user_inv(heap, current)))));

procedure GCD.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, GCD);



implementation GCD.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.GCD.default_create(Current: ref);
  free requires attached_exact(Heap, Current, GCD); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.GCD.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.GCD.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.GCD.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.GCD.default_create"} true;
  if (*) {
...
procedure GCD.gcd_nondeterministic(Current: ref, a_: int, b_: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, GCD); // info:type property for argument Current
  free requires is_integer_32(a_); // info:type property for argument a_
  free requires is_integer_32(b_); // info:type property for argument b_
  modifies Heap;
  requires (a_) > (0); // type:pre tag:a_poisitve line:15
  requires (b_) > (0); // type:pre tag:b_positive line:16
  ensures pre.fun.GCD.gcd(Heap, Current, a_, b_); // type:check tag:function_precondition line:52 cid:404 rid:5402
  ensures (Result) == (fun.GCD.gcd(Heap, Current, a_, b_)); // type:post tag:valid_result line:52
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.GCD.gcd_nondeterministic(Heap, Current, a_, b_), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.GCD.gcd_nondeterministic(old(Heap), Current, a_, b_));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.GCD.gcd_nondeterministic(Heap, Current, a_, b_), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.GCD.gcd_nondeterministic(old(Heap), Current, a_, b_));



function fun.GCD.gcd_nondeterministic(heap: HeapType, current: ref, a_: int, b_: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a_: int, b_: int :: { fun.GCD.gcd_nondeterministic(heap, current, a_, b_) } (pre.fun.GCD.gcd_nondeterministic(heap, current, a_, b_)) ==> (((fun.GCD.gcd_nondeterministic(heap, current, a_, b_)) == (fun.GCD.gcd(heap, current, a_, b_))) && (is_integer_32(fun.GCD.gcd_nondeterministic(heap, current, a_, b_))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a_: int, b_: int :: { HeapSucc(h, h'), fun.GCD.gcd_nondeterministic(h, current, a_, b_), fun.GCD.gcd_nondeterministic(h', current, a_, b_) } ((HeapSucc(h, h')) && (pre.fun.GCD.gcd_nondeterministic(h, current, a_, b_)) && (pre.fun.GCD.gcd_nondeterministic(h', current, a_, b_)) && (same_inside(h, h', read.fun.GCD.gcd_nondeterministic(h, current, a_, b_)))) ==> ((fun.GCD.gcd_nondeterministic(h, current, a_, b_)) == (fun.GCD.gcd_nondeterministic(h', current, a_, b_)))));

function { :inline } variant.GCD.gcd_nondeterministic.1(heap: HeapType, current: ref, a_: int, b_: int) returns (int) {
  a_
}

function { :inline } variant.GCD.gcd_nondeterministic.2(heap: HeapType, current: ref, a_: int, b_: int) returns (int) {
  b_
}

implementation GCD.gcd_nondeterministic(Current: ref, a_: int, b_: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "GCD.gcd_nondeterministic"} true;
  // /home/caf/temp/comcom/repo-gcd/gcd.e:21
  // check assume: a_turn.count > 0 end -- Modeling infinite sequence
  assume readable[Current, GCD.a_turn];
  assume (Seq#Length(Heap[Current, GCD.a_turn])) > (0);
  // /home/caf/temp/comcom/repo-gcd/gcd.e:23
  // a := a_
  local1 := a_;
  // /home/caf/temp/comcom/repo-gcd/gcd.e:24
  // b := b_
  local2 := b_;
  // /home/caf/temp/comcom/repo-gcd/gcd.e:25
  // i := 1
  local3 := 1;
  PreLoopHeap_4 := Heap;
  goto loop_head_1;
  loop_head_1:
  // /home/caf/temp/comcom/repo-gcd/gcd.e:27
  // a_in_bounds: 0 < a and a <= a_
  assert ((0) < (local1)) && ((local1) <= (a_)); // type:loop_inv tag:a_in_bounds line:27
  // /home/caf/temp/comcom/repo-gcd/gcd.e:28
  // b_in_bounds: 0 < b and b <= b_
  assert ((0) < (local2)) && ((local2) <= (b_)); // type:loop_inv tag:b_in_bounds line:28
  // /home/caf/temp/comcom/repo-gcd/gcd.e:29
  // maintains_gcd: gcd (a, b) = gcd (a_, b_)
  assert Frame#Subset(read.fun.GCD.gcd(Heap, Current, local1, local2), readable); // type:access tag:frame_readable line:29 cid:404 rid:5402
  assert pre.fun.GCD.gcd(Heap, Current, local1, local2); // type:check tag:function_precondition line:29 cid:404 rid:5402
  assert Frame#Subset(read.fun.GCD.gcd(Heap, Current, a_, b_), readable); // type:access tag:frame_readable line:29 cid:404 rid:5402
  assert pre.fun.GCD.gcd(Heap, Current, a_, b_); // type:check tag:function_precondition line:29 cid:404 rid:5402
  assert (fun.GCD.gcd(Heap, Current, local1, local2)) == (fun.GCD.gcd(Heap, Current, a_, b_)); // type:loop_inv tag:maintains_gcd line:29
  // /home/caf/temp/comcom/repo-gcd/gcd.e:30
  // coin_flips_long_enough: 1 <= i and i <= a_turn.count
  assert readable[Current, GCD.a_turn]; // type:access tag:attribute_readable line:30 cid:404 fid:82
  assert ((1) <= (local3)) && ((local3) <= (Seq#Length(Heap[Current, GCD.a_turn]))); // type:loop_inv tag:coin_flips_long_enough line:30
  assume HeapSucc(PreLoopHeap_4, Heap);
  assume same_outside(old(Heap), Heap, modify.GCD.gcd_nondeterministic(old(Heap), Current, a_, b_));
  assume global(Heap);
  // /home/caf/temp/comcom/repo-gcd/gcd.e:-1
  goto loop_body_2, loop_end_3;
  loop_body_2:
  assume !((local1) == (local2));
  variant_5 := (local1) + (local2);
  variant_6 := (fun.GCD.next(Heap, Current, local3, (local1) > (local2))) - (local3);
  // /home/caf/temp/comcom/repo-gcd/gcd.e:38
  // check assume: i + 1 <= a_turn.count end -- Modeling infinite sequence
  assume readable[Current, GCD.a_turn];
  assume ((local3) + (1)) <= (Seq#Length(Heap[Current, GCD.a_turn]));
  // /home/caf/temp/comcom/repo-gcd/gcd.e:39
  // if a_turn [i] then -- Thread A is scheduled
  assert readable[Current, GCD.a_turn]; // type:access tag:attribute_readable line:39 cid:404 rid:5403
  assert pre.fun.MML_SEQUENCE^BOOLEAN^.item(Heap[Current, GCD.a_turn], local3); // type:check tag:function_precondition line:39 cid:125 rid:3286
  if (Seq#Item(Heap[Current, GCD.a_turn], local3)) {
    // /home/caf/temp/comcom/repo-gcd/gcd.e:40
    // if a > b then
    if ((local1) > (local2)) {
      // /home/caf/temp/comcom/repo-gcd/gcd.e:41
      // a := a - b
      local1 := (local1) - (local2);
    }
  } else {
    // /home/caf/temp/comcom/repo-gcd/gcd.e:44
    // if b > a then
    if ((local2) > (local1)) {
      // /home/caf/temp/comcom/repo-gcd/gcd.e:45
      // b := b - a
      local2 := (local2) - (local1);
    }
  }
  // /home/caf/temp/comcom/repo-gcd/gcd.e:48
  // i := i + 1
  local3 := (local3) + (1);
  // /home/caf/temp/comcom/repo-gcd/gcd.e:38
  // check assume: i + 1 <= a_turn.count end -- Modeling infinite sequence
  assert {:subsumption 0} ((((local1) + (local2)) <= (variant_5)) && ((variant_5) <= ((local1) + (local2)))) || ((0) <= (variant_5)); // type:termination tag:bounded line:38 varid:1
  assert {:subsumption 0} ((((local1) + (local2)) <= (variant_5)) && (!((variant_5) <= ((local1) + (local2))))) || ((((fun.GCD.next(Heap, Current, local3, (local1) > (local2))) - (local3)) <= (variant_6)) && ((variant_6) <= ((fun.GCD.next(Heap, Current, local3, (local1) > (local2))) - (local3)))) || ((0) <= (variant_6)); // type:termination tag:bounded line:38 varid:2
  assert {:subsumption 0} ((((local1) + (local2)) <= (variant_5)) && (!((variant_5) <= ((local1) + (local2))))) || ((((local1) + (local2)) <= (variant_5)) && ((variant_5) <= ((local1) + (local2))) && (((fun.GCD.next(Heap, Current, local3, (local1) > (local2))) - (local3)) <= (variant_6)) && (!((variant_6) <= ((fun.GCD.next(Heap, Current, local3, (local1) > (local2))) - (local3))))); // type:termination tag:variant_decreases line:38
  goto loop_head_1;
  loop_end_3:
  assume (local1) == (local2);
  // /home/caf/temp/comcom/repo-gcd/gcd.e:50
  // Result := a
  Result := local1;
}

procedure GCD.gcd(Current: ref, a: int, b: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, GCD); // info:type property for argument Current
  ...
  modifies Heap;
  requires (0) < (a); // type:pre tag:a_positive line:62
  requires (0) < (b); // type:pre tag:b_positive line:63
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.GCD.gcd(Heap, Current, a, b), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.GCD.gcd(old(Heap), Current, a, b));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.GCD.gcd(Heap, Current, a, b), readable);



function fun.GCD.gcd(heap: HeapType, current: ref, a: int, b: int) returns (int);

function fun0.GCD.gcd(heap: HeapType, current: ref, a: int, b: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a: int, b: int :: { fun.GCD.gcd(heap, current, a, b) } (pre.fun.GCD.gcd(heap, current, a, b)) ==> (is_integer_32(fun.GCD.gcd(heap, current, a, b)))));

axiom ((forall heap: HeapType, current: ref, a: int, b: int :: { fun.GCD.gcd(heap, current, a, b) } { trigger.fun.GCD.gcd(heap, current, a, b) } (pre.fun.GCD.gcd(heap, current, a, b)) ==> ((fun.GCD.gcd(heap, current, a, b)) == ((if (a) == (b) then a else (if (a) > (b) then fun0.GCD.gcd(heap, current, (a) - (b), b) else fun0.GCD.gcd(heap, current, a, (b) - (a))))))));

axiom ((forall heap: HeapType, current: ref, a: int, b: int :: { fun.GCD.gcd(heap, current, a, b) } (fun.GCD.gcd(heap, current, a, b)) == (fun0.GCD.gcd(heap, current, a, b))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: int, b: int :: { HeapSucc(h, h'), fun0.GCD.gcd(h, current, a, b), fun0.GCD.gcd(h', current, a, b) } ((HeapSucc(h, h')) && (pre.fun.GCD.gcd(h, current, a, b)) && (pre.fun.GCD.gcd(h', current, a, b)) && (same_inside(h, h', read.fun.GCD.gcd(h, current, a, b)))) ==> ((fun0.GCD.gcd(h, current, a, b)) == (fun0.GCD.gcd(h', current, a, b)))));

function { :inline } variant.GCD.gcd.1(heap: HeapType, current: ref, a: int, b: int) returns (int) {
  a
}

function { :inline } variant.GCD.gcd.2(heap: HeapType, current: ref, a: int, b: int) returns (int) {
  b
}

implementation GCD.gcd(Current: ref, a: int, b: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "GCD.gcd"} true;
  // /home/caf/temp/comcom/repo-gcd/gcd.e:65
  // Result := if a = b then a else
  assert ((!((a) == (b))) && ((a) > (b))) ==> (Frame#Subset(read.fun.GCD.gcd(Heap, Current, (a) - (b), b), readable)); // type:access tag:frame_readable line:65 cid:404 rid:5402
  assert ((!((a) == (b))) && ((a) > (b))) ==> (pre.fun.GCD.gcd(Heap, Current, (a) - (b), b)); // type:check tag:function_precondition line:65 cid:404 rid:5402
  assert {:subsumption 0} ((!((a) == (b))) && ((a) > (b))) ==> ((((variant.GCD.gcd.1(Heap, Current, (a) - (b), b)) <= (variant.GCD.gcd.1(old(Heap), Current, a, b))) && ((variant.GCD.gcd.1(old(Heap), Current, a, b)) <= (variant.GCD.gcd.1(Heap, Current, (a) - (b), b)))) || ((0) <= (variant.GCD.gcd.1(old(Heap), Current, a, b)))); // type:termination tag:bounded line:65 varid:1
  assert {:subsumption 0} ((!((a) == (b))) && ((a) > (b))) ==> ((((variant.GCD.gcd.1(Heap, Current, (a) - (b), b)) <= (variant.GCD.gcd.1(old(Heap), Current, a, b))) && (!((variant.GCD.gcd.1(old(Heap), Current, a, b)) <= (variant.GCD.gcd.1(Heap, Current, (a) - (b), b))))) || (((variant.GCD.gcd.2(Heap, Current, (a) - (b), b)) <= (variant.GCD.gcd.2(old(Heap), Current, a, b))) && ((variant.GCD.gcd.2(old(Heap), Current, a, b)) <= (variant.GCD.gcd.2(Heap, Current, (a) - (b), b)))) || ((0) <= (variant.GCD.gcd.2(old(Heap), Current, a, b)))); // type:termination tag:bounded line:65 varid:2
  assert {:subsumption 0} ((!((a) == (b))) && ((a) > (b))) ==> ((((variant.GCD.gcd.1(Heap, Current, (a) - (b), b)) <= (variant.GCD.gcd.1(old(Heap), Current, a, b))) && (!((variant.GCD.gcd.1(old(Heap), Current, a, b)) <= (variant.GCD.gcd.1(Heap, Current, (a) - (b), b))))) || (((variant.GCD.gcd.1(Heap, Current, (a) - (b), b)) <= (variant.GCD.gcd.1(old(Heap), Current, a, b))) && ((variant.GCD.gcd.1(old(Heap), Current, a, b)) <= (variant.GCD.gcd.1(Heap, Current, (a) - (b), b))) && ((variant.GCD.gcd.2(Heap, Current, (a) - (b), b)) <= (variant.GCD.gcd.2(old(Heap), Current, a, b))) && (!((variant.GCD.gcd.2(old(Heap), Current, a, b)) <= (variant.GCD.gcd.2(Heap, Current, (a) - (b), b)))))); // type:termination tag:variant_decreases line:65
  assert ((!((a) == (b))) && (!((a) > (b)))) ==> (Frame#Subset(read.fun.GCD.gcd(Heap, Current, a, (b) - (a)), readable)); // type:access tag:frame_readable line:65 cid:404 rid:5402
  assert ((!((a) == (b))) && (!((a) > (b)))) ==> (pre.fun.GCD.gcd(Heap, Current, a, (b) - (a))); // type:check tag:function_precondition line:65 cid:404 rid:5402
  assert {:subsumption 0} ((!((a) == (b))) && (!((a) > (b)))) ==> ((((variant.GCD.gcd.1(Heap, Current, a, (b) - (a))) <= (variant.GCD.gcd.1(old(Heap), Current, a, b))) && ((variant.GCD.gcd.1(old(Heap), Current, a, b)) <= (variant.GCD.gcd.1(Heap, Current, a, (b) - (a))))) || ((0) <= (variant.GCD.gcd.1(old(Heap), Current, a, b)))); // type:termination tag:bounded line:65 varid:1
  assert {:subsumption 0} ((!((a) == (b))) && (!((a) > (b)))) ==> ((((variant.GCD.gcd.1(Heap, Current, a, (b) - (a))) <= (variant.GCD.gcd.1(old(Heap), Current, a, b))) && (!((variant.GCD.gcd.1(old(Heap), Current, a, b)) <= (variant.GCD.gcd.1(Heap, Current, a, (b) - (a)))))) || (((variant.GCD.gcd.2(Heap, Current, a, (b) - (a))) <= (variant.GCD.gcd.2(old(Heap), Current, a, b))) && ((variant.GCD.gcd.2(old(Heap), Current, a, b)) <= (variant.GCD.gcd.2(Heap, Current, a, (b) - (a))))) || ((0) <= (variant.GCD.gcd.2(old(Heap), Current, a, b)))); // type:termination tag:bounded line:65 varid:2
  assert {:subsumption 0} ((!((a) == (b))) && (!((a) > (b)))) ==> ((((variant.GCD.gcd.1(Heap, Current, a, (b) - (a))) <= (variant.GCD.gcd.1(old(Heap), Current, a, b))) && (!((variant.GCD.gcd.1(old(Heap), Current, a, b)) <= (variant.GCD.gcd.1(Heap, Current, a, (b) - (a)))))) || (((variant.GCD.gcd.1(Heap, Current, a, (b) - (a))) <= (variant.GCD.gcd.1(old(Heap), Current, a, b))) && ((variant.GCD.gcd.1(old(Heap), Current, a, b)) <= (variant.GCD.gcd.1(Heap, Current, a, (b) - (a)))) && ((variant.GCD.gcd.2(Heap, Current, a, (b) - (a))) <= (variant.GCD.gcd.2(old(Heap), Current, a, b))) && (!((variant.GCD.gcd.2(old(Heap), Current, a, b)) <= (variant.GCD.gcd.2(Heap, Current, a, (b) - (a))))))); // type:termination tag:variant_decreases line:65
  Result := (if (a) == (b) then a else (if (a) > (b) then fun.GCD.gcd(Heap, Current, (a) - (b), b) else fun.GCD.gcd(Heap, Current, a, (b) - (a))));
}

procedure GCD.next(Current: ref, i: int, val: bool) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, GCD); // info:type property for argument Current
  free requires is_integer_32(i); // info:type property for argument i
  free requires true; // info:type property for argument val
  modifies Heap;
  requires ((1) <= (i)) && ((i) <= (Seq#Length(Heap[Current, GCD.a_turn]))); // type:pre line:77
  ensures ((i) <= (Result)) && ((Result) <= (Seq#Length(Heap[Current, GCD.a_turn]))); // type:post tag:valid_index line:81
  ensures pre.fun.MML_SEQUENCE^BOOLEAN^.item(Heap[Current, GCD.a_turn], Result); // type:check tag:function_precondition line:82 cid:125 rid:3286
  ensures (Seq#Item(Heap[Current, GCD.a_turn], Result)) == (val); // type:post tag:correct_value line:82
  ensures (forall i_7: int :: (((i) <= (i_7)) && ((i_7) <= ((Result) - (1)))) ==> (pre.fun.MML_SEQUENCE^BOOLEAN^.item(Heap[Current, GCD.a_turn], i_7))); // type:check tag:function_precondition line:83 cid:125 rid:3286
  ensures (forall i_7: int :: (((i) <= (i_7)) && ((i_7) <= ((Result) - (1)))) ==> ((Seq#Item(Heap[Current, GCD.a_turn], i_7)) != (val))); // type:post tag:first_correct_value line:83
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.GCD.next(Heap, Current, i, val), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.GCD.next(old(Heap), Current, i, val));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.GCD.next(Heap, Current, i, val), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.GCD.next(old(Heap), Current, i, val));



function fun.GCD.next(heap: HeapType, current: ref, i: int, val: bool) returns (int);

axiom ((forall heap: HeapType, current: ref, i: int, val: bool :: { fun.GCD.next(heap, current, i, val) } (pre.fun.GCD.next(heap, current, i, val)) ==> (((i) <= (fun.GCD.next(heap, current, i, val))) && ((fun.GCD.next(heap, current, i, val)) <= (Seq#Length(heap[current, GCD.a_turn]))) && ((Seq#Item(heap[current, GCD.a_turn], fun.GCD.next(heap, current, i, val))) == (val)) && ((forall i_8: int :: (((i) <= (i_8)) && ((i_8) <= ((fun.GCD.next(heap, current, i, val)) - (1)))) ==> ((Seq#Item(heap[current, GCD.a_turn], i_8)) != (val)))) && (is_integer_32(fun.GCD.next(heap, current, i, val))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, i: int, val: bool :: { HeapSucc(h, h'), fun.GCD.next(h, current, i, val), fun.GCD.next(h', current, i, val) } ((HeapSucc(h, h')) && (pre.fun.GCD.next(h, current, i, val)) && (pre.fun.GCD.next(h', current, i, val)) && (same_inside(h, h', read.fun.GCD.next(h, current, i, val)))) ==> ((fun.GCD.next(h, current, i, val)) == (fun.GCD.next(h', current, i, val)))));

function { :inline } variant.GCD.next.1(heap: HeapType, current: ref, i: int, val: bool) returns (int) {
  i
}

function { :inline } variant.GCD.next.2(heap: HeapType, current: ref, i: int, val: bool) returns (bool) {
  val
}

implementation GCD.next(Current: ref, i: int, val: bool) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "GCD.next"} true;
  // /home/caf/temp/comcom/repo-gcd/gcd.e:79
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, GCD)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, GCD)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, GCD)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.GCD.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, GCD)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.GCD.in_observers(heap, current, v, o)))));

function modify.GCD.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.GCD.default_create(heap, current)[$o, $f] } (modify.GCD.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.GCD.gcd_nondeterministic(heap: HeapType, current: ref, a_: int, b_: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_: int, b_: int :: (IsHeap(heap)) ==> ((forall <T6> $o: ref, $f: Field T6 :: { modify.GCD.gcd_nondeterministic(heap, current, a_, b_)[$o, $f] } (modify.GCD.gcd_nondeterministic(heap, current, a_, b_)[$o, $f]) <==> (false)))));

function read.fun.GCD.gcd_nondeterministic(heap: HeapType, current: ref, a_: int, b_: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_: int, b_: int :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { read.fun.GCD.gcd_nondeterministic(heap, current, a_, b_)[$o, $f] } (read.fun.GCD.gcd_nondeterministic(heap, current, a_, b_)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.GCD.gcd_nondeterministic(heap: HeapType, current: ref, a_: int, b_: int) returns (bool) {
  ((a_) > (0)) && ((b_) > (0)) && (is_closed(heap, current))
}

function trigger.fun.GCD.gcd_nondeterministic(heap: HeapType, current: ref, a_: int, b_: int) returns (bool);

const GCD.a_turn: Field (Seq bool);

axiom ((FieldId(GCD.a_turn, GCD)) == (82));

axiom ((forall heap: HeapType, current: ref, v: Seq bool, o: ref :: { guard(heap, current, GCD.a_turn, v, o) } (attached_exact(heap, current, GCD)) ==> ((guard(heap, current, GCD.a_turn, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, GCD.a_turn := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: Seq bool, o: ref :: { guard(heap, current, GCD.a_turn, v, o) } (attached(heap, current, GCD)) ==> ((guard(heap, current, GCD.a_turn, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, GCD.a_turn := v], o))))));

function modify.GCD.gcd(heap: HeapType, current: ref, a: int, b: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: int, b: int :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.GCD.gcd(heap, current, a, b)[$o, $f] } (modify.GCD.gcd(heap, current, a, b)[$o, $f]) <==> (false)))));

function read.fun.GCD.gcd(heap: HeapType, current: ref, a: int, b: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: int, b: int :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { read.fun.GCD.gcd(heap, current, a, b)[$o, $f] } (read.fun.GCD.gcd(heap, current, a, b)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.GCD.gcd(heap: HeapType, current: ref, a: int, b: int) returns (bool) {
  ((0) < (a)) && ((0) < (b))
}

function trigger.fun.GCD.gcd(heap: HeapType, current: ref, a: int, b: int) returns (bool);

function modify.GCD.next(heap: HeapType, current: ref, i: int, val: bool) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int, val: bool :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { modify.GCD.next(heap, current, i, val)[$o, $f] } (modify.GCD.next(heap, current, i, val)[$o, $f]) <==> (false)))));

function read.fun.GCD.next(heap: HeapType, current: ref, i: int, val: bool) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int, val: bool :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { read.fun.GCD.next(heap, current, i, val)[$o, $f] } (read.fun.GCD.next(heap, current, i, val)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.GCD.next(heap: HeapType, current: ref, i: int, val: bool) returns (bool) {
  ((1) <= (i)) && ((i) <= (Seq#Length(heap[current, GCD.a_turn]))) && (is_closed(heap, current))
}

function trigger.fun.GCD.next(heap: HeapType, current: ref, i: int, val: bool) returns (bool);
...
procedure GCD.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, GCD); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.GCD.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.GCD.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.GCD.in_observers(Heap, Current, new_observers, o), readable);



function fun.GCD.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.GCD.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.GCD.in_observers(heap, current, new_observers, o) } { trigger.fun.GCD.in_observers(heap, current, new_observers, o) } (pre.fun.GCD.in_observers(heap, current, new_observers, o)) ==> ((fun.GCD.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.GCD.in_observers(heap, current, new_observers, o) } (fun.GCD.in_observers(heap, current, new_observers, o)) == (fun0.GCD.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.GCD.in_observers(h, current, new_observers, o), fun0.GCD.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.GCD.in_observers(h, current, new_observers, o)) && (pre.fun.GCD.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.GCD.in_observers(h, current, new_observers, o)))) ==> ((fun0.GCD.in_observers(h, current, new_observers, o)) == (fun0.GCD.in_observers(h', current, new_observers, o)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { modify.ANY.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.ANY.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.ANY.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { read.fun.ANY.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.ANY.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
function modify.GCD.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { modify.GCD.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.GCD.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.GCD.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { read.fun.GCD.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.GCD.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.GCD.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.GCD.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
