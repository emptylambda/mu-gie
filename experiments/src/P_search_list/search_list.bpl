// Automatically generated (12/12/2017 1:54:38.619 PM)
...
implementation SINGLY_LINKED_LIST.invariant_admissibility_check(Current: ref)
{
  ...
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.count]; // type:access tag:attribute_readable line:116 cid:404 fid:82
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.sequence]; // type:access tag:attribute_readable line:116 cid:404 fid:86
  assume (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) == (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence]));
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.sequence]; // type:access tag:attribute_readable line:117 cid:404 fid:86
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:117 cid:404 fid:87
  assume (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence])) == (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]));
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:118 cid:404 fid:87
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.first]; // type:access tag:attribute_readable line:118 cid:404 fid:80
  assume (Seq#IsEmpty(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) == ((Heap[Current, SINGLY_LINKED_LIST^ANY^.first]) == (Void));
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:119 cid:404 fid:87
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.last]; // type:access tag:attribute_readable line:119 cid:404 fid:81
  assume (Seq#IsEmpty(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) == ((Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) == (Void));
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:120 cid:404 fid:87
  assume Set#Equal(Heap[Current, owns], Seq#Range(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]));
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:121 cid:404 fid:87
  assume Seq#NonNull(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]);
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:122 cid:404 fid:87
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.sequence]; // type:access tag:attribute_readable line:122 cid:404 fid:86
  assert (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])))) ==> (pre.fun.MML_SEQUENCE^ANY^.item(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], i_2))); // type:check tag:function_precondition line:122 cid:125 rid:3286
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:122 cid:404 fid:87
  assert (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])))) ==> (pre.fun.MML_SEQUENCE^LINKED_NODE^ANY^^.item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], i_2))); // type:check tag:function_precondition line:122 cid:125 rid:3286
  assert (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])))) ==> ((Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], i_2)) != (Void))); // type:attached tag:sequence_implementation line:122
  assert (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])))) ==> (user_inv_readable(Heap, Current)[Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], i_2), LINKED_NODE^ANY^.value])); // type:access tag:attribute_readable line:122 cid:405 fid:81
  ...
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:123 cid:404 fid:87
  assert Frame#Subset(read.fun.SINGLY_LINKED_LIST^ANY^.is_linked(Heap, Current, Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]), user_inv_readable(Heap, Current)); // type:access tag:frame_readable line:123 cid:404 rid:5414
  assert pre.fun.SINGLY_LINKED_LIST^ANY^.is_linked(Heap, Current, Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:check tag:function_precondition line:123 cid:404 rid:5414
  assume fun.SINGLY_LINKED_LIST^ANY^.is_linked(Heap, Current, Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]);
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:124 cid:404 fid:87
  assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> (user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.first]); // type:access tag:attribute_readable line:124 cid:404 fid:80
  assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> (user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:access tag:attribute_readable line:124 cid:404 fid:87
  assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> (pre.fun.MML_SEQUENCE^LINKED_NODE^ANY^^.first(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])); // type:check tag:function_precondition line:124 cid:125 rid:3296
  ...
  assert user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]; // type:access tag:attribute_readable line:125 cid:404 fid:87
  assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> (user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.last]); // type:access tag:attribute_readable line:125 cid:404 fid:81
  assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> (user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:access tag:attribute_readable line:125 cid:404 fid:87
  assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> (pre.fun.MML_SEQUENCE^LINKED_NODE^ANY^^.last(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])); // type:check tag:function_precondition line:125 cid:125 rid:3297
  assert (((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) && ((Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) == (Seq#Last(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])))) ==> (user_inv_readable(Heap, Current)[Current, SINGLY_LINKED_LIST^ANY^.last]); // type:access tag:attribute_readable line:125 cid:404 fid:81
  assert {:subsumption 0} (((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) && ((Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) == (Seq#Last(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])))) ==> ((Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) != (Void)); // type:attached tag:nodes_last line:125
...
procedure create.SINGLY_LINKED_LIST^ANY^.default_create(Current: ref);
  ...
  ensures (forall <T4> $f: Field T4 :: ((($f) != (allocated)) && (($f) != (closed)) && (($f) != (owns))) ==> ((Heap[Current, $f]) == (Default($f))));
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SINGLY_LINKED_LIST^ANY^.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SINGLY_LINKED_LIST^ANY^.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.SINGLY_LINKED_LIST^ANY^.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.SINGLY_LINKED_LIST^ANY^.default_create"} true;
  if (modify.SINGLY_LINKED_LIST^ANY^.default_create(Heap, Current)[Current, owns]) {
    call update_heap(Current, owns, SINGLY_LINKED_LIST^ANY^.owns.static(Heap, Current)); // default:owns line:364
  }
  if (*) {
    assert (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) == (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence])); // type:inv tag:count_definition line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence])) == (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])); // type:inv tag:nodes_domain line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (Seq#IsEmpty(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) == ((Heap[Current, SINGLY_LINKED_LIST^ANY^.first]) == (Void)); // type:inv tag:first_void line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (Seq#IsEmpty(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) == ((Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) == (Void)); // type:inv tag:last_void line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#Equal(Heap[Current, owns], Seq#Range(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])); // type:inv tag:owns_definition line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Seq#NonNull(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:inv tag:nodes_exist line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (forall i_3: int :: (((1) <= (i_3)) && ((i_3) <= (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])))) ==> ((Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], i_3)) == (Heap[Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], i_3), LINKED_NODE^ANY^.value]))); // type:inv tag:sequence_implementation line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert fun.SINGLY_LINKED_LIST^ANY^.is_linked(Heap, Current, Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:inv tag:nodes_linked line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> ((Heap[Current, SINGLY_LINKED_LIST^ANY^.first]) == (Seq#First(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]))); // type:inv tag:nodes_first line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> (((Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) == (Seq#Last(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]))) && ((Heap[Heap[Current, SINGLY_LINKED_LIST^ANY^.last], LINKED_NODE^ANY^.next]) == (Void))); // type:inv tag:nodes_last line:364 cid:1 rid:55
    assume false;
  }
  if (*) {
...
implementation SINGLY_LINKED_LIST^ANY^.is_empty(Current: ref) returns (Result: bool)
{
  ...
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:27
  // Result := first = Void
  assert readable[Current, SINGLY_LINKED_LIST^ANY^.first]; // type:access tag:attribute_readable line:27 cid:404 fid:80
...
procedure SINGLY_LINKED_LIST^ANY^.extend_back(Current: ref, a_value: ref);
  ...
  modifies Heap;
  ensures Seq#Equal(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], Seq#Extended(old(Heap)[Current, SINGLY_LINKED_LIST^ANY^.sequence], a_value)); // type:post tag:sequence_effect line:49
  ensures Seq#Equal(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], Seq#Extended(old(Heap)[Current, SINGLY_LINKED_LIST^ANY^.nodes], Heap[Current, SINGLY_LINKED_LIST^ANY^.last])); // type:post tag:nodes_effect line:50
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
...
implementation SINGLY_LINKED_LIST^ANY^.extend_back(Current: ref, a_value: ref)
{
  ...
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:37
  // create l_node.make (a_value)
  call temp_4 := allocate(LINKED_NODE^ANY^); // line:-1
  call create.LINKED_NODE^ANY^.make(temp_4, a_value); // line:37 cid:405 rid:5401
  local1 := temp_4;
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:38
  // if first = Void then
  if ((Heap[Current, SINGLY_LINKED_LIST^ANY^.first]) == (Void)) {
    // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:39
    // first := l_node
    call update_heap(Current, SINGLY_LINKED_LIST^ANY^.first, local1); // line:39
  } else {
    // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:41
    // last.set_next (l_node)
    assert {:subsumption 0} (Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) != (Void); // type:attached line:41
    call LINKED_NODE^ANY^.set_next(Heap[Current, SINGLY_LINKED_LIST^ANY^.last], local1); // line:41 cid:405 rid:5404
  }
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:43
  // last := l_node
  call update_heap(Current, SINGLY_LINKED_LIST^ANY^.last, local1); // line:43
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:44
  // count := count + 1
  call update_heap(Current, SINGLY_LINKED_LIST^ANY^.count, (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1)); // line:44
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:46
  // nodes := nodes & l_node
  call update_heap(Current, SINGLY_LINKED_LIST^ANY^.nodes, Seq#Extended(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], local1)); // line:46
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:47
  // sequence := sequence & a_value
  call update_heap(Current, SINGLY_LINKED_LIST^ANY^.sequence, Seq#Extended(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], a_value)); // line:47
  if (modify.SINGLY_LINKED_LIST^ANY^.extend_back(Heap, Current, a_value)[Current, owns]) {
    call update_heap(Current, owns, SINGLY_LINKED_LIST^ANY^.owns.static(Heap, Current)); // default:owns line:51
  }
  if (*) {
    assert (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) == (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence])); // type:inv tag:count_definition line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence])) == (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])); // type:inv tag:nodes_domain line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (Seq#IsEmpty(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) == ((Heap[Current, SINGLY_LINKED_LIST^ANY^.first]) == (Void)); // type:inv tag:first_void line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (Seq#IsEmpty(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) == ((Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) == (Void)); // type:inv tag:last_void line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#Equal(Heap[Current, owns], Seq#Range(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])); // type:inv tag:owns_definition line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Seq#NonNull(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:inv tag:nodes_exist line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (forall i_5: int :: (((1) <= (i_5)) && ((i_5) <= (Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])))) ==> ((Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], i_5)) == (Heap[Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], i_5), LINKED_NODE^ANY^.value]))); // type:inv tag:sequence_implementation line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert fun.SINGLY_LINKED_LIST^ANY^.is_linked(Heap, Current, Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:inv tag:nodes_linked line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> ((Heap[Current, SINGLY_LINKED_LIST^ANY^.first]) == (Seq#First(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]))); // type:inv tag:nodes_first line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert ((Seq#Length(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes])) > (0)) ==> (((Heap[Current, SINGLY_LINKED_LIST^ANY^.last]) == (Seq#Last(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes]))) && ((Heap[Heap[Current, SINGLY_LINKED_LIST^ANY^.last], LINKED_NODE^ANY^.next]) == (Void))); // type:inv tag:nodes_last line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, observers]); // type:inv tag:default_observers line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, subjects]); // type:inv tag:default_subjects line:51 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert admissibility2(Heap, Current); // type:inv tag:A2 line:51 cid:1 rid:55
    assume false;
  }
  call wrap(Current); // default:wrapping cid:1 rid:55 line:51
}

procedure SINGLY_LINKED_LIST^ANY^.index_of(Current: ref, v: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, SINGLY_LINKED_LIST^ANY^); // info:type property for argument Current
  free requires Heap[v, allocated]; // info:type property for argument v
  modifies Heap;
  requires (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) > (0); // type:pre line:59
  ensures (!(Seq#Has(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], v))) ==> ((Result) == ((Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1))); // type:post tag:not_found line:81
  ensures ((Seq#Has(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], v)) && ((1) <= (Result)) && ((Result) <= (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]))) ==> (pre.fun.MML_SEQUENCE^ANY^.item(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], Result)); // type:check tag:function_precondition line:82 cid:125 rid:3286
  ensures (Seq#Has(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], v)) ==> (((1) <= (Result)) && ((Result) <= (Heap[Current, SINGLY_LINKED_LIST^ANY^.count])) && ((Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], Result)) == (v))); // type:post tag:found line:82
  ensures !(Seq#Has(Seq#Front(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], (Result) - (1)), v)); // type:post tag:v_not_in_front line:83
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SINGLY_LINKED_LIST^ANY^.index_of(Heap, Current, v), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SINGLY_LINKED_LIST^ANY^.index_of(old(Heap), Current, v));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SINGLY_LINKED_LIST^ANY^.index_of(Heap, Current, v), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.SINGLY_LINKED_LIST^ANY^.index_of(old(Heap), Current, v));



function fun.SINGLY_LINKED_LIST^ANY^.index_of(heap: HeapType, current: ref, v: ref) returns (int);

axiom ((forall heap: HeapType, current: ref, v: ref :: { fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v) } (pre.fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v)) ==> (((!(Seq#Has(heap[current, SINGLY_LINKED_LIST^ANY^.sequence], v))) ==> ((fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v)) == ((heap[current, SINGLY_LINKED_LIST^ANY^.count]) + (1)))) && ((Seq#Has(heap[current, SINGLY_LINKED_LIST^ANY^.sequence], v)) ==> (((1) <= (fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v))) && ((fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v)) <= (heap[current, SINGLY_LINKED_LIST^ANY^.count])) && ((Seq#Item(heap[current, SINGLY_LINKED_LIST^ANY^.sequence], fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v))) == (v)))) && (!(Seq#Has(Seq#Front(heap[current, SINGLY_LINKED_LIST^ANY^.sequence], (fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v)) - (1)), v))) && (is_integer_32(fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, v: ref :: { HeapSucc(h, h'), fun.SINGLY_LINKED_LIST^ANY^.index_of(h, current, v), fun.SINGLY_LINKED_LIST^ANY^.index_of(h', current, v) } ((HeapSucc(h, h')) && (pre.fun.SINGLY_LINKED_LIST^ANY^.index_of(h, current, v)) && (pre.fun.SINGLY_LINKED_LIST^ANY^.index_of(h', current, v)) && (same_inside(h, h', read.fun.SINGLY_LINKED_LIST^ANY^.index_of(h, current, v)))) ==> ((fun.SINGLY_LINKED_LIST^ANY^.index_of(h, current, v)) == (fun.SINGLY_LINKED_LIST^ANY^.index_of(h', current, v)))));

function { :inline } variant.SINGLY_LINKED_LIST^ANY^.index_of.1(heap: HeapType, current: ref, v: ref) returns (ref) {
  v
}

implementation SINGLY_LINKED_LIST^ANY^.index_of(Current: ref, v: ref) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "SINGLY_LINKED_LIST^ANY^.index_of"} true;
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:64
  // i := first
  assert readable[Current, SINGLY_LINKED_LIST^ANY^.first]; // type:access tag:attribute_readable line:64 cid:404 rid:5406
  local1 := Heap[Current, SINGLY_LINKED_LIST^ANY^.first];
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:65
  // Result := 1
  Result := 1;
  PreLoopHeap_9 := Heap;
  goto loop_head_6;
  loop_head_6:
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:67
  // result_in_range: 1 <= Result and Result <= count + 1
  assert readable[Current, SINGLY_LINKED_LIST^ANY^.count]; // type:access tag:attribute_readable line:67 cid:404 fid:82
  assert ((1) <= (Result)) && ((Result) <= ((Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1))); // type:loop_inv tag:result_in_range line:67
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:68
  // result_c_relation: 1 <= Result and Result <= count implies i = nodes[Result]
  assert readable[Current, SINGLY_LINKED_LIST^ANY^.count]; // type:access tag:attribute_readable line:68 cid:404 fid:82
  assert (((1) <= (Result)) && ((Result) <= (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]))) ==> (readable[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:access tag:attribute_readable line:68 cid:404 fid:87
  assert (((1) <= (Result)) && ((Result) <= (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]))) ==> (pre.fun.MML_SEQUENCE^LINKED_NODE^ANY^^.item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], Result)); // type:check tag:function_precondition line:68 cid:125 rid:3286
  assert (((1) <= (Result)) && ((Result) <= (Heap[Current, SINGLY_LINKED_LIST^ANY^.count]))) ==> ((local1) == (Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], Result))); // type:loop_inv tag:result_c_relation line:68
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:69
  // i_at_end: i = Void implies Result = count + 1
  assert ((local1) == (Void)) ==> (readable[Current, SINGLY_LINKED_LIST^ANY^.count]); // type:access tag:attribute_readable line:69 cid:404 fid:82
  assert ((local1) == (Void)) ==> ((Result) == ((Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1))); // type:loop_inv tag:i_at_end line:69
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:70
  // i_in_range: i /= Void implies i = nodes[Result]
  assert ((local1) != (Void)) ==> (readable[Current, SINGLY_LINKED_LIST^ANY^.nodes]); // type:access tag:attribute_readable line:70 cid:404 fid:87
  assert ((local1) != (Void)) ==> (pre.fun.MML_SEQUENCE^LINKED_NODE^ANY^^.item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], Result)); // type:check tag:function_precondition line:70 cid:125 rid:3286
  assert ((local1) != (Void)) ==> ((local1) == (Seq#Item(Heap[Current, SINGLY_LINKED_LIST^ANY^.nodes], Result))); // type:loop_inv tag:i_in_range line:70
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:71
  // v_not_yet: not sequence.front (Result - 1).has (v)
  assert readable[Current, SINGLY_LINKED_LIST^ANY^.sequence]; // type:access tag:attribute_readable line:71 cid:404 fid:86
  assert !(Seq#Has(Seq#Front(Heap[Current, SINGLY_LINKED_LIST^ANY^.sequence], (Result) - (1)), v)); // type:loop_inv tag:v_not_yet line:71
  assume HeapSucc(PreLoopHeap_9, Heap);
  assume same_outside(old(Heap), Heap, modify.SINGLY_LINKED_LIST^ANY^.index_of(old(Heap), Current, v));
  assume global(Heap);
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:-1
  assert {:subsumption 0} (!((local1) == (Void))) ==> ((local1) != (Void)); // type:attached line:-1
  assert (!((local1) == (Void))) ==> (readable[local1, LINKED_NODE^ANY^.value]); // type:access tag:attribute_readable line:-1 cid:405 fid:81
  goto loop_body_7, loop_end_8;
  loop_body_7:
  assume !(((local1) == (Void)) || ((Heap[local1, LINKED_NODE^ANY^.value]) == (v)));
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:78
  // count + 1 - Result
  variant_10 := ((Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1)) - (Result);
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:75
  // Result := Result + 1
  Result := (Result) + (1);
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:76
  // i := i.next
  assert {:subsumption 0} (local1) != (Void); // type:attached line:76
  assert readable[local1, LINKED_NODE^ANY^.next]; // type:access tag:attribute_readable line:76 cid:405 rid:5403
  local1 := Heap[local1, LINKED_NODE^ANY^.next];
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:78
  // count + 1 - Result
  assert {:subsumption 0} (((((Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1)) - (Result)) <= (variant_10)) && ((variant_10) <= (((Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1)) - (Result)))) || ((0) <= (variant_10)); // type:termination tag:bounded line:78 varid:1
  assert {:subsumption 0} ((((Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1)) - (Result)) <= (variant_10)) && (!((variant_10) <= (((Heap[Current, SINGLY_LINKED_LIST^ANY^.count]) + (1)) - (Result)))); // type:termination tag:variant_decreases line:78
  goto loop_head_6;
  loop_end_8:
  assume ((local1) == (Void)) || ((Heap[local1, LINKED_NODE^ANY^.value]) == (v));
}
...
procedure SINGLY_LINKED_LIST^ANY^.is_linked(Current: ref, ns: Seq (ref)) returns (Result: bool where true);
  ...
  modifies Heap;
  requires Seq#NonNull(ns); // type:pre line:107
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
...
axiom ((forall heap: HeapType, current: ref, ns: Seq (ref) :: { fun.SINGLY_LINKED_LIST^ANY^.is_linked(heap, current, ns) } { trigger.fun.SINGLY_LINKED_LIST^ANY^.is_linked(heap, current, ns) } (pre.fun.SINGLY_LINKED_LIST^ANY^.is_linked(heap, current, ns)) ==> ((fun.SINGLY_LINKED_LIST^ANY^.is_linked(heap, current, ns)) == ((forall i_11: int :: (((1) <= (i_11)) && ((i_11) <= (Seq#Length(ns)))) ==> ((forall i_12: int :: (((1) <= (i_12)) && ((i_12) <= (Seq#Length(ns)))) ==> ((((i_11) + (1)) == (i_12)) ==> ((heap[Seq#Item(ns, i_11), LINKED_NODE^ANY^.next]) == (Seq#Item(ns, i_12)))))))))));
...
implementation SINGLY_LINKED_LIST^ANY^.is_linked(Current: ref, ns: Seq (ref)) returns (Result: bool)
{
  ...
  // /home/caf/temp/comcom/repo-search_list/singly_linked_list.e:110
  // Result := across 1 |..| ns.count as i all
  assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= (Seq#Length(ns)))) ==> ((true) ==> (pre.fun.MML_SEQUENCE^LINKED_NODE^ANY^^.item(ns, i_13)))); // type:check tag:function_precondition line:110 cid:125 rid:3286
  assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= (Seq#Length(ns)))) ==> ((true) ==> ((Seq#Item(ns, i_13)) != (Void)))); // type:attached line:110
  assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= (Seq#Length(ns)))) ==> ((true) ==> (readable[Seq#Item(ns, i_13), LINKED_NODE^ANY^.next]))); // type:access tag:attribute_readable line:110 cid:405 fid:82
  assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= (Seq#Length(ns)))) ==> ((forall i_14: int :: (((1) <= (i_14)) && ((i_14) <= (Seq#Length(ns)))) ==> ((((i_13) + (1)) == (i_14)) ==> (pre.fun.MML_SEQUENCE^LINKED_NODE^ANY^^.item(ns, i_14)))))); // type:check tag:function_precondition line:110 cid:125 rid:3286
  Result := (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= (Seq#Length(ns)))) ==> ((forall i_14: int :: (((1) <= (i_14)) && ((i_14) <= (Seq#Length(ns)))) ==> ((((i_13) + (1)) == (i_14)) ==> ((Heap[Seq#Item(ns, i_13), LINKED_NODE^ANY^.next]) == (Seq#Item(ns, i_14)))))));
}
...
axiom ((forall <T5> $f: Field T5 :: { IsModelField($f, LINKED_NODE^ANY^) } (IsModelField($f, LINKED_NODE^ANY^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));
...
implementation create.LINKED_NODE^ANY^.make(Current: ref, a_value: ref)
{
  ...
  // /home/caf/temp/comcom/repo-search_list/linked_node.e:17
  // value := a_value
...
implementation LINKED_NODE^ANY^.set_next(Current: ref, a_node: ref)
{
  ...
  // /home/caf/temp/comcom/repo-search_list/linked_node.e:38
  // next := a_node
...
axiom ((FieldId(SINGLY_LINKED_LIST^ANY^.count, SINGLY_LINKED_LIST^ANY^)) == (82));
...
axiom ((FieldId(SINGLY_LINKED_LIST^ANY^.sequence, SINGLY_LINKED_LIST^ANY^)) == (86));
...
axiom ((FieldId(SINGLY_LINKED_LIST^ANY^.nodes, SINGLY_LINKED_LIST^ANY^)) == (87));
...
axiom ((FieldId(SINGLY_LINKED_LIST^ANY^.first, SINGLY_LINKED_LIST^ANY^)) == (80));
...
axiom ((FieldId(SINGLY_LINKED_LIST^ANY^.last, SINGLY_LINKED_LIST^ANY^)) == (81));
...
function modify.SINGLY_LINKED_LIST^ANY^.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.SINGLY_LINKED_LIST^ANY^.default_create(heap, current)[$o, $f] } (modify.SINGLY_LINKED_LIST^ANY^.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.SINGLY_LINKED_LIST^ANY^.is_empty(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.SINGLY_LINKED_LIST^ANY^.is_empty(heap, current)[$o, $f] } (modify.SINGLY_LINKED_LIST^ANY^.is_empty(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SINGLY_LINKED_LIST^ANY^.is_empty(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { read.fun.SINGLY_LINKED_LIST^ANY^.is_empty(heap, current)[$o, $f] } (read.fun.SINGLY_LINKED_LIST^ANY^.is_empty(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, a_value: ref :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { modify.SINGLY_LINKED_LIST^ANY^.extend_back(heap, current, a_value)[$o, $f] } (modify.SINGLY_LINKED_LIST^ANY^.extend_back(heap, current, a_value)[$o, $f]) <==> (($o) == (current))))));

function modify.SINGLY_LINKED_LIST^ANY^.index_of(heap: HeapType, current: ref, v: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, v: ref :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v)[$o, $f] } (modify.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v)[$o, $f]) <==> (false)))));

function read.fun.SINGLY_LINKED_LIST^ANY^.index_of(heap: HeapType, current: ref, v: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, v: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { read.fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v)[$o, $f] } (read.fun.SINGLY_LINKED_LIST^ANY^.index_of(heap, current, v)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SINGLY_LINKED_LIST^ANY^.index_of(heap: HeapType, current: ref, v: ref) returns (bool) {
  ((heap[current, SINGLY_LINKED_LIST^ANY^.count]) > (0)) && (is_closed(heap, current))
}

function trigger.fun.SINGLY_LINKED_LIST^ANY^.index_of(heap: HeapType, current: ref, v: ref) returns (bool);

function modify.SINGLY_LINKED_LIST^ANY^.is_linked(heap: HeapType, current: ref, ns: Seq (ref)) returns (Frame);

axiom ((forall heap: HeapType, current: ref, ns: Seq (ref) :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.SINGLY_LINKED_LIST^ANY^.is_linked(heap, current, ns)[$o, $f] } (modify.SINGLY_LINKED_LIST^ANY^.is_linked(heap, current, ns)[$o, $f]) <==> (false)))));

function read.fun.SINGLY_LINKED_LIST^ANY^.is_linked(heap: HeapType, current: ref, ns: Seq (ref)) returns (Frame);

axiom ((forall heap: HeapType, current: ref, ns: Seq (ref) :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { read.fun.SINGLY_LINKED_LIST^ANY^.is_linked(heap, current, ns)[$o, $f] } (read.fun.SINGLY_LINKED_LIST^ANY^.is_linked(heap, current, ns)[$o, $f]) <==> (((Seq#Range(ns)[$o]) && (($f) == (LINKED_NODE^ANY^.next))) || ((false) && (($f) != (closed)) && (($f) != (owner))))))));
...
axiom ((forall heap: HeapType, current: ref, a_value: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { modify.LINKED_NODE^ANY^.make(heap, current, a_value)[$o, $f] } (modify.LINKED_NODE^ANY^.make(heap, current, a_value)[$o, $f]) <==> (($o) == (current))))));

function modify.LINKED_NODE^ANY^.set_next(heap: HeapType, current: ref, a_node: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a_node: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { modify.LINKED_NODE^ANY^.set_next(heap, current, a_node)[$o, $f] } (modify.LINKED_NODE^ANY^.set_next(heap, current, a_node)[$o, $f]) <==> ((($o) == (current)) && ((($f) == (LINKED_NODE^ANY^.next)) || (($f) == (closed))))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T17> $o: ref, $f: Field T17 :: { modify.ANY.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.ANY.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.ANY.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T18> $o: ref, $f: Field T18 :: { read.fun.ANY.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.ANY.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T19> $o: ref, $f: Field T19 :: { modify.SINGLY_LINKED_LIST^ANY^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SINGLY_LINKED_LIST^ANY^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T20> $o: ref, $f: Field T20 :: { read.fun.SINGLY_LINKED_LIST^ANY^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SINGLY_LINKED_LIST^ANY^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T21> $o: ref, $f: Field T21 :: { modify.LINKED_NODE^ANY^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.LINKED_NODE^ANY^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.LINKED_NODE^ANY^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T22> $o: ref, $f: Field T22 :: { read.fun.LINKED_NODE^ANY^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.LINKED_NODE^ANY^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
