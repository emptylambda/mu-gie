...
// Command Line Options: /compile:0 /noVerify /print:Problem1-SumMax.bpl Problem1-SumMax.dfy
...
implementation CheckWellformed$$_module.__default.M(N#0: int, a#0: ref) returns (sum#0: int, max#0: int)
{
  ...
  var k#0: int;
    ...
    assume {:captureState "Problem1-SumMax.dfy(13,7): initial state"} true;
    assume LitInt(0) <= N#0;
    assume a#0 != null;
    assert a#0 != null;
    ...
    havoc sum#0, max#0;
    assume {:captureState "Problem1-SumMax.dfy(15,14): post-state"} true;
    assume sum#0 <= N#0 * max#0;
}
...
implementation Impl$$_module.__default.M(N#0: int, a#0: ref) returns (sum#0: int, max#0: int, $_reverifyPost: bool)
{
  ...
  var $decr$loop#00: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "Problem1-SumMax.dfy(16,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- Problem1-SumMax.dfy(17,7)
    assume true;
    assume true;
    sum#0 := LitInt(0);
    assume {:captureState "Problem1-SumMax.dfy(17,10)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(18,7)
    assume true;
    assume true;
    max#0 := LitInt(0);
    assume {:captureState "Problem1-SumMax.dfy(18,10)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(19,9)
    assume true;
    assume true;
    i#0 := LitInt(0);
    assume {:captureState "Problem1-SumMax.dfy(19,12)"} true;
    // ----- while statement ----- Problem1-SumMax.dfy(20,3)
    ...
    while (true)
      ...
      invariant $w$loop#0 ==> sum#0 <= i#0 * max#0;
    ...
    {
        assume {:captureState "Problem1-SumMax.dfy(20,2): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            if (i#0 <= N#0)
            {
            ...
            assume true;
            assume i#0 <= N#0 && sum#0 <= i#0 * max#0;
            assume true;
            assume false;
        }
        ...
        // ----- if statement ----- Problem1-SumMax.dfy(23,5)
        assert a#0 != null;
        assert 0 <= i#0 && i#0 < _System.array.Length(a#0);
        assume true;
        if (max#0 < $Unbox(read($Heap, a#0, IndexField(i#0))): int)
        {
            // ----- assignment statement ----- Problem1-SumMax.dfy(24,11)
            assume true;
            assert a#0 != null;
            assert 0 <= i#0 && i#0 < _System.array.Length(a#0);
            assume true;
            max#0 := $Unbox(read($Heap, a#0, IndexField(i#0))): int;
            assume {:captureState "Problem1-SumMax.dfy(24,17)"} true;
        }
        else
        {
        }

        // ----- assignment statement ----- Problem1-SumMax.dfy(26,9)
        assume true;
        assert a#0 != null;
        assert 0 <= i#0 && i#0 < _System.array.Length(a#0);
        assume true;
        sum#0 := sum#0 + $Unbox(read($Heap, a#0, IndexField(i#0))): int;
        assume {:captureState "Problem1-SumMax.dfy(26,21)"} true;
        // ----- assignment statement ----- Problem1-SumMax.dfy(27,7)
        assume true;
        assume true;
        i#0 := i#0 + 1;
        assume {:captureState "Problem1-SumMax.dfy(27,14)"} true;
        // ----- loop termination check ----- Problem1-SumMax.dfy(20,3)
...
implementation Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var a##0: ref;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "Problem1-SumMax.dfy(32,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- Problem1-SumMax.dfy(33,9)
    assume true;
    assert 0 <= LitInt(10);
    havoc $nw;
    assume $nw != null
    ...
    a#0 := $nw;
    assume {:captureState "Problem1-SumMax.dfy(33,22)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(34,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(34,11)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(35,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(35,11)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(36,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(36,11)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(37,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(37,11)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(38,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(38,11)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(39,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(39,11)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(40,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(40,11)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(41,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(41,11)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(42,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(42,12)"} true;
    // ----- assignment statement ----- Problem1-SumMax.dfy(43,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "Problem1-SumMax.dfy(43,11)"} true;
    // ----- call statement ----- Problem1-SumMax.dfy(44,16)
    assume true;
    assume true;
    ...
    s#0 := $rhs##0;
    m#0 := $rhs##1;
    assume {:captureState "Problem1-SumMax.dfy(44,22)"} true;
    // ----- print statement ----- Problem1-SumMax.dfy(45,3)
    assume true;
