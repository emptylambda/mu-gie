...
// Command Line Options: /compile:0 /noVerify /print:b3.bpl b3.dfy
...
implementation CheckWellformed$$_module.Queue.Enqueue(_module.Queue$T: Ty, this: ref, x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "b3.dfy(21,9): initial state"} true;
    havoc $Heap;
    ...
    assume {:captureState "b3.dfy(23,21): post-state"} true;
...
implementation CheckWellformed$$_module.Queue.Dequeue(_module.Queue$T: Ty, this: ref) returns (x#0: Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == this);
    assume {:captureState "b3.dfy(24,9): initial state"} true;
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc x#0;
    assume {:captureState "b3.dfy(27,43): post-state"} true;
    assert $IsAlloc(this, Tclass._module.Queue(_module.Queue$T), old($Heap));
    assert 0 <= LitInt(1)
...
implementation CheckWellformed$$_module.Queue.Head(_module.Queue$T: Ty, this: ref)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "b3.dfy(28,18): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == this);
...
implementation CheckWellformed$$_module.Queue.Get(_module.Queue$T: Ty, this: ref, i#0: int)
{
  ...
  var b$reqreads#1: bool;
    ...
    assume {:captureState "b3.dfy(32,18): initial state"} true;
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == this);
    if (LitInt(0) <= i#0)
    {
...
axiom (forall $Heap: Heap, this: ref, c#0: ref ::
  { _module.Comparable.AtMost#requires($Heap, this, c#0) }
  $IsGoodHeap($Heap)
       &&
      this != null
       &&
...
implementation CheckWellformed$$_module.Benchmark3.Sort(this: ref, q#0: ref) returns (r#0: ref)
{
  ...
  var ##i#1: int;
    ...
    assume {:captureState "b3.dfy(45,9): initial state"} true;
    assume q#0 != null;
    havoc $Heap;
    assume (forall<alpha> $o: ref, $f: Field alpha ::
      { read($Heap, $o, $f) }
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc r#0;
    assume {:captureState "b3.dfy(48,22): post-state"} true;
    assume r#0 != null;
...
implementation Impl$$_module.Benchmark3.Sort(this: ref, q#0: ref) returns (r#0: ref, $_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
  var $nw: ref;
  ...
  var x##0_0: Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == q#0);
    assume {:captureState "b3.dfy(53,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- b3.dfy(54,7)
    assume true;
    havoc $nw;
    assume $nw != null
       &&
    ...
    // ----- init call statement ----- b3.dfy(54,25)
    ...
    assume {:captureState "b3.dfy(54,30)"} true;
    r#0 := $nw;
    assume {:captureState "b3.dfy(54,30)"} true;
    // ----- while statement ----- b3.dfy(55,5)
    ...
    while (true)
      ...
      free invariant (forall<alpha> $o: ref, $f: Field alpha ::
        { read($Heap, $o, $f) }
        $o != null && read(old($Heap), $o, alloc)
           ==> read($Heap, $o, $f) == read($PreLoopHeap$loop#0, $o, $f) || $o == q#0);
      ...
      free invariant (if Seq#Length(read($Heap, q#0, _module.Queue.contents)) <= LitInt(0)
         ...
         && ((if Seq#Length(read($Heap, q#0, _module.Queue.contents)) <= LitInt(0)
           ...
           ==> true);
    {
        assume {:captureState "b3.dfy(55,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
        ...
        // ----- assignment statement ----- b3.dfy(65,20)
        assume true;
        assert q#0 != null;
        assume true;
        qc#0_0 := read($Heap, q#0, _module.Queue.contents);
        assume {:captureState "b3.dfy(65,32)"} true;
        // ----- call statement ----- b3.dfy(66,27)
        assume true;
        assume true;
        ...
        m#0_0 := $rhs##0_0;
        k#0_0 := $rhs##0_1;
        assume {:captureState "b3.dfy(66,29)"} true;
        // ----- assert statement ----- b3.dfy(67,7)
        ...
        // ProcessCallStmt: Make the call
        call Call$$_module.Queue.Enqueue(TInt, r#0, x##0_0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "b3.dfy(68,18)"} true;
        // ----- loop termination check ----- b3.dfy(55,5)
...
implementation CheckWellformed$$_module.Benchmark3.RemoveMin(this: ref, q#0: ref) returns (m#0: int, k#0: int)
{
  ...
  var i#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == q#0);
    assume {:captureState "b3.dfy(72,9): initial state"} true;
    assume q#0 != null;
    assert q#0 != null;
    ...
    assume $HeapSucc(old($Heap), $Heap);
    havoc m#0, k#0;
    assume {:captureState "b3.dfy(75,30): post-state"} true;
    assert q#0 != null;
    assert $IsAlloc(q#0, Tclass._module.Queue(TInt), old($Heap));
    assert q#0 != null;
...
implementation Impl$$_module.Benchmark3.RemoveMin(this: ref, q#0: ref) returns (m#0: int, k#0: int, $_reverifyPost: bool)
{
  ...
  var $tmp##0: Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == q#0);
    assume {:captureState "b3.dfy(79,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- b3.dfy(80,11)
    assume true;
    assert q#0 != null;
    assume true;
    n#0 := Seq#Length(read($Heap, q#0, _module.Queue.contents));
    assume {:captureState "b3.dfy(80,25)"} true;
    // ----- assignment statement ----- b3.dfy(81,7)
    assume true;
    assume true;
    k#0 := LitInt(0);
    assume {:captureState "b3.dfy(81,10)"} true;
    // ----- assignment statement ----- b3.dfy(82,7)
    assume true;
    assert q#0 != null;
    ...
    assume {:captureState "b3.dfy(82,17)"} true;
    // ----- assignment statement ----- b3.dfy(83,11)
    assume true;
    assume true;
    j#0 := LitInt(0);
    assume {:captureState "b3.dfy(83,14)"} true;
    // ----- while statement ----- b3.dfy(84,5)
    // Assume Fuel Constant
    $PreLoopHeap$loop#0 := $Heap;
    ...
    {
        assume {:captureState "b3.dfy(84,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            assume true;
            assume j#0 <= n#0;
        ...
        // ----- assignment statement ----- b3.dfy(90,21)
        assume true;
        assert q#0 != null;
        assume true;
        qc0#0_0 := read($Heap, q#0, _module.Queue.contents);
        assume {:captureState "b3.dfy(90,33)"} true;
        // ----- call statement ----- b3.dfy(91,25)
        assume true;
        // TrCallStmt: Adding lhs Microsoft.Dafny.AutoGhostIdentifierExpr with type int
        // TrCallStmt: Before ProcessCallStmt
        assert q#0 != null;
        ...
        // TrCallStmt: After ProcessCallStmt
        x#0_0 := $rhs##0_0;
        assume {:captureState "b3.dfy(91,26)"} true;
        // ----- call statement ----- b3.dfy(92,16)
        // TrCallStmt: Before ProcessCallStmt
        assert q#0 != null;
        assume true;
        // ProcessCallStmt: CheckSubrange
        ...
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "b3.dfy(92,18)"} true;
        // ----- call statement ----- b3.dfy(93,20)
        // TrCallStmt: Before ProcessCallStmt
        assert q#0 != null;
        assert $IsAlloc(q#0, Tclass._module.Queue(TInt), old($Heap));
        assume true;
        ...
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "b3.dfy(93,56)"} true;
        // ----- if statement ----- b3.dfy(94,7)
        assume true;
        if (x#0_0 < m#0)
        {
            // ----- assignment statement ----- b3.dfy(94,20)
            assume true;
            assume true;
            k#0 := j#0;
            assume {:captureState "b3.dfy(94,23)"} true;
            // ----- assignment statement ----- b3.dfy(94,28)
            assume true;
            assume true;
            m#0 := x#0_0;
            assume {:captureState "b3.dfy(94,31)"} true;
        }
        else
        {
        }

        // ----- assignment statement ----- b3.dfy(95,9)
        assume true;
        assume true;
        j#0 := j#0 + 1;
        assume {:captureState "b3.dfy(95,14)"} true;
        // ----- loop termination check ----- b3.dfy(84,5)
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b3.dfy(98,16)"} true;
    // ----- assert statement ----- b3.dfy(100,5)
    assert {:subsumption 0} q#0 != null;
    assert {:subsumption 0} q#0 != null;
    assert $IsAlloc(q#0, Tclass._module.Queue(TInt), old($Heap));
    assert {:subsumption 0} 0 <= k#0 && k#0 <= Seq#Length(read(old($Heap), q#0, _module.Queue.contents));
    ...
    assert Seq#Equal(read($Heap, q#0, _module.Queue.contents),
      Seq#Append(Seq#Drop(read(old($Heap), q#0, _module.Queue.contents), k#0),
        Seq#Take(read(old($Heap), q#0, _module.Queue.contents), k#0)));
    // ----- assignment statement ----- b3.dfy(101,18)
    assume true;
    assert q#0 != null;
    assume true;
    qq#0 := read($Heap, q#0, _module.Queue.contents);
    assume {:captureState "b3.dfy(101,30)"} true;
    // ----- call statement ----- b3.dfy(102,19)
    assume true;
...
implementation CheckWellformed$$_module.Benchmark3.Rotate(this: ref, q#0: ref, k#0: int)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == q#0);
    assume {:captureState "b3.dfy(107,9): initial state"} true;
    assume q#0 != null;
    assert q#0 != null;
    ...
    assume (forall<alpha> $o: ref, $f: Field alpha ::
      ...
      $o != null && read(old($Heap), $o, alloc)
         ==> read($Heap, $o, $f) == read(old($Heap), $o, $f) || $o == q#0);
    assume $HeapSucc(old($Heap), $Heap);
    assume {:captureState "b3.dfy(110,23): post-state"} true;
    assert q#0 != null;
    assert q#0 != null;
    assert $IsAlloc(q#0, Tclass._module.Queue(TInt), old($Heap));
    assert 0 <= k#0 && k#0 <= Seq#Length(read(old($Heap), q#0, _module.Queue.contents));
...
implementation Impl$$_module.Benchmark3.Rotate(this: ref, q#0: ref, k#0: int) returns ($_reverifyPost: bool)
{
  ...
  var C##0_0: Seq Box;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> $o == q#0);
    assume {:captureState "b3.dfy(111,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- b3.dfy(112,11)
    assume true;
    assume true;
    j#0 := LitInt(0);
    assume {:captureState "b3.dfy(112,14)"} true;
    // ----- while statement ----- b3.dfy(113,5)
    // Assume Fuel Constant
    $PreLoopHeap$loop#0 := $Heap;
    ...
    {
        assume {:captureState "b3.dfy(113,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            assume true;
            assume j#0 <= k#0;
        ...
        // ----- assignment statement ----- b3.dfy(117,21)
        assume true;
        assert q#0 != null;
        assume true;
        qc0#0_0 := read($Heap, q#0, _module.Queue.contents);
        assume {:captureState "b3.dfy(117,33)"} true;
        // ----- call statement ----- b3.dfy(118,25)
        assume true;
        // TrCallStmt: Adding lhs Microsoft.Dafny.AutoGhostIdentifierExpr with type int
        // TrCallStmt: Before ProcessCallStmt
        assert q#0 != null;
        ...
        // TrCallStmt: After ProcessCallStmt
        x#0_0 := $rhs##0_0;
        assume {:captureState "b3.dfy(118,26)"} true;
        // ----- call statement ----- b3.dfy(119,16)
        // TrCallStmt: Before ProcessCallStmt
        assert q#0 != null;
        assume true;
        // ProcessCallStmt: CheckSubrange
        ...
        call Call$$_module.Queue.Enqueue(TInt, q#0, x##0_0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "b3.dfy(119,18)"} true;
        // ----- call statement ----- b3.dfy(120,20)
        // TrCallStmt: Before ProcessCallStmt
        assert q#0 != null;
        assert $IsAlloc(q#0, Tclass._module.Queue(TInt), old($Heap));
        assume true;
        ...
        call Call$$_module.Benchmark3.RotationLemma(TInt, this, O##0_0, j##0_0, A##0_0, C##0_0);
        // TrCallStmt: After ProcessCallStmt
        assume {:captureState "b3.dfy(120,56)"} true;
        // ----- assignment statement ----- b3.dfy(121,9)
        assume true;
        assume true;
        j#0 := j#0 + 1;
        assume {:captureState "b3.dfy(121,14)"} true;
        // ----- loop termination check ----- b3.dfy(113,5)
    ...
    C#0: Seq Box)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    assume {:captureState "b3.dfy(126,8): initial state"} true;
    ...
    assume {:captureState "b3.dfy(130,14): post-state"} true;
   ...
   returns ($_reverifyPost: bool)
{
  var $_Frame: <beta>[ref,Field beta]bool;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b3.dfy(131,2): initial state"} true;
    $_reverifyPost := false;
    // ----- calc statement ----- b3.dfy(132,5)
    // Assume Fuel Constant
    if (*)
    {
        // ----- assert wf[initial] ----- b3.dfy(132,5)
        assume true;
        assume false;
    }
    else if (*)
    {
        // ----- assume wf[lhs] ----- b3.dfy(132,5)
        assume true;
        // ----- Hint0 ----- b3.dfy(132,5)
        // ----- assert wf[rhs] ----- b3.dfy(132,5)
        assert {:subsumption 0} 0 <= j#0 && j#0 <= Seq#Length(O#0);
        assert {:subsumption 0} 0 <= j#0 && j#0 <= Seq#Length(O#0);
        assume true;
        // ----- assert line0 == line1 ----- b3.dfy(132,5)
    ...
    else if (*)
    {
        ...
        assert {:subsumption 0} 0 <= j#0 && j#0 <= Seq#Length(O#0);
        assume true;
        // ----- assert line1 == line2 ----- b3.dfy(132,5)
    ...
    else if (*)
    {
        ...
        assert {:subsumption 0} 0 <= j#0 && j#0 <= Seq#Length(O#0);
        assume true;
        // ----- assert line2 == line3 ----- b3.dfy(132,5)
    ...
    assume Seq#Equal(A#0,
      Seq#Append(Seq#Drop(Seq#Take(O#0, j#0 + 1), j#0),
        Seq#Append(Seq#Drop(O#0, j#0 + 1), Seq#Take(O#0, j#0))));
    // ----- calc statement ----- b3.dfy(138,5)
    // Assume Fuel Constant
    if (*)
    {
        // ----- assert wf[initial] ----- b3.dfy(138,5)
        assume true;
        assume false;
    }
    else if (*)
    {
        // ----- assume wf[lhs] ----- b3.dfy(138,5)
        assume true;
        // ----- Hint0 ----- b3.dfy(138,5)
        // ----- assert wf[rhs] ----- b3.dfy(138,5)
        assert {:subsumption 0} 0 <= LitInt(1) && LitInt(1) <= Seq#Length(A#0);
        assert {:subsumption 0} 0 <= LitInt(0) && LitInt(0) < Seq#Length(A#0);
        assume true;
        // ----- assert line0 == line1 ----- b3.dfy(138,5)
    ...
    else if (*)
    {
        ...
        assert {:subsumption 0} 0 <= j#0 && j#0 < Seq#Length(O#0);
        assume true;
        // ----- assert line1 == line2 ----- b3.dfy(138,5)
    ...
    else if (*)
    {
        ...
        assert {:subsumption 0} j#0 <= j#0 + 1 && j#0 + 1 <= Seq#Length(O#0);
        assume true;
        // ----- assert line2 == line3 ----- b3.dfy(138,5)
    ...
    else if (*)
    {
        ...
        assert {:subsumption 0} j#0 <= j#0 + 1 && j#0 + 1 <= Seq#Length(O#0);
        assume true;
        // ----- assert line3 == line4 ----- b3.dfy(138,5)
        assert {:subsumption 0} Seq#Equal(Seq#Append(Seq#Append(Seq#Drop(O#0, j#0 + 1), Seq#Take(O#0, j#0)),
            Seq#Drop(Seq#Take(O#0, j#0 + 1), j#0)),
    ...
    else if (*)
    {
        ...
        assert {:subsumption 0} 0 <= j#0 + 1 && j#0 + 1 <= Seq#Length(O#0);
        assume true;
        // ----- assert line4 == line5 ----- b3.dfy(138,5)
