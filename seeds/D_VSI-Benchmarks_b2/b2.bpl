...
// Command Line Options: /compile:0 /noVerify /print:b2.bpl b2.dfy
...
implementation CheckWellformed$$_module.Benchmark2.BinarySearch(this: ref, a#0: ref, key#0: int) returns (result#0: int)
{
  ...
  var i#2: int;
    ...
    assume {:captureState "b2.dfy(5,9): initial state"} true;
    assume a#0 != null;
    havoc i#0;
    havoc j#0;
    if (*)
    ...
    havoc result#0;
    assume {:captureState "b2.dfy(8,15): post-state"} true;
    if (LitInt(0 - 1) <= result#0)
    {
        assert a#0 != null;
    }

    assume LitInt(0 - 1) <= result#0 && result#0 < _System.array.Length(a#0);
    if (*)
    {
...
procedure Call$$_module.Benchmark2.BinarySearch(this: ref
  ...
  free ensures true;
  ensures LitInt(0 - 1) <= result#0;
  ensures result#0 < _System.array.Length(a#0);
  free ensures true;
  ensures LitInt(0) <= result#0
     ==> $Unbox(read($Heap, a#0, IndexField(result#0))): int == key#0;
  free ensures result#0 == LitInt(0 - 1)
     ==> (forall i#3: int :: { $Unbox(read($Heap, a#0, IndexField(i#3))): int } true);
  ensures result#0 == LitInt(0 - 1)
     ==> (forall i#3: int ::
      { $Unbox(read($Heap, a#0, IndexField(i#3))): int }
      true
         ==>
...
implementation Impl$$_module.Benchmark2.BinarySearch(this: ref, a#0: ref, key#0: int) returns (result#0: int, $_reverifyPost: bool)
{
  ...
  var midVal#0_0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b2.dfy(11,2): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- b2.dfy(12,13)
    assume true;
    assume true;
    low#0 := LitInt(0);
    assume {:captureState "b2.dfy(12,16)"} true;
    // ----- assignment statement ----- b2.dfy(13,14)
    assume true;
    assert a#0 != null;
    assume true;
    high#0 := _System.array.Length(a#0);
    assume {:captureState "b2.dfy(13,24)"} true;
    // ----- while statement ----- b2.dfy(15,5)
    ...
    while (true)
      ...
      free invariant $w$loop#0
         ==> (forall i#5: int :: { $Unbox(read($Heap, a#0, IndexField(i#5))): int } true);
      invariant $w$loop#0
         ==> (forall i#5: int ::
      ...
      free invariant $w$loop#0
         ==> (forall i#7: int :: { $Unbox(read($Heap, a#0, IndexField(i#7))): int } true);
      invariant $w$loop#0
         ==> (forall i#7: int ::
    ...
    {
        assume {:captureState "b2.dfy(15,4): after some loop iterations"} true;
        if (!$w$loop#0)
        {
            if (LitInt(0) <= low#0)
            {
            ...
            assume (forall i#5: int :: { $Unbox(read($Heap, a#0, IndexField(i#5))): int } true);
            ...
            // End Comprehension WF check
            assume (forall i#7: int :: { $Unbox(read($Heap, a#0, IndexField(i#7))): int } true);
        ...
        // ----- assignment statement ----- b2.dfy(20,15)
        assume true;
        assert LitInt(2) != 0;
        assume true;
        mid#0_0 := low#0 + (high#0 - low#0) div 2;
        assume {:captureState "b2.dfy(20,39)"} true;
        // ----- assignment statement ----- b2.dfy(21,18)
        assume true;
        assert a#0 != null;
        assert 0 <= mid#0_0 && mid#0_0 < _System.array.Length(a#0);
        assume true;
        midVal#0_0 := $Unbox(read($Heap, a#0, IndexField(mid#0_0))): int;
        assume {:captureState "b2.dfy(21,26)"} true;
        // ----- if statement ----- b2.dfy(23,7)
        assume true;
        if (midVal#0_0 < key#0)
        {
            // ----- assignment statement ----- b2.dfy(24,13)
            assume true;
            assume true;
            low#0 := mid#0_0 + 1;
            assume {:captureState "b2.dfy(24,22)"} true;
        }
        else
        {
            // ----- if statement ----- b2.dfy(25,14)
            assume true;
            if (key#0 < midVal#0_0)
            {
                // ----- assignment statement ----- b2.dfy(26,14)
                assume true;
                assume true;
                high#0 := mid#0_0;
                assume {:captureState "b2.dfy(26,19)"} true;
            }
            else
            {
                // ----- assignment statement ----- b2.dfy(28,16)
                assume true;
                assume true;
                result#0 := mid#0_0;
                assume {:captureState "b2.dfy(28,21)"} true;
                // ----- return statement ----- b2.dfy(29,9)
                return;
            }
        }

        // ----- loop termination check ----- b2.dfy(15,5)
    ...
    // ----- assignment statement ----- b2.dfy(32,12)
    assume true;
    assume true;
    result#0 := LitInt(0 - 1);
    assume {:captureState "b2.dfy(32,16)"} true;
}
...
implementation Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var key##6: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b2.dfy(36,14): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- b2.dfy(37,9)
    assume true;
    assert 0 <= LitInt(5);
    havoc $nw;
    assume $nw != null
    ...
    a#0 := $nw;
    assume {:captureState "b2.dfy(37,21)"} true;
    // ----- assignment statement ----- b2.dfy(38,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "b2.dfy(38,12)"} true;
    // ----- assignment statement ----- b2.dfy(39,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "b2.dfy(39,12)"} true;
    // ----- assignment statement ----- b2.dfy(40,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "b2.dfy(40,12)"} true;
    // ----- assignment statement ----- b2.dfy(41,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "b2.dfy(41,11)"} true;
    // ----- assignment statement ----- b2.dfy(42,8)
    assert a#0 != null;
    ...
    assume $IsGoodHeap($Heap);
    assume {:captureState "b2.dfy(42,12)"} true;
    // ----- call statement ----- b2.dfy(43,13)
    ...
    assume {:captureState "b2.dfy(43,18)"} true;
    // ----- call statement ----- b2.dfy(44,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##1 := a#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b2.dfy(44,19)"} true;
    // ----- call statement ----- b2.dfy(45,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##2 := a#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b2.dfy(45,19)"} true;
    // ----- call statement ----- b2.dfy(46,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##3 := a#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b2.dfy(46,18)"} true;
    // ----- call statement ----- b2.dfy(47,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##4 := a#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b2.dfy(47,19)"} true;
    // ----- call statement ----- b2.dfy(48,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##5 := a#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b2.dfy(48,19)"} true;
    // ----- call statement ----- b2.dfy(49,13)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    a##6 := a#0;
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b2.dfy(49,19)"} true;
}
...
implementation CheckWellformed$$_module.__default.TestSearch(a#0: ref, key#0: int)
{
  ...
  var j#0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b2.dfy(52,7): initial state"} true;
    assume a#0 != null;
    havoc i#0;
    havoc j#0;
    if (*)
...
implementation Impl$$_module.__default.TestSearch(a#0: ref, key#0: int) returns ($_reverifyPost: bool)
{
  ...
  var key##0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b2.dfy(55,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- b2.dfy(56,9)
    assume true;
    havoc $nw;
    assume $nw != null
       &&
      !read($Heap, $nw, alloc)
       && dtype($nw) == Tclass._module.Benchmark2();
    $Heap := update($Heap, $nw, alloc, true);
    assume $IsGoodHeap($Heap);
    assume $IsHeapAnchor($Heap);
    b#0 := $nw;
    assume {:captureState "b2.dfy(56,25)"} true;
    // ----- call statement ----- b2.dfy(57,26)
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    r#0 := $rhs##0;
    assume {:captureState "b2.dfy(57,33)"} true;
    // ----- print statement ----- b2.dfy(58,3)
    assume true;
    assume true;
    assume true;
    assume true;
