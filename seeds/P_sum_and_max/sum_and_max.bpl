// Automatically generated (12/12/2017 1:54:57.855 PM)
...
const unique SUM_AND_MAX: Type;

axiom ((SUM_AND_MAX) <: (ANY));

axiom ((forall t: Type :: { (SUM_AND_MAX) <: (t) } ((SUM_AND_MAX) <: (t)) <==> (((t) == (SUM_AND_MAX)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, SUM_AND_MAX)) == (-1));

axiom ((FieldId(closed, SUM_AND_MAX)) == (-2));

axiom ((FieldId(owner, SUM_AND_MAX)) == (-3));

axiom ((FieldId(owns, SUM_AND_MAX)) == (-4));

axiom ((FieldId(observers, SUM_AND_MAX)) == (-5));

axiom ((FieldId(subjects, SUM_AND_MAX)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, SUM_AND_MAX) } (IsModelField($f, SUM_AND_MAX)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } SUM_AND_MAX.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, SUM_AND_MAX)) ==> ((user_inv(heap, current)) <==> (SUM_AND_MAX.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, SUM_AND_MAX)) ==> ((user_inv(heap, current)) ==> (SUM_AND_MAX.user_inv(heap, current)))));

procedure SUM_AND_MAX.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, SUM_AND_MAX);



implementation SUM_AND_MAX.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.SUM_AND_MAX.default_create(Current: ref);
  free requires attached_exact(Heap, Current, SUM_AND_MAX); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.SUM_AND_MAX.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.SUM_AND_MAX.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.SUM_AND_MAX.default_create"} true;
  if (*) {
...
procedure SUM_AND_MAX.sum_and_max(Current: ref, a: ref) returns (Result: ref where detachable(Heap, Result, TUPLE^INTEGER_32#INTEGER_32^));
  free requires attached_exact(Heap, Current, SUM_AND_MAX); // info:type property for argument Current
  free requires detachable_exact(Heap, a, SIMPLE_ARRAY^INTEGER_32^); // info:type property for argument a
  modifies Heap;
  requires (a) != (Void); // type:pre tag:a_not_void line:14
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:15 cid:190 rid:3249
  requires (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1))); // type:check tag:function_precondition line:15 cid:125 rid:3286
  requires (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1)) >= (0))); // type:pre tag:natural_numbers line:15
  ensures (Result) != (Void); // type:attached tag:sum_in_range line:39
  ensures (a) != (Void); // type:attached tag:sum_in_range line:39
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:39 cid:190 rid:3249
  ensures (Heap[Result, TUPLE^INTEGER_32#INTEGER_32^.field_1]) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) * (Heap[Result, TUPLE^INTEGER_32#INTEGER_32^.field_2])); // type:post tag:sum_in_range line:39
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUM_AND_MAX.sum_and_max(Heap, Current, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX.sum_and_max(old(Heap), Current, a));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.SUM_AND_MAX.sum_and_max.1(heap: HeapType, current: ref, a: ref) returns (ref) {
  a
}

implementation SUM_AND_MAX.sum_and_max(Current: ref, a: ref) returns (Result: ref)
{
  var PreLoopHeap_5: HeapType;
  var variant_6: int;
  var temp_7: int;
  var temp_8: int;
  var temp_9: int;
  ...
  entry:
  assume {:captureState "SUM_AND_MAX.sum_and_max"} true;
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:23
  // i := 1
  local1 := 1;
  PreLoopHeap_5 := Heap;
  goto loop_head_2;
  loop_head_2:
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:25
  ...
  assert ((1) <= (local1)) && ((local1) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))); // type:loop_inv tag:i_in_range line:25
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:26
  // sum_and_max_not_negative: sum >= 0 and max >= 0
  assert ((local2) >= (0)) && ((local3) >= (0)); // type:loop_inv tag:sum_and_max_not_negative line:26
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:27
  // partial_sum_and_max: sum <= (i-1) * max
  assert (local2) <= (((local1) - (1)) * (local3)); // type:loop_inv tag:partial_sum_and_max line:27
  assume HeapSucc(PreLoopHeap_5, Heap);
  assume same_outside(old(Heap), Heap, modify.SUM_AND_MAX.sum_and_max(old(Heap), Current, a));
  assume global(Heap);
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:-1
  ...
  goto loop_body_3, loop_end_4;
  loop_body_3:
  assume !((local1) > (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)));
  variant_6 := (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1);
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:31
  // if a[i] > max then
  assert {:subsumption 0} (a) != (Void); // type:attached line:31
  call temp_7 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:31 cid:190 rid:3250
  if ((temp_7) > (local3)) {
    // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:32
    // max := a[i]
    assert {:subsumption 0} (a) != (Void); // type:attached line:32
    call temp_8 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:32 cid:190 rid:3250
    local3 := temp_8;
  }
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:34
  // sum := sum + a[i]
  assert {:subsumption 0} (a) != (Void); // type:attached line:34
  call temp_9 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:34 cid:190 rid:3250
  local2 := (local2) + (temp_9);
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:35
  // i := i + 1
  local1 := (local1) + (1);
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:31
  // if a[i] > max then
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) <= (variant_6)) && ((variant_6) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)))) || ((0) <= (variant_6)); // type:termination tag:bounded line:31 varid:1
  assert {:subsumption 0} (((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)) <= (variant_6)) && (!((variant_6) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) - (local1)))); // type:termination tag:variant_decreases line:31
  goto loop_head_2;
  loop_end_4:
  assume (local1) > (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a));
  // /home/caf/temp/comcom/repo-sum_and_max/sum_and_max.e:37
  // Result := [sum, max]
  call temp_10 := allocate(TUPLE^INTEGER_32#INTEGER_32^); // line:-1
  call create.TUPLE^INTEGER_32#INTEGER_32^.make(temp_10, local2, local3);
  Result := temp_10;
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, SUM_AND_MAX)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, SUM_AND_MAX)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, SUM_AND_MAX)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.SUM_AND_MAX.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, SUM_AND_MAX)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.SUM_AND_MAX.in_observers(heap, current, v, o)))));

function modify.SUM_AND_MAX.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.SUM_AND_MAX.default_create(heap, current)[$o, $f] } (modify.SUM_AND_MAX.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.SUM_AND_MAX.sum_and_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.SUM_AND_MAX.sum_and_max(heap, current, a)[$o, $f] } (modify.SUM_AND_MAX.sum_and_max(heap, current, a)[$o, $f]) <==> (false)))));
...
procedure SUM_AND_MAX.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SUM_AND_MAX); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUM_AND_MAX.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUM_AND_MAX.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SUM_AND_MAX.in_observers(Heap, Current, new_observers, o), readable);



function fun.SUM_AND_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.SUM_AND_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUM_AND_MAX.in_observers(heap, current, new_observers, o) } { trigger.fun.SUM_AND_MAX.in_observers(heap, current, new_observers, o) } (pre.fun.SUM_AND_MAX.in_observers(heap, current, new_observers, o)) ==> ((fun.SUM_AND_MAX.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUM_AND_MAX.in_observers(heap, current, new_observers, o) } (fun.SUM_AND_MAX.in_observers(heap, current, new_observers, o)) == (fun0.SUM_AND_MAX.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.SUM_AND_MAX.in_observers(h, current, new_observers, o), fun0.SUM_AND_MAX.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.SUM_AND_MAX.in_observers(h, current, new_observers, o)) && (pre.fun.SUM_AND_MAX.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.SUM_AND_MAX.in_observers(h, current, new_observers, o)))) ==> ((fun0.SUM_AND_MAX.in_observers(h, current, new_observers, o)) == (fun0.SUM_AND_MAX.in_observers(h', current, new_observers, o)))));
...
function modify.SUM_AND_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { modify.SUM_AND_MAX.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SUM_AND_MAX.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SUM_AND_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { read.fun.SUM_AND_MAX.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SUM_AND_MAX.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SUM_AND_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.SUM_AND_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T21> $o: ref, $f: Field T21 :: { modify.TUPLE^INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.TUPLE^INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T22> $o: ref, $f: Field T22 :: { read.fun.TUPLE^INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.TUPLE^INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
