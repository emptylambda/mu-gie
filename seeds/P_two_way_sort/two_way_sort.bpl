// Automatically generated (12/12/2017 1:54:50.404 PM)
...
const unique TWO_WAY_SORT: Type;

axiom ((TWO_WAY_SORT) <: (ANY));

axiom ((forall t: Type :: { (TWO_WAY_SORT) <: (t) } ((TWO_WAY_SORT) <: (t)) <==> (((t) == (TWO_WAY_SORT)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, TWO_WAY_SORT)) == (-1));

axiom ((FieldId(closed, TWO_WAY_SORT)) == (-2));

axiom ((FieldId(owner, TWO_WAY_SORT)) == (-3));

axiom ((FieldId(owns, TWO_WAY_SORT)) == (-4));

axiom ((FieldId(observers, TWO_WAY_SORT)) == (-5));

axiom ((FieldId(subjects, TWO_WAY_SORT)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, TWO_WAY_SORT) } (IsModelField($f, TWO_WAY_SORT)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } TWO_WAY_SORT.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, TWO_WAY_SORT)) ==> ((user_inv(heap, current)) <==> (TWO_WAY_SORT.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, TWO_WAY_SORT)) ==> ((user_inv(heap, current)) ==> (TWO_WAY_SORT.user_inv(heap, current)))));

procedure TWO_WAY_SORT.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, TWO_WAY_SORT);



implementation TWO_WAY_SORT.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.TWO_WAY_SORT.default_create(Current: ref);
  free requires attached_exact(Heap, Current, TWO_WAY_SORT); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.TWO_WAY_SORT.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.TWO_WAY_SORT.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.TWO_WAY_SORT.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.TWO_WAY_SORT.default_create"} true;
  if (*) {
...
procedure TWO_WAY_SORT.two_way_sort(Current: ref, a: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, TWO_WAY_SORT); // info:type property for argument Current
  free requires detachable_exact(Heap, a, SIMPLE_ARRAY^BOOLEAN^); // info:type property for argument a
  modifies Heap;
  requires (a) != (Void); // type:attached line:15
  requires pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a); // type:check tag:function_precondition line:15 cid:190 rid:3249
  requires (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a)) >= (0); // type:pre line:15
  ensures (a) != (Void); // type:attached tag:false_first line:49
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (Result))) ==> (pre.fun.MML_SEQUENCE^BOOLEAN^.item(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i_1))); // type:check tag:function_precondition line:49 cid:125 rid:3286
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (Result))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i_1)) == (false))); // type:post tag:false_first line:49
  ensures pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a); // type:check tag:function_precondition line:50 cid:190 rid:3249
  ensures (forall i_2: int :: ((((Result) + (1)) <= (i_2)) && ((i_2) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^BOOLEAN^.item(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i_2))); // type:check tag:function_precondition line:50 cid:125 rid:3286
  ensures (forall i_2: int :: ((((Result) + (1)) <= (i_2)) && ((i_2) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i_2)) == (true))); // type:post tag:true_last line:50
  ensures Bag#Equal(Seq#ToBag(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence]), Seq#ToBag(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence])); // type:post tag:is_permutation line:51
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.TWO_WAY_SORT.two_way_sort(Heap, Current, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.TWO_WAY_SORT.two_way_sort(old(Heap), Current, a));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.TWO_WAY_SORT.two_way_sort.1(heap: HeapType, current: ref, a: ref) returns (ref) {
  a
}

implementation TWO_WAY_SORT.two_way_sort(Current: ref, a: ref) returns (Result: int)
{
  ...
  var local3: Seq bool where true;
  ...
  entry:
  assume {:captureState "TWO_WAY_SORT.two_way_sort"} true;
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:23
  // i := 0
  local1 := 0;
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:24
  // j := a.count
  assert {:subsumption 0} (a) != (Void); // type:attached line:24
  assert pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a); // type:check tag:function_precondition line:24 cid:190 rid:3249
  local2 := fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a);
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:25
  // old_sequence := a.sequence
  assert {:subsumption 0} (a) != (Void); // type:attached line:25
  local3 := Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence];
  PreLoopHeap_6 := Heap;
  goto loop_head_3;
  loop_head_3:
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:27
  ...
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:28
  // i_and_j_bounds: i >= 0 and i <= j and j <= a.count
  assert {:subsumption 0} (a) != (Void); // type:attached line:28
  assert pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a); // type:check tag:function_precondition line:28 cid:190 rid:3249
  assert ((local1) >= (0)) && ((local1) <= (local2)) && ((local2) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a))); // type:loop_inv tag:i_and_j_bounds line:28
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:29
  // false_up_to_i: across 1 |..| i as ai all a.sequence[ai.item] = False end
  assert {:subsumption 0} (a) != (Void); // type:attached line:29
  assert (forall i_7: int :: (((1) <= (i_7)) && ((i_7) <= (local1))) ==> (pre.fun.MML_SEQUENCE^BOOLEAN^.item(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i_7))); // type:check tag:function_precondition line:29 cid:125 rid:3286
  assert (forall i_7: int :: (((1) <= (i_7)) && ((i_7) <= (local1))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i_7)) == (false))); // type:loop_inv tag:false_up_to_i line:29
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:30
  // true_from_j: across (j+1) |..| a.count as ai all a.sequence[ai.item] = True end
  assert {:subsumption 0} (a) != (Void); // type:attached line:30
  assert pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a); // type:check tag:function_precondition line:30 cid:190 rid:3249
  assert {:subsumption 0} (a) != (Void); // type:attached line:30
  assert (forall i_8: int :: ((((local2) + (1)) <= (i_8)) && ((i_8) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^BOOLEAN^.item(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i_8))); // type:check tag:function_precondition line:30 cid:125 rid:3286
  assert (forall i_8: int :: ((((local2) + (1)) <= (i_8)) && ((i_8) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i_8)) == (true))); // type:loop_inv tag:true_from_j line:30
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:31
  // is_permutation: a.sequence.to_bag ~ old_sequence.to_bag
  assert {:subsumption 0} (a) != (Void); // type:attached line:31
  assert Bag#Equal(Seq#ToBag(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence]), Seq#ToBag(local3)); // type:loop_inv tag:is_permutation line:31
  assume HeapSucc(PreLoopHeap_6, Heap);
  assume same_outside(old(Heap), Heap, modify.TWO_WAY_SORT.two_way_sort(old(Heap), Current, a));
  assume global(Heap);
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:-1
  goto loop_body_4, loop_end_5;
  loop_body_4:
  assume !((local1) == (local2));
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:45
  // j - i
  variant_9 := (local2) - (local1);
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:35
  // if a[i+1] = False then
  assert {:subsumption 0} (a) != (Void); // type:attached line:35
  call temp_10 := SIMPLE_ARRAY^BOOLEAN^.item(a, (local1) + (1)); // line:35 cid:190 rid:3250
  if ((temp_10) == (false)) {
    // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:36
    // i := i + 1
    local1 := (local1) + (1);
  } else {
    // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:37
    // elseif a[j] = True then
    assert {:subsumption 0} (a) != (Void); // type:attached line:37
    call temp_11 := SIMPLE_ARRAY^BOOLEAN^.item(a, local2); // line:37 cid:190 rid:3250
    if ((temp_11) == (true)) {
      // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:38
      // j := j - 1
      local2 := (local2) - (1);
    } else {
      // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:40
      // i := i + 1
      local1 := (local1) + (1);
      // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:41
      // swap (a, i, j)
      call TWO_WAY_SORT.swap(Current, a, local1, local2); // line:41 cid:404 rid:5402
      // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:42
      // j := j - 1
      local2 := (local2) - (1);
    }
  }
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:45
  // j - i
  assert {:subsumption 0} ((((local2) - (local1)) <= (variant_9)) && ((variant_9) <= ((local2) - (local1)))) || ((0) <= (variant_9)); // type:termination tag:bounded line:45 varid:1
  assert {:subsumption 0} (((local2) - (local1)) <= (variant_9)) && (!((variant_9) <= ((local2) - (local1)))); // type:termination tag:variant_decreases line:45
  goto loop_head_3;
  loop_end_5:
  assume (local1) == (local2);
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:47
  // Result := i
  Result := local1;
}

procedure TWO_WAY_SORT.swap(Current: ref, a: ref, i: int, j: int);
  free requires attached_exact(Heap, Current, TWO_WAY_SORT); // info:type property for argument Current
  free requires detachable_exact(Heap, a, SIMPLE_ARRAY^BOOLEAN^); // info:type property for argument a
  ...
  modifies Heap;
  requires (a) != (Void); // type:attached tag:i_in_range line:59
  requires pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a); // type:check tag:function_precondition line:59 cid:190 rid:3249
  requires ((1) <= (i)) && ((i) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a))); // type:pre tag:i_in_range line:59
  requires ((1) <= (j)) && ((j) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, a))); // type:pre tag:j_in_range line:60
  ensures (a) != (Void); // type:attached tag:swapped line:70
  ensures pre.fun.MML_SEQUENCE^BOOLEAN^.item(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], j); // type:check tag:function_precondition line:70 cid:125 rid:3286
  ensures pre.fun.MML_SEQUENCE^BOOLEAN^.replaced_at(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i, Seq#Item(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], j)); // type:check tag:function_precondition line:70 cid:125 rid:3308
  ensures pre.fun.MML_SEQUENCE^BOOLEAN^.item(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i); // type:check tag:function_precondition line:70 cid:125 rid:3286
  ensures pre.fun.MML_SEQUENCE^BOOLEAN^.replaced_at(Seq#Update(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i, Seq#Item(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], j)), j, Seq#Item(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i)); // type:check tag:function_precondition line:70 cid:125 rid:3308
  ensures Seq#Equal(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence], Seq#Update(Seq#Update(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i, Seq#Item(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], j)), j, Seq#Item(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence], i))); // type:post tag:swapped line:70
  ensures Bag#Equal(Seq#ToBag(Heap[a, SIMPLE_ARRAY^BOOLEAN^.sequence]), Seq#ToBag(old(Heap)[a, SIMPLE_ARRAY^BOOLEAN^.sequence])); // type:post tag:is_permutation line:71
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.TWO_WAY_SORT.swap(Heap, Current, a, i, j), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.TWO_WAY_SORT.swap(old(Heap), Current, a, i, j));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
  requires is_wrapped(Heap, a); // type:pre tag:arg_a_is_wrapped default:contracts
...
function { :inline } variant.TWO_WAY_SORT.swap.1(heap: HeapType, current: ref, a: ref, i: int, j: int) returns (ref) {
  a
}

function { :inline } variant.TWO_WAY_SORT.swap.2(heap: HeapType, current: ref, a: ref, i: int, j: int) returns (int) {
  i
}

function { :inline } variant.TWO_WAY_SORT.swap.3(heap: HeapType, current: ref, a: ref, i: int, j: int) returns (int) {
  j
}

implementation TWO_WAY_SORT.swap(Current: ref, a: ref, i: int, j: int)
{
  var temp_12: bool;
  var temp_13: bool;
  ...
  entry:
  assume {:captureState "TWO_WAY_SORT.swap"} true;
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:66
  // t := a[i]
  assert {:subsumption 0} (a) != (Void); // type:attached line:66
  call temp_12 := SIMPLE_ARRAY^BOOLEAN^.item(a, i); // line:66 cid:190 rid:3250
  local1 := temp_12;
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:67
  // a[i] := a[j]
  assert {:subsumption 0} (a) != (Void); // type:attached line:67
  assert {:subsumption 0} (a) != (Void); // type:attached line:67
  call temp_13 := SIMPLE_ARRAY^BOOLEAN^.item(a, j); // line:67 cid:190 rid:3250
  call SIMPLE_ARRAY^BOOLEAN^.put(a, temp_13, i); // line:67 cid:190 rid:3254
  // /home/caf/temp/comcom/repo-two_way_sort/two_way_sort.e:68
  // a[j] := t
  assert {:subsumption 0} (a) != (Void); // type:attached line:68
  call SIMPLE_ARRAY^BOOLEAN^.put(a, local1, j); // line:68 cid:190 rid:3254
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, TWO_WAY_SORT)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, TWO_WAY_SORT)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, TWO_WAY_SORT)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.TWO_WAY_SORT.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, TWO_WAY_SORT)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.TWO_WAY_SORT.in_observers(heap, current, v, o)))));

function modify.TWO_WAY_SORT.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.TWO_WAY_SORT.default_create(heap, current)[$o, $f] } (modify.TWO_WAY_SORT.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));

const unique SIMPLE_ARRAY^BOOLEAN^: Type;

axiom (is_frozen(SIMPLE_ARRAY^BOOLEAN^));

axiom ((SIMPLE_ARRAY^BOOLEAN^) <: (ITERABLE^BOOLEAN^));

axiom ((forall t: Type :: { (SIMPLE_ARRAY^BOOLEAN^) <: (t) } ((SIMPLE_ARRAY^BOOLEAN^) <: (t)) <==> (((t) == (SIMPLE_ARRAY^BOOLEAN^)) || ((ITERABLE^BOOLEAN^) <: (t)))));

axiom ((FieldId(allocated, SIMPLE_ARRAY^BOOLEAN^)) == (-1));

axiom ((FieldId(closed, SIMPLE_ARRAY^BOOLEAN^)) == (-2));

axiom ((FieldId(owner, SIMPLE_ARRAY^BOOLEAN^)) == (-3));

axiom ((FieldId(owns, SIMPLE_ARRAY^BOOLEAN^)) == (-4));

axiom ((FieldId(observers, SIMPLE_ARRAY^BOOLEAN^)) == (-5));

axiom ((FieldId(subjects, SIMPLE_ARRAY^BOOLEAN^)) == (-6));

axiom ((forall <T6> $f: Field T6 :: { IsModelField($f, SIMPLE_ARRAY^BOOLEAN^) } (IsModelField($f, SIMPLE_ARRAY^BOOLEAN^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } SIMPLE_ARRAY^BOOLEAN^.user_inv(heap: HeapType, current: ref) returns (bool) {
  ((fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)) >= (0)) && ((fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)) == (Seq#Length(heap[current, SIMPLE_ARRAY^BOOLEAN^.sequence]))) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, SIMPLE_ARRAY^BOOLEAN^)) ==> ((user_inv(heap, current)) <==> (SIMPLE_ARRAY^BOOLEAN^.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, SIMPLE_ARRAY^BOOLEAN^)) ==> ((user_inv(heap, current)) ==> (SIMPLE_ARRAY^BOOLEAN^.user_inv(heap, current)))));

procedure SIMPLE_ARRAY^BOOLEAN^.count(Current: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, SIMPLE_ARRAY^BOOLEAN^); // info:type property for argument Current
  modifies Heap;
  ensures (Result) == (Seq#Length(Heap[Current, SIMPLE_ARRAY^BOOLEAN^.sequence])); // type:post tag:definition line:77
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_ARRAY^BOOLEAN^.count(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_ARRAY^BOOLEAN^.count(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, Current), readable);



function fun.SIMPLE_ARRAY^BOOLEAN^.count(heap: HeapType, current: ref) returns (int);

function fun0.SIMPLE_ARRAY^BOOLEAN^.count(heap: HeapType, current: ref) returns (int);

axiom ((forall heap: HeapType, current: ref :: { fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current) } (pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)) ==> (((fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)) == (Seq#Length(heap[current, SIMPLE_ARRAY^BOOLEAN^.sequence]))) && (is_integer_32(fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current))))));

axiom ((forall heap: HeapType, current: ref :: { fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current) } { trigger.fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current) } (pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)) ==> ((fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)) == (Seq#Length(heap[current, SIMPLE_ARRAY^BOOLEAN^.sequence])))));

axiom ((forall heap: HeapType, current: ref :: { fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current) } (fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)) == (fun0.SIMPLE_ARRAY^BOOLEAN^.count(heap, current))));

axiom ((forall h: HeapType, h': HeapType, current: ref :: { HeapSucc(h, h'), fun0.SIMPLE_ARRAY^BOOLEAN^.count(h, current), fun0.SIMPLE_ARRAY^BOOLEAN^.count(h', current) } ((HeapSucc(h, h')) && (pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(h, current)) && (pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(h', current)) && (same_inside(h, h', read.fun.SIMPLE_ARRAY^BOOLEAN^.count(h, current)))) ==> ((fun0.SIMPLE_ARRAY^BOOLEAN^.count(h, current)) == (fun0.SIMPLE_ARRAY^BOOLEAN^.count(h', current)))));

const SIMPLE_ARRAY^BOOLEAN^.sequence: Field (Seq bool);

axiom ((FieldId(SIMPLE_ARRAY^BOOLEAN^.sequence, SIMPLE_ARRAY^BOOLEAN^)) == (84));

axiom ((forall heap: HeapType, current: ref, v: Seq bool, o: ref :: { guard(heap, current, SIMPLE_ARRAY^BOOLEAN^.sequence, v, o) } (attached_exact(heap, current, SIMPLE_ARRAY^BOOLEAN^)) ==> ((guard(heap, current, SIMPLE_ARRAY^BOOLEAN^.sequence, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, SIMPLE_ARRAY^BOOLEAN^.sequence := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: Seq bool, o: ref :: { guard(heap, current, SIMPLE_ARRAY^BOOLEAN^.sequence, v, o) } (attached(heap, current, SIMPLE_ARRAY^BOOLEAN^)) ==> ((guard(heap, current, SIMPLE_ARRAY^BOOLEAN^.sequence, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, SIMPLE_ARRAY^BOOLEAN^.sequence := v], o))))));

function modify.TWO_WAY_SORT.two_way_sort(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.TWO_WAY_SORT.two_way_sort(heap, current, a)[$o, $f] } (modify.TWO_WAY_SORT.two_way_sort(heap, current, a)[$o, $f]) <==> (($o) == (a))))));

procedure SIMPLE_ARRAY^BOOLEAN^.item(Current: ref, i: int) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SIMPLE_ARRAY^BOOLEAN^); // info:type property for argument Current
  free requires is_integer_32(i); // info:type property for argument i
  modifies Heap;
  requires pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, Current); // type:check tag:function_precondition line:83 cid:190 rid:3249
  requires ((1) <= (i)) && ((i) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, Current))); // type:pre tag:in_bounds line:83
  requires pre.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(Heap, Current, i); // type:check tag:function_precondition line:84 cid:190 rid:3253
  requires fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(Heap, Current, i); // type:pre tag:valid_index line:84
  ensures pre.fun.MML_SEQUENCE^BOOLEAN^.item(Heap[Current, SIMPLE_ARRAY^BOOLEAN^.sequence], i); // type:check tag:function_precondition line:89 cid:125 rid:3286
  ensures (Result) == (Seq#Item(Heap[Current, SIMPLE_ARRAY^BOOLEAN^.sequence], i)); // type:post tag:definition line:89
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_ARRAY^BOOLEAN^.item(Heap, Current, i), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_ARRAY^BOOLEAN^.item(old(Heap), Current, i));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SIMPLE_ARRAY^BOOLEAN^.item(Heap, Current, i), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.SIMPLE_ARRAY^BOOLEAN^.item(old(Heap), Current, i));



function fun.SIMPLE_ARRAY^BOOLEAN^.item(heap: HeapType, current: ref, i: int) returns (bool);

axiom ((forall heap: HeapType, current: ref, i: int :: { fun.SIMPLE_ARRAY^BOOLEAN^.item(heap, current, i) } (pre.fun.SIMPLE_ARRAY^BOOLEAN^.item(heap, current, i)) ==> ((fun.SIMPLE_ARRAY^BOOLEAN^.item(heap, current, i)) == (Seq#Item(heap[current, SIMPLE_ARRAY^BOOLEAN^.sequence], i)))));

axiom ((forall h: HeapType, h': HeapType, current: ref, i: int :: { HeapSucc(h, h'), fun.SIMPLE_ARRAY^BOOLEAN^.item(h, current, i), fun.SIMPLE_ARRAY^BOOLEAN^.item(h', current, i) } ((HeapSucc(h, h')) && (pre.fun.SIMPLE_ARRAY^BOOLEAN^.item(h, current, i)) && (pre.fun.SIMPLE_ARRAY^BOOLEAN^.item(h', current, i)) && (same_inside(h, h', read.fun.SIMPLE_ARRAY^BOOLEAN^.item(h, current, i)))) ==> ((fun.SIMPLE_ARRAY^BOOLEAN^.item(h, current, i)) == (fun.SIMPLE_ARRAY^BOOLEAN^.item(h', current, i)))));

function modify.TWO_WAY_SORT.swap(heap: HeapType, current: ref, a: ref, i: int, j: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, i: int, j: int :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.TWO_WAY_SORT.swap(heap, current, a, i, j)[$o, $f] } (modify.TWO_WAY_SORT.swap(heap, current, a, i, j)[$o, $f]) <==> (($o) == (a))))));

procedure SIMPLE_ARRAY^BOOLEAN^.put(Current: ref, v: bool, i: int);
  free requires attached_exact(Heap, Current, SIMPLE_ARRAY^BOOLEAN^); // info:type property for argument Current
  free requires true; // info:type property for argument v
  free requires is_integer_32(i); // info:type property for argument i
  modifies Heap;
  requires pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, Current); // type:check tag:function_precondition line:141 cid:190 rid:3249
  requires ((1) <= (i)) && ((i) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, Current))); // type:pre tag:in_bounds line:141
  requires pre.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(Heap, Current, i); // type:check tag:function_precondition line:142 cid:190 rid:3253
  requires fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(Heap, Current, i); // type:pre tag:valid_index line:142
  ensures pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, Current); // type:check tag:function_precondition line:148 cid:190 rid:3249
  ensures pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(old(Heap), Current); // type:check tag:function_precondition line:148 cid:190 rid:3249
  ensures (fun.SIMPLE_ARRAY^BOOLEAN^.count(Heap, Current)) == (fun.SIMPLE_ARRAY^BOOLEAN^.count(old(Heap), Current)); // type:post tag:same_count line:148
  ensures pre.fun.MML_SEQUENCE^BOOLEAN^.replaced_at(old(Heap)[Current, SIMPLE_ARRAY^BOOLEAN^.sequence], i, v); // type:check tag:function_precondition line:149 cid:125 rid:3308
  ensures Seq#Equal(Heap[Current, SIMPLE_ARRAY^BOOLEAN^.sequence], Seq#Update(old(Heap)[Current, SIMPLE_ARRAY^BOOLEAN^.sequence], i, v)); // type:post tag:sequence_effect line:149
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_ARRAY^BOOLEAN^.put(Heap, Current, v, i), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_ARRAY^BOOLEAN^.put(old(Heap), Current, v, i));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
procedure TWO_WAY_SORT.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, TWO_WAY_SORT); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.TWO_WAY_SORT.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.TWO_WAY_SORT.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.TWO_WAY_SORT.in_observers(Heap, Current, new_observers, o), readable);



function fun.TWO_WAY_SORT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.TWO_WAY_SORT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.TWO_WAY_SORT.in_observers(heap, current, new_observers, o) } { trigger.fun.TWO_WAY_SORT.in_observers(heap, current, new_observers, o) } (pre.fun.TWO_WAY_SORT.in_observers(heap, current, new_observers, o)) ==> ((fun.TWO_WAY_SORT.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.TWO_WAY_SORT.in_observers(heap, current, new_observers, o) } (fun.TWO_WAY_SORT.in_observers(heap, current, new_observers, o)) == (fun0.TWO_WAY_SORT.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.TWO_WAY_SORT.in_observers(h, current, new_observers, o), fun0.TWO_WAY_SORT.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.TWO_WAY_SORT.in_observers(h, current, new_observers, o)) && (pre.fun.TWO_WAY_SORT.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.TWO_WAY_SORT.in_observers(h, current, new_observers, o)))) ==> ((fun0.TWO_WAY_SORT.in_observers(h, current, new_observers, o)) == (fun0.TWO_WAY_SORT.in_observers(h', current, new_observers, o)))));

const unique ITERABLE^BOOLEAN^: Type;

axiom ((ITERABLE^BOOLEAN^) <: (ANY));

axiom ((forall t: Type :: { (ITERABLE^BOOLEAN^) <: (t) } ((ITERABLE^BOOLEAN^) <: (t)) <==> (((t) == (ITERABLE^BOOLEAN^)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, ITERABLE^BOOLEAN^)) == (-1));

axiom ((FieldId(closed, ITERABLE^BOOLEAN^)) == (-2));

axiom ((FieldId(owner, ITERABLE^BOOLEAN^)) == (-3));

axiom ((FieldId(owns, ITERABLE^BOOLEAN^)) == (-4));

axiom ((FieldId(observers, ITERABLE^BOOLEAN^)) == (-5));

axiom ((FieldId(subjects, ITERABLE^BOOLEAN^)) == (-6));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, SIMPLE_ARRAY^BOOLEAN^)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, SIMPLE_ARRAY^BOOLEAN^)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, SIMPLE_ARRAY^BOOLEAN^)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, SIMPLE_ARRAY^BOOLEAN^)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, v, o)))));

function modify.SIMPLE_ARRAY^BOOLEAN^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { modify.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)[$o, $f] } (modify.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^BOOLEAN^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { read.fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)[$o, $f] } (read.fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SIMPLE_ARRAY^BOOLEAN^.count(heap: HeapType, current: ref) returns (bool) {
  true
}

function trigger.fun.SIMPLE_ARRAY^BOOLEAN^.count(heap: HeapType, current: ref) returns (bool);

function pre.fun.MML_SEQUENCE^BOOLEAN^.item(current: Seq bool, i: int) returns (bool) {
  ((1) <= (i)) && ((i) <= (Seq#Length(current)))
}

function trigger.fun.MML_SEQUENCE^BOOLEAN^.item(current: Seq bool, i: int) returns (bool);

procedure SIMPLE_ARRAY^BOOLEAN^.valid_index(Current: ref, i: int) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SIMPLE_ARRAY^BOOLEAN^); // info:type property for argument Current
  free requires is_integer_32(i); // info:type property for argument i
  modifies Heap;
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_ARRAY^BOOLEAN^.valid_index(Heap, Current, i), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_ARRAY^BOOLEAN^.valid_index(old(Heap), Current, i));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(Heap, Current, i), readable);



function fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap: HeapType, current: ref, i: int) returns (bool);

function fun0.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap: HeapType, current: ref, i: int) returns (bool);

axiom ((forall heap: HeapType, current: ref, i: int :: { fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i) } { trigger.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i) } (pre.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i)) ==> ((fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i)) == (((1) <= (i)) && ((i) <= (Seq#Length(heap[current, SIMPLE_ARRAY^BOOLEAN^.sequence])))))));

axiom ((forall heap: HeapType, current: ref, i: int :: { fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i) } (fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i)) == (fun0.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i))));

axiom ((forall h: HeapType, h': HeapType, current: ref, i: int :: { HeapSucc(h, h'), fun0.SIMPLE_ARRAY^BOOLEAN^.valid_index(h, current, i), fun0.SIMPLE_ARRAY^BOOLEAN^.valid_index(h', current, i) } ((HeapSucc(h, h')) && (pre.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(h, current, i)) && (pre.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(h', current, i)) && (same_inside(h, h', read.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(h, current, i)))) ==> ((fun0.SIMPLE_ARRAY^BOOLEAN^.valid_index(h, current, i)) == (fun0.SIMPLE_ARRAY^BOOLEAN^.valid_index(h', current, i)))));

function modify.SIMPLE_ARRAY^BOOLEAN^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.SIMPLE_ARRAY^BOOLEAN^.item(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^BOOLEAN^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^BOOLEAN^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { read.fun.SIMPLE_ARRAY^BOOLEAN^.item(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^BOOLEAN^.item(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SIMPLE_ARRAY^BOOLEAN^.item(heap: HeapType, current: ref, i: int) returns (bool) {
  ((1) <= (i)) && ((i) <= (fun.SIMPLE_ARRAY^BOOLEAN^.count(heap, current))) && (fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i)) && (is_closed(heap, current))
}

function trigger.fun.SIMPLE_ARRAY^BOOLEAN^.item(heap: HeapType, current: ref, i: int) returns (bool);

function pre.fun.MML_SEQUENCE^BOOLEAN^.replaced_at(current: Seq bool, i: int, x: bool) returns (bool) {
  Seq#Domain(current)[i]
}

function trigger.fun.MML_SEQUENCE^BOOLEAN^.replaced_at(current: Seq bool, i: int, x: bool) returns (bool);

function modify.SIMPLE_ARRAY^BOOLEAN^.put(heap: HeapType, current: ref, v: bool, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, v: bool, i: int :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.SIMPLE_ARRAY^BOOLEAN^.put(heap, current, v, i)[$o, $f] } (modify.SIMPLE_ARRAY^BOOLEAN^.put(heap, current, v, i)[$o, $f]) <==> (($o) == (current))))));

function modify.ANY.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { modify.ANY.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.ANY.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.ANY.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { read.fun.ANY.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.ANY.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
function modify.TWO_WAY_SORT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { modify.TWO_WAY_SORT.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.TWO_WAY_SORT.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.TWO_WAY_SORT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T17> $o: ref, $f: Field T17 :: { read.fun.TWO_WAY_SORT.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.TWO_WAY_SORT.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.TWO_WAY_SORT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.TWO_WAY_SORT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

procedure SIMPLE_ARRAY^BOOLEAN^.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SIMPLE_ARRAY^BOOLEAN^); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_ARRAY^BOOLEAN^.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_ARRAY^BOOLEAN^.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(Heap, Current, new_observers, o), readable);



function fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o) } { trigger.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o) } (pre.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o)) ==> ((fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o) } (fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o)) == (fun0.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.SIMPLE_ARRAY^BOOLEAN^.in_observers(h, current, new_observers, o), fun0.SIMPLE_ARRAY^BOOLEAN^.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(h, current, new_observers, o)) && (pre.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(h, current, new_observers, o)))) ==> ((fun0.SIMPLE_ARRAY^BOOLEAN^.in_observers(h, current, new_observers, o)) == (fun0.SIMPLE_ARRAY^BOOLEAN^.in_observers(h', current, new_observers, o)))));

function modify.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T18> $o: ref, $f: Field T18 :: { modify.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T19> $o: ref, $f: Field T19 :: { read.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap: HeapType, current: ref, i: int) returns (bool) {
  true
}

function trigger.fun.SIMPLE_ARRAY^BOOLEAN^.valid_index(heap: HeapType, current: ref, i: int) returns (bool);

function modify.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T20> $o: ref, $f: Field T20 :: { modify.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T21> $o: ref, $f: Field T21 :: { read.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.SIMPLE_ARRAY^BOOLEAN^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
