...
// Command Line Options: /compile:0 /noVerify /print:b1.bpl b1.dfy
...
implementation Impl$$_module.__default.Add(x#0: int, y#0: int) returns (r#0: int, $_reverifyPost: bool)
{
  ...
  var $decr$loop#00: int;
    ...
    assume {:captureState "b1.dfy(13,0): initial state"} true;
    $_reverifyPost := false;
    // ----- assignment statement ----- b1.dfy(14,5)
    assume true;
    assume true;
    r#0 := x#0;
    assume {:captureState "b1.dfy(14,8)"} true;
    // ----- if statement ----- b1.dfy(15,3)
    assume true;
    if (y#0 < 0)
    {
        // ----- assignment statement ----- b1.dfy(16,11)
        assume true;
        assume true;
        n#0_0 := y#0;
        assume {:captureState "b1.dfy(16,14)"} true;
        // ----- while statement ----- b1.dfy(17,5)
        ...
        while (true)
          ...
          free invariant (if n#0_0 <= LitInt(0) then 0 - n#0_0 else n#0_0 - 0) <= $decr_init$loop#0_00
             && ((if n#0_0 <= LitInt(0) then 0 - n#0_0 else n#0_0 - 0) == $decr_init$loop#0_00
               ==> true);
        {
            assume {:captureState "b1.dfy(17,4): after some loop iterations"} true;
            if (!$w$loop#0_0)
            {
            ...
            // ----- assignment statement ----- b1.dfy(20,9)
            assume true;
            assume true;
            r#0 := r#0 - 1;
            assume {:captureState "b1.dfy(20,16)"} true;
            // ----- assignment statement ----- b1.dfy(21,9)
            assume true;
            assume true;
            n#0_0 := n#0_0 + 1;
            assume {:captureState "b1.dfy(21,16)"} true;
            // ----- loop termination check ----- b1.dfy(17,5)
    ...
    {
        // ----- assignment statement ----- b1.dfy(24,11)
        assume true;
        assume true;
        n#0 := y#0;
        assume {:captureState "b1.dfy(24,14)"} true;
        // ----- while statement ----- b1.dfy(25,5)
        // Assume Fuel Constant
        ...
        {
            assume {:captureState "b1.dfy(25,4): after some loop iterations"} true;
            if (!$w$loop#0)
            {
                if (r#0 == x#0 + y#0 - n#0)
                {
            ...
            // ----- assignment statement ----- b1.dfy(28,9)
            assume true;
            assume true;
            r#0 := r#0 + 1;
            assume {:captureState "b1.dfy(28,16)"} true;
            // ----- assignment statement ----- b1.dfy(29,9)
            assume true;
            assume true;
            n#0 := n#0 - 1;
            assume {:captureState "b1.dfy(29,16)"} true;
            // ----- loop termination check ----- b1.dfy(25,5)
...
implementation Impl$$_module.__default.Mul(x#0: int, y#0: int) returns (r#0: int, $_reverifyPost: bool)
{
  ...
  var y##1: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b1.dfy(37,0): initial state"} true;
    $_reverifyPost := false;
    // ----- if statement ----- b1.dfy(38,3)
    assume true;
    if (x#0 == LitInt(0))
    {
        // ----- assignment statement ----- b1.dfy(39,7)
        assume true;
        assume true;
        r#0 := LitInt(0);
        assume {:captureState "b1.dfy(39,10)"} true;
    }
    else
    {
        // ----- if statement ----- b1.dfy(40,10)
        assume true;
        if (x#0 < 0)
        {
            // ----- call statement ----- b1.dfy(41,13)
            assume true;
            ...
            r#0 := $rhs##1_0;
            assume {:captureState "b1.dfy(41,19)"} true;
            // ----- assignment statement ----- b1.dfy(42,7)
            assume true;
            assume true;
            r#0 := 0 - r#0;
            assume {:captureState "b1.dfy(42,11)"} true;
        }
        else
        {
            // ----- call statement ----- b1.dfy(44,13)
            assume true;
            // TrCallStmt: Adding lhs Microsoft.Dafny.IdentifierExpr with type int
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            ...
            // TrCallStmt: After ProcessCallStmt
            r#0 := $rhs##0;
            assume {:captureState "b1.dfy(44,20)"} true;
            // ----- call statement ----- b1.dfy(45,13)
            assume true;
            // TrCallStmt: Adding lhs Microsoft.Dafny.IdentifierExpr with type int
            // TrCallStmt: Before ProcessCallStmt
            assume true;
            ...
            // TrCallStmt: After ProcessCallStmt
            r#0 := $rhs##1;
            assume {:captureState "b1.dfy(45,18)"} true;
        }
    }
}
...
implementation Impl$$_module.__default.Main() returns ($_reverifyPost: bool)
{
  ...
  var y##8: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b1.dfy(51,14): initial state"} true;
    $_reverifyPost := false;
    // ----- call statement ----- b1.dfy(52,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##0 := LitInt(3);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(52,17)"} true;
    // ----- call statement ----- b1.dfy(53,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##1 := LitInt(3);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(53,18)"} true;
    // ----- call statement ----- b1.dfy(54,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##2 := LitInt(0);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(54,15)"} true;
    // ----- call statement ----- b1.dfy(56,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##3 := LitInt(3);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(56,17)"} true;
    // ----- call statement ----- b1.dfy(57,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##4 := LitInt(3);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(57,18)"} true;
    // ----- call statement ----- b1.dfy(58,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##5 := LitInt(180);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(58,17)"} true;
    // ----- call statement ----- b1.dfy(59,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##6 := LitInt(0 - 180);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(59,18)"} true;
    // ----- call statement ----- b1.dfy(60,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##7 := LitInt(0);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(60,15)"} true;
    // ----- call statement ----- b1.dfy(61,10)
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    // ProcessCallStmt: CheckSubrange
    x##8 := LitInt(1);
    ...
    // TrCallStmt: After ProcessCallStmt
    assume {:captureState "b1.dfy(61,15)"} true;
}
...
implementation Impl$$_module.__default.TestAdd(x#0: int, y#0: int) returns ($_reverifyPost: bool)
{
  ...
  var y##0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b1.dfy(64,31): initial state"} true;
    $_reverifyPost := false;
    // ----- print statement ----- b1.dfy(65,3)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- b1.dfy(66,15)
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    z#0 := $rhs##0;
    assume {:captureState "b1.dfy(66,20)"} true;
    // ----- print statement ----- b1.dfy(67,3)
    assume true;
    assume true;
}
...
implementation Impl$$_module.__default.TestMul(x#0: int, y#0: int) returns ($_reverifyPost: bool)
{
  ...
  var y##0: int;
    ...
    $_Frame := (lambda<alpha> $o: ref, $f: Field alpha ::
      $o != null && read($Heap, $o, alloc) ==> false);
    assume {:captureState "b1.dfy(70,31): initial state"} true;
    $_reverifyPost := false;
    // ----- print statement ----- b1.dfy(71,3)
    assume true;
    assume true;
    assume true;
    assume true;
    // ----- call statement ----- b1.dfy(72,15)
    assume true;
    // TrCallStmt: Adding lhs Microsoft.Dafny.AutoGhostIdentifierExpr with type int
    // TrCallStmt: Before ProcessCallStmt
    assume true;
    ...
    // TrCallStmt: After ProcessCallStmt
    z#0 := $rhs##0;
    assume {:captureState "b1.dfy(72,20)"} true;
    // ----- print statement ----- b1.dfy(73,3)
    assume true;
    assume true;
}
