// Automatically generated (12/12/2017 1:54:54.985 PM)
...
const unique LCP^ANY^: Type;

axiom ((LCP^ANY^) <: (ANY));

axiom ((forall t: Type :: { (LCP^ANY^) <: (t) } ((LCP^ANY^) <: (t)) <==> (((t) == (LCP^ANY^)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, LCP^ANY^)) == (-1));

axiom ((FieldId(closed, LCP^ANY^)) == (-2));

axiom ((FieldId(owner, LCP^ANY^)) == (-3));

axiom ((FieldId(owns, LCP^ANY^)) == (-4));

axiom ((FieldId(observers, LCP^ANY^)) == (-5));

axiom ((FieldId(subjects, LCP^ANY^)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, LCP^ANY^) } (IsModelField($f, LCP^ANY^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } LCP^ANY^.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, LCP^ANY^)) ==> ((user_inv(heap, current)) <==> (LCP^ANY^.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, LCP^ANY^)) ==> ((user_inv(heap, current)) ==> (LCP^ANY^.user_inv(heap, current)))));

procedure LCP.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, LCP^ANY^);



implementation LCP.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.LCP^ANY^.default_create(Current: ref);
  free requires attached_exact(Heap, Current, LCP^ANY^); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.LCP^ANY^.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LCP^ANY^.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.LCP^ANY^.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.LCP^ANY^.default_create"} true;
  if (*) {
...
procedure LCP^ANY^.lcp(Current: ref, a: ref, x: int, y: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, LCP^ANY^); // info:type property for argument Current
  free requires detachable_exact(Heap, a, SIMPLE_ARRAY^ANY^); // info:type property for argument a
  free requires is_integer_32(x); // info:type property for argument x
  free requires is_integer_32(y); // info:type property for argument y
  modifies Heap;
  requires (a) != (Void); // type:attached tag:x_in_range line:12
  requires pre.fun.SIMPLE_ARRAY^ANY^.count(Heap, a); // type:check tag:function_precondition line:12 cid:190 rid:3249
  requires ((1) <= (x)) && ((x) <= (fun.SIMPLE_ARRAY^ANY^.count(Heap, a))); // type:pre tag:x_in_range line:12
  requires ((1) <= (y)) && ((y) <= (fun.SIMPLE_ARRAY^ANY^.count(Heap, a))); // type:pre tag:y_in_range line:13
  requires ((0) < (fun.SIMPLE_ARRAY^ANY^.count(Heap, a))) && ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) < (2147483647)); // type:pre tag:no_overflow line:14
  ensures (Result) >= (0); // type:post tag:length_non_negative line:34
  ensures is_integer_32((x) + (Result)); // type:overflow tag:end_in_range_1 line:35
  ensures (a) != (Void); // type:attached tag:end_in_range_1 line:35
  ensures pre.fun.SIMPLE_ARRAY^ANY^.count(Heap, a); // type:check tag:function_precondition line:35 cid:190 rid:3249
  ensures is_integer_32((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)); // type:overflow tag:end_in_range_1 line:35
  ensures ((x) + (Result)) <= ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)); // type:post tag:end_in_range_1 line:35
  ensures is_integer_32((y) + (Result)); // type:overflow tag:end_in_range_2 line:36
  ensures ((y) + (Result)) <= ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)); // type:post tag:end_in_range_2 line:36
  ensures is_integer_32(subtract(Result, 1)); // type:overflow tag:is_common line:37
  ensures (forall i_1: int :: (((0) <= (i_1)) && ((i_1) <= (subtract(Result, 1)))) ==> (is_integer_32(add(x, i_1)))); // type:overflow tag:is_common line:37
  ensures (forall i_1: int :: (((0) <= (i_1)) && ((i_1) <= (subtract(Result, 1)))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(x, i_1)))); // type:check tag:function_precondition line:37 cid:190 rid:3250
  ensures (forall i_1: int :: (((0) <= (i_1)) && ((i_1) <= (subtract(Result, 1)))) ==> (is_integer_32(add(y, i_1)))); // type:overflow tag:is_common line:37
  ensures (forall i_1: int :: (((0) <= (i_1)) && ((i_1) <= (subtract(Result, 1)))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(y, i_1)))); // type:check tag:function_precondition line:37 cid:190 rid:3250
  ensures (forall i_1: int :: (((0) <= (i_1)) && ((i_1) <= (subtract(Result, 1)))) ==> ((fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(x, i_1))) == (fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(y, i_1))))); // type:post tag:is_common line:37
  ensures (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> (is_integer_32((y) + (Result))); // type:overflow tag:longest_prefix line:38
  ensures (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> ((a) != (Void)); // type:attached tag:longest_prefix line:38
  ensures (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.count(Heap, a)); // type:check tag:function_precondition line:38 cid:190 rid:3249
  ensures (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> (is_integer_32((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))); // type:overflow tag:longest_prefix line:38
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> ((a) != (Void)); // type:attached tag:longest_prefix line:38
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (is_integer_32((x) + (Result))); // type:overflow tag:longest_prefix line:38
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (x) + (Result))); // type:check tag:function_precondition line:38 cid:190 rid:3250
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (is_integer_32((y) + (Result))); // type:overflow tag:longest_prefix line:38
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (y) + (Result))); // type:check tag:function_precondition line:38 cid:190 rid:3250
  ensures (((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || ((fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (x) + (Result))) != (fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (y) + (Result)))); // type:post tag:longest_prefix line:38
  ensures pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, x); // type:check tag:function_precondition line:39 cid:190 rid:3250
  ensures pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, y); // type:check tag:function_precondition line:39 cid:190 rid:3250
  ensures ((fun.SIMPLE_ARRAY^ANY^.item(Heap, a, x)) != (fun.SIMPLE_ARRAY^ANY^.item(Heap, a, y))) ==> ((Result) == (0)); // type:post tag:empty_prefix line:39
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LCP^ANY^.lcp(Heap, Current, a, x, y), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LCP^ANY^.lcp(old(Heap), Current, a, x, y));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LCP^ANY^.lcp(Heap, Current, a, x, y), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  requires is_closed(Heap, a); // type:pre tag:arg_a_is_closed default:contracts
  free ensures (Result) == (fun.LCP^ANY^.lcp(old(Heap), Current, a, x, y));



function fun.LCP^ANY^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref, x: int, y: int :: { fun.LCP^ANY^.lcp(heap, current, a, x, y) } (pre.fun.LCP^ANY^.lcp(heap, current, a, x, y)) ==> (((fun.LCP^ANY^.lcp(heap, current, a, x, y)) >= (0)) && (((x) + (fun.LCP^ANY^.lcp(heap, current, a, x, y))) <= ((fun.SIMPLE_ARRAY^ANY^.count(heap, a)) + (1))) && (((y) + (fun.LCP^ANY^.lcp(heap, current, a, x, y))) <= ((fun.SIMPLE_ARRAY^ANY^.count(heap, a)) + (1))) && ((forall i_2: int :: (((0) <= (i_2)) && ((i_2) <= (subtract(fun.LCP^ANY^.lcp(heap, current, a, x, y), 1)))) ==> ((fun.SIMPLE_ARRAY^ANY^.item(heap, a, add(x, i_2))) == (fun.SIMPLE_ARRAY^ANY^.item(heap, a, add(y, i_2)))))) && ((((x) + (fun.LCP^ANY^.lcp(heap, current, a, x, y))) == ((fun.SIMPLE_ARRAY^ANY^.count(heap, a)) + (1))) || (((y) + (fun.LCP^ANY^.lcp(heap, current, a, x, y))) == ((fun.SIMPLE_ARRAY^ANY^.count(heap, a)) + (1))) || ((fun.SIMPLE_ARRAY^ANY^.item(heap, a, (x) + (fun.LCP^ANY^.lcp(heap, current, a, x, y)))) != (fun.SIMPLE_ARRAY^ANY^.item(heap, a, (y) + (fun.LCP^ANY^.lcp(heap, current, a, x, y)))))) && (((fun.SIMPLE_ARRAY^ANY^.item(heap, a, x)) != (fun.SIMPLE_ARRAY^ANY^.item(heap, a, y))) ==> ((fun.LCP^ANY^.lcp(heap, current, a, x, y)) == (0))) && (is_integer_32(fun.LCP^ANY^.lcp(heap, current, a, x, y))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref, x: int, y: int :: { HeapSucc(h, h'), fun.LCP^ANY^.lcp(h, current, a, x, y), fun.LCP^ANY^.lcp(h', current, a, x, y) } ((HeapSucc(h, h')) && (pre.fun.LCP^ANY^.lcp(h, current, a, x, y)) && (pre.fun.LCP^ANY^.lcp(h', current, a, x, y)) && (same_inside(h, h', read.fun.LCP^ANY^.lcp(h, current, a, x, y)))) ==> ((fun.LCP^ANY^.lcp(h, current, a, x, y)) == (fun.LCP^ANY^.lcp(h', current, a, x, y)))));

function { :inline } variant.LCP^ANY^.lcp.1(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (ref) {
  a
}

function { :inline } variant.LCP^ANY^.lcp.2(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (int) {
  x
}

function { :inline } variant.LCP^ANY^.lcp.3(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (int) {
  y
}

implementation LCP^ANY^.lcp(Current: ref, a: ref, x: int, y: int) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "LCP^ANY^.lcp"} true;
  // /home/caf/temp/comcom/repo-lcp/lcp.e:17
  // Result := 0
  Result := 0;
  PreLoopHeap_6 := Heap;
  goto loop_head_3;
  loop_head_3:
  // /home/caf/temp/comcom/repo-lcp/lcp.e:19
  // length_non_negative: Result >= 0
  assert (Result) >= (0); // type:loop_inv tag:length_non_negative line:19
  // /home/caf/temp/comcom/repo-lcp/lcp.e:20
  // end_in_range_1: x + Result <= a.count + 1
  assert {:subsumption 0} is_integer_32((x) + (Result)); // type:overflow line:20
  assert {:subsumption 0} (a) != (Void); // type:attached line:20
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.count(Heap, a), readable); // type:access tag:frame_readable line:20 cid:190 rid:3249
  assert pre.fun.SIMPLE_ARRAY^ANY^.count(Heap, a); // type:check tag:function_precondition line:20 cid:190 rid:3249
  assert {:subsumption 0} is_integer_32((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)); // type:overflow line:20
  assert ((x) + (Result)) <= ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)); // type:loop_inv tag:end_in_range_1 line:20
  // /home/caf/temp/comcom/repo-lcp/lcp.e:21
  // end_in_range_2: y + Result <= a.count + 1
  assert {:subsumption 0} is_integer_32((y) + (Result)); // type:overflow line:21
  assert {:subsumption 0} (a) != (Void); // type:attached line:21
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.count(Heap, a), readable); // type:access tag:frame_readable line:21 cid:190 rid:3249
  assert pre.fun.SIMPLE_ARRAY^ANY^.count(Heap, a); // type:check tag:function_precondition line:21 cid:190 rid:3249
  assert {:subsumption 0} is_integer_32((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)); // type:overflow line:21
  assert ((y) + (Result)) <= ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)); // type:loop_inv tag:end_in_range_2 line:21
  // /home/caf/temp/comcom/repo-lcp/lcp.e:22
  // is_common: across 0 |..| (Result - 1) as i all a [x + i.item] = a [y + i.item] end
  assert {:subsumption 0} is_integer_32(subtract(Result, 1)); // type:overflow line:22
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert (forall i_7: int :: (((0) <= (i_7)) && ((i_7) <= (subtract(Result, 1)))) ==> (is_integer_32(add(x, i_7)))); // type:overflow line:22
  assert (forall i_7: int :: (((0) <= (i_7)) && ((i_7) <= (subtract(Result, 1)))) ==> (Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(x, i_7)), readable))); // type:access tag:frame_readable line:22 cid:190 rid:3250
  assert (forall i_7: int :: (((0) <= (i_7)) && ((i_7) <= (subtract(Result, 1)))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(x, i_7)))); // type:check tag:function_precondition line:22 cid:190 rid:3250
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert (forall i_7: int :: (((0) <= (i_7)) && ((i_7) <= (subtract(Result, 1)))) ==> (is_integer_32(add(y, i_7)))); // type:overflow line:22
  assert (forall i_7: int :: (((0) <= (i_7)) && ((i_7) <= (subtract(Result, 1)))) ==> (Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(y, i_7)), readable))); // type:access tag:frame_readable line:22 cid:190 rid:3250
  assert (forall i_7: int :: (((0) <= (i_7)) && ((i_7) <= (subtract(Result, 1)))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(y, i_7)))); // type:check tag:function_precondition line:22 cid:190 rid:3250
  assert (forall i_7: int :: (((0) <= (i_7)) && ((i_7) <= (subtract(Result, 1)))) ==> ((fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(x, i_7))) == (fun.SIMPLE_ARRAY^ANY^.item(Heap, a, add(y, i_7))))); // type:loop_inv tag:is_common line:22
  // /home/caf/temp/comcom/repo-lcp/lcp.e:23
  // empty_prefix: a [x] /= a [y] implies Result = 0
  assert {:subsumption 0} (a) != (Void); // type:attached line:23
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, x), readable); // type:access tag:frame_readable line:23 cid:190 rid:3250
  assert pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, x); // type:check tag:function_precondition line:23 cid:190 rid:3250
  assert {:subsumption 0} (a) != (Void); // type:attached line:23
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, y), readable); // type:access tag:frame_readable line:23 cid:190 rid:3250
  assert pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, y); // type:check tag:function_precondition line:23 cid:190 rid:3250
  assert ((fun.SIMPLE_ARRAY^ANY^.item(Heap, a, x)) != (fun.SIMPLE_ARRAY^ANY^.item(Heap, a, y))) ==> ((Result) == (0)); // type:loop_inv tag:empty_prefix line:23
  assume HeapSucc(PreLoopHeap_6, Heap);
  assume same_outside(old(Heap), Heap, modify.LCP^ANY^.lcp(old(Heap), Current, a, x, y));
  assume global(Heap);
  // /home/caf/temp/comcom/repo-lcp/lcp.e:-1
  assert {:subsumption 0} is_integer_32((x) + (Result)); // type:overflow line:-1
  assert {:subsumption 0} (a) != (Void); // type:attached line:-1
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.count(Heap, a), readable); // type:access tag:frame_readable line:-1 cid:190 rid:3249
  assert pre.fun.SIMPLE_ARRAY^ANY^.count(Heap, a); // type:check tag:function_precondition line:-1 cid:190 rid:3249
  assert {:subsumption 0} is_integer_32((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)); // type:overflow line:-1
  assert {:subsumption 0} (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> (is_integer_32((y) + (Result))); // type:overflow line:-1
  assert {:subsumption 0} (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> ((a) != (Void)); // type:attached line:-1
  assert (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> (Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.count(Heap, a), readable)); // type:access tag:frame_readable line:-1 cid:190 rid:3249
  assert (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.count(Heap, a)); // type:check tag:function_precondition line:-1 cid:190 rid:3249
  assert {:subsumption 0} (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1)))) ==> (is_integer_32((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))); // type:overflow line:-1
  assert {:subsumption 0} (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> ((a) != (Void)); // type:attached line:-1
  assert {:subsumption 0} (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (is_integer_32((x) + (Result))); // type:overflow line:-1
  assert (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (x) + (Result)), readable)); // type:access tag:frame_readable line:-1 cid:190 rid:3250
  assert (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (x) + (Result))); // type:check tag:function_precondition line:-1 cid:190 rid:3250
  assert {:subsumption 0} (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> ((a) != (Void)); // type:attached line:-1
  assert {:subsumption 0} (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (is_integer_32((y) + (Result))); // type:overflow line:-1
  assert (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (Frame#Subset(read.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (y) + (Result)), readable)); // type:access tag:frame_readable line:-1 cid:190 rid:3250
  assert (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))))) ==> (pre.fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (y) + (Result))); // type:check tag:function_precondition line:-1 cid:190 rid:3250
  goto loop_body_4, loop_end_5;
  loop_body_4:
  assume !((((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || ((fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (x) + (Result))) != (fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (y) + (Result)))));
  // /home/caf/temp/comcom/repo-lcp/lcp.e:31
  // a.count - Result + 1
  variant_8 := ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) - (Result)) + (1);
  // /home/caf/temp/comcom/repo-lcp/lcp.e:29
  // Result := Result + 1
  assert {:subsumption 0} is_integer_32((Result) + (1)); // type:overflow line:29
  Result := (Result) + (1);
  // /home/caf/temp/comcom/repo-lcp/lcp.e:31
  // a.count - Result + 1
  assert {:subsumption 0} (((((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) - (Result)) + (1)) <= (variant_8)) && ((variant_8) <= (((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) - (Result)) + (1)))) || ((0) <= (variant_8)); // type:termination tag:bounded line:31 varid:1
  assert {:subsumption 0} ((((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) - (Result)) + (1)) <= (variant_8)) && (!((variant_8) <= (((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) - (Result)) + (1)))); // type:termination tag:variant_decreases line:31
  goto loop_head_3;
  loop_end_5:
  assume (((x) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^ANY^.count(Heap, a)) + (1))) || ((fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (x) + (Result))) != (fun.SIMPLE_ARRAY^ANY^.item(Heap, a, (y) + (Result))));
}
...
axiom ((forall <T5> $f: Field T5 :: { IsModelField($f, CLIENT) } (IsModelField($f, CLIENT)) <==> ((($f) == (subjects)) || (($f) == (observers)))));
...
implementation create.CLIENT.default_create(Current: ref)
{
  ...
  if (*) {
    assert Set#IsEmpty(Heap[Current, observers]); // type:inv tag:default_observers line:49 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, subjects]); // type:inv tag:default_subjects line:49 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, owns]); // type:inv tag:default_owns line:49 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert admissibility2(Heap, Current); // type:inv tag:A2 line:49 cid:1 rid:55
    assume false;
  }
  call wrap(Current); // default:wrapping cid:1 rid:55 line:364
}

procedure CLIENT.test_lcp(Current: ref);
  free requires attached_exact(Heap, Current, CLIENT); // info:type property for argument Current
  modifies Heap;
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.CLIENT.test_lcp(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.CLIENT.test_lcp(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.CLIENT.test_lcp.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation CLIENT.test_lcp(Current: ref)
{
  var temp_9: ref;
  var temp_10: ref;
  var temp_11: int;
  ...
  var temp_22: int;
  var temp_23: int;
  var local1: ref where detachable(Heap, local1, LCP^INTEGER_32^);
  var local2: ref where detachable_exact(Heap, local2, SIMPLE_ARRAY^INTEGER_32^);
  ...
  entry:
  assume {:captureState "CLIENT.test_lcp"} true;
  call unwrap(Current); // default:wrapping cid:1 rid:57 line:9
  assume CLIENT.user_inv(Heap, Current);
  // /home/caf/temp/comcom/repo-lcp/client.e:16
  // create l
  call temp_9 := allocate(LCP^INTEGER_32^); // line:-1
  call create.LCP^INTEGER_32^.default_create(temp_9); // line:16 cid:405 rid:35
  local1 := temp_9;
  // /home/caf/temp/comcom/repo-lcp/client.e:17
  // create a.init (<< 1 >>)
  call temp_10 := allocate(SIMPLE_ARRAY^INTEGER_32^); // line:-1
  call create.SIMPLE_ARRAY^INTEGER_32^.init(temp_10, Seq#Singleton(1)); // line:17 cid:190 rid:3247
  local2 := temp_10;
  // /home/caf/temp/comcom/repo-lcp/client.e:19
  // x := l.lcp (a, 1, 1)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:19
  call temp_11 := LCP^INTEGER_32^.lcp(local1, local2, 1, 1); // line:19 cid:405 rid:5401
  local3 := temp_11;
  // /home/caf/temp/comcom/repo-lcp/client.e:20
  // check x = 1 end
  assert (local3) == (1); // type:check line:20
  // /home/caf/temp/comcom/repo-lcp/client.e:22
  // create a.init (<< 1, 1 >>)
  call temp_12 := allocate(SIMPLE_ARRAY^INTEGER_32^); // line:-1
  call create.SIMPLE_ARRAY^INTEGER_32^.init(temp_12, Seq#Extended(Seq#Singleton(1), 1)); // line:22 cid:190 rid:3247
  local2 := temp_12;
  // /home/caf/temp/comcom/repo-lcp/client.e:24
  // x := l.lcp (a, 1, 2)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:24
  call temp_13 := LCP^INTEGER_32^.lcp(local1, local2, 1, 2); // line:24 cid:405 rid:5401
  local3 := temp_13;
  // /home/caf/temp/comcom/repo-lcp/client.e:25
  // check x = 1 end
  assert (local3) == (1); // type:check line:25
  // /home/caf/temp/comcom/repo-lcp/client.e:26
  // x := l.lcp (a, 1, 1)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:26
  call temp_14 := LCP^INTEGER_32^.lcp(local1, local2, 1, 1); // line:26 cid:405 rid:5401
  local3 := temp_14;
  // /home/caf/temp/comcom/repo-lcp/client.e:27
  // check x = 2 end
  assert (local3) == (2); // type:check line:27
  // /home/caf/temp/comcom/repo-lcp/client.e:29
  // create a.init (<< 1, 2 >>)
  call temp_15 := allocate(SIMPLE_ARRAY^INTEGER_32^); // line:-1
  call create.SIMPLE_ARRAY^INTEGER_32^.init(temp_15, Seq#Extended(Seq#Singleton(1), 2)); // line:29 cid:190 rid:3247
  local2 := temp_15;
  // /home/caf/temp/comcom/repo-lcp/client.e:31
  // x := l.lcp (a, 1, 2)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:31
  call temp_16 := LCP^INTEGER_32^.lcp(local1, local2, 1, 2); // line:31 cid:405 rid:5401
  local3 := temp_16;
  // /home/caf/temp/comcom/repo-lcp/client.e:32
  // check x = 0 end
  assert (local3) == (0); // type:check line:32
  // /home/caf/temp/comcom/repo-lcp/client.e:33
  // x := l.lcp (a, 1, 1)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:33
  call temp_17 := LCP^INTEGER_32^.lcp(local1, local2, 1, 1); // line:33 cid:405 rid:5401
  local3 := temp_17;
  // /home/caf/temp/comcom/repo-lcp/client.e:34
  // check x = 2 end
  assert (local3) == (2); // type:check line:34
  // /home/caf/temp/comcom/repo-lcp/client.e:36
  // create a.init (<< 1, 2, 2, 5>>)
  call temp_18 := allocate(SIMPLE_ARRAY^INTEGER_32^); // line:-1
  call create.SIMPLE_ARRAY^INTEGER_32^.init(temp_18, Seq#Extended(Seq#Extended(Seq#Extended(Seq#Singleton(1), 2), 2), 5)); // line:36 cid:190 rid:3247
  local2 := temp_18;
  // /home/caf/temp/comcom/repo-lcp/client.e:38
  // x := l.lcp (a, 1, 2)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:38
  call temp_19 := LCP^INTEGER_32^.lcp(local1, local2, 1, 2); // line:38 cid:405 rid:5401
  local3 := temp_19;
  // /home/caf/temp/comcom/repo-lcp/client.e:39
  // check x = 0 end
  assert (local3) == (0); // type:check line:39
  // /home/caf/temp/comcom/repo-lcp/client.e:41
  // create a.init (<< 1, 2, 3, 4, 1, 2, 3>>)
  call temp_20 := allocate(SIMPLE_ARRAY^INTEGER_32^); // line:-1
  call create.SIMPLE_ARRAY^INTEGER_32^.init(temp_20, Seq#Extended(Seq#Extended(Seq#Extended(Seq#Extended(Seq#Extended(Seq#Extended(Seq#Singleton(1), 2), 3), 4), 1), 2), 3)); // line:41 cid:190 rid:3247
  local2 := temp_20;
  // /home/caf/temp/comcom/repo-lcp/client.e:43
  // x := l.lcp (a, 1, 3)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:43
  call temp_21 := LCP^INTEGER_32^.lcp(local1, local2, 1, 3); // line:43 cid:405 rid:5401
  local3 := temp_21;
  // /home/caf/temp/comcom/repo-lcp/client.e:44
  // check x = 0 end
  assert (local3) == (0); // type:check line:44
  // /home/caf/temp/comcom/repo-lcp/client.e:45
  // x := l.lcp (a, 1, 5)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:45
  call temp_22 := LCP^INTEGER_32^.lcp(local1, local2, 1, 5); // line:45 cid:405 rid:5401
  local3 := temp_22;
  // /home/caf/temp/comcom/repo-lcp/client.e:46
  // check x = 3 end
  assert (local3) == (3); // type:check line:46
  // /home/caf/temp/comcom/repo-lcp/client.e:47
  // x := l.lcp (a, 2, 6)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:47
  call temp_23 := LCP^INTEGER_32^.lcp(local1, local2, 2, 6); // line:47 cid:405 rid:5401
  local3 := temp_23;
  // /home/caf/temp/comcom/repo-lcp/client.e:48
  // check x = 2 end
  assert (local3) == (2); // type:check line:48
  if (*) {
    assert Set#IsEmpty(Heap[Current, observers]); // type:inv tag:default_observers line:49 cid:1 rid:55
    assume false;
  }
  ...
  call wrap(Current); // default:wrapping cid:1 rid:55 line:49
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, LCP^ANY^)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, LCP^ANY^)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, LCP^ANY^)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.LCP^ANY^.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, LCP^ANY^)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.LCP^ANY^.in_observers(heap, current, v, o)))));

function modify.LCP^ANY^.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { modify.LCP^ANY^.default_create(heap, current)[$o, $f] } (modify.LCP^ANY^.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
axiom ((forall <T9> $f: Field T9 :: { IsModelField($f, SIMPLE_ARRAY^ANY^) } (IsModelField($f, SIMPLE_ARRAY^ANY^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));
...
function modify.LCP^ANY^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, x: int, y: int :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { modify.LCP^ANY^.lcp(heap, current, a, x, y)[$o, $f] } (modify.LCP^ANY^.lcp(heap, current, a, x, y)[$o, $f]) <==> (false)))));

function read.fun.LCP^ANY^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, x: int, y: int :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { read.fun.LCP^ANY^.lcp(heap, current, a, x, y)[$o, $f] } (read.fun.LCP^ANY^.lcp(heap, current, a, x, y)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LCP^ANY^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (bool) {
  ((1) <= (x)) && ((x) <= (fun.SIMPLE_ARRAY^ANY^.count(heap, a))) && ((1) <= (y)) && ((y) <= (fun.SIMPLE_ARRAY^ANY^.count(heap, a))) && ((0) < (fun.SIMPLE_ARRAY^ANY^.count(heap, a))) && ((fun.SIMPLE_ARRAY^ANY^.count(heap, a)) < (2147483647)) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.LCP^ANY^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (bool);
...
axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { modify.CLIENT.default_create(heap, current)[$o, $f] } (modify.CLIENT.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));

function modify.CLIENT.test_lcp(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.CLIENT.test_lcp(heap, current)[$o, $f] } (modify.CLIENT.test_lcp(heap, current)[$o, $f]) <==> (($o) == (current))))));

const unique LCP^INTEGER_32^: Type;

axiom ((LCP^INTEGER_32^) <: (ANY));

axiom ((forall t: Type :: { (LCP^INTEGER_32^) <: (t) } ((LCP^INTEGER_32^) <: (t)) <==> (((t) == (LCP^INTEGER_32^)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, LCP^INTEGER_32^)) == (-1));

axiom ((FieldId(closed, LCP^INTEGER_32^)) == (-2));

axiom ((FieldId(owner, LCP^INTEGER_32^)) == (-3));

axiom ((FieldId(owns, LCP^INTEGER_32^)) == (-4));

axiom ((FieldId(observers, LCP^INTEGER_32^)) == (-5));

axiom ((FieldId(subjects, LCP^INTEGER_32^)) == (-6));

axiom ((forall <T14> $f: Field T14 :: { IsModelField($f, LCP^INTEGER_32^) } (IsModelField($f, LCP^INTEGER_32^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } LCP^INTEGER_32^.user_inv(heap: HeapType, current: ref) returns (bool) {
  (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, LCP^INTEGER_32^)) ==> ((user_inv(heap, current)) <==> (LCP^INTEGER_32^.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, LCP^INTEGER_32^)) ==> ((user_inv(heap, current)) ==> (LCP^INTEGER_32^.user_inv(heap, current)))));

procedure create.LCP^INTEGER_32^.default_create(Current: ref);
  free requires attached_exact(Heap, Current, LCP^INTEGER_32^); // info:type property for argument Current
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LCP^INTEGER_32^.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LCP^INTEGER_32^.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
axiom ((forall <T17> $f: Field T17 :: { IsModelField($f, SIMPLE_ARRAY^INTEGER_32^) } (IsModelField($f, SIMPLE_ARRAY^INTEGER_32^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));
...
procedure create.SIMPLE_ARRAY^INTEGER_32^.init(Current: ref, s: Seq int);
  ...
  modifies Heap;
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, Current); // type:check tag:function_precondition line:57 cid:190 rid:3249
  ensures (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, Current)) == (Seq#Length(s)); // type:post tag:count_set line:57
  ensures Seq#Equal(Heap[Current, SIMPLE_ARRAY^INTEGER_32^.sequence], s); // type:post tag:sequence_set line:58
  requires (forall <T18> $f: Field T18 :: (($f) != (allocated)) ==> ((Heap[Current, $f]) == (Default($f))));
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_ARRAY^INTEGER_32^.init(Heap, Current, s), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_ARRAY^INTEGER_32^.init(old(Heap), Current, s));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



procedure LCP^INTEGER_32^.lcp(Current: ref, a: ref, x: int, y: int) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, LCP^INTEGER_32^); // info:type property for argument Current
  ...
  modifies Heap;
  requires (a) != (Void); // type:attached tag:x_in_range line:12
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:12 cid:190 rid:3249
  requires ((1) <= (x)) && ((x) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))); // type:pre tag:x_in_range line:12
  requires ((1) <= (y)) && ((y) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))); // type:pre tag:y_in_range line:13
  requires ((0) < (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) < (2147483647)); // type:pre tag:no_overflow line:14
  ensures (Result) >= (0); // type:post tag:length_non_negative line:34
  ensures is_integer_32((x) + (Result)); // type:overflow tag:end_in_range_1 line:35
  ensures (a) != (Void); // type:attached tag:end_in_range_1 line:35
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:35 cid:190 rid:3249
  ensures is_integer_32((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)); // type:overflow tag:end_in_range_1 line:35
  ensures ((x) + (Result)) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)); // type:post tag:end_in_range_1 line:35
  ensures is_integer_32((y) + (Result)); // type:overflow tag:end_in_range_2 line:36
  ensures ((y) + (Result)) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)); // type:post tag:end_in_range_2 line:36
  ensures is_integer_32(subtract(Result, 1)); // type:overflow tag:is_common line:37
  ensures (forall i_25: int :: (((0) <= (i_25)) && ((i_25) <= (subtract(Result, 1)))) ==> (is_integer_32(add(x, i_25)))); // type:overflow tag:is_common line:37
  ensures (forall i_25: int :: (((0) <= (i_25)) && ((i_25) <= (subtract(Result, 1)))) ==> (pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, add(x, i_25)))); // type:check tag:function_precondition line:37 cid:190 rid:3250
  ensures (forall i_25: int :: (((0) <= (i_25)) && ((i_25) <= (subtract(Result, 1)))) ==> (is_integer_32(add(y, i_25)))); // type:overflow tag:is_common line:37
  ensures (forall i_25: int :: (((0) <= (i_25)) && ((i_25) <= (subtract(Result, 1)))) ==> (pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, add(y, i_25)))); // type:check tag:function_precondition line:37 cid:190 rid:3250
  ensures (forall i_25: int :: (((0) <= (i_25)) && ((i_25) <= (subtract(Result, 1)))) ==> ((fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, add(x, i_25))) == (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, add(y, i_25))))); // type:post tag:is_common line:37
  ensures (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)))) ==> (is_integer_32((y) + (Result))); // type:overflow tag:longest_prefix line:38
  ensures (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)))) ==> ((a) != (Void)); // type:attached tag:longest_prefix line:38
  ensures (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)))) ==> (pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)); // type:check tag:function_precondition line:38 cid:190 rid:3249
  ensures (!(((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1)))) ==> (is_integer_32((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))); // type:overflow tag:longest_prefix line:38
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))))) ==> ((a) != (Void)); // type:attached tag:longest_prefix line:38
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))))) ==> (is_integer_32((x) + (Result))); // type:overflow tag:longest_prefix line:38
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))))) ==> (pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, (x) + (Result))); // type:check tag:function_precondition line:38 cid:190 rid:3250
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))))) ==> (is_integer_32((y) + (Result))); // type:overflow tag:longest_prefix line:38
  ensures (!((((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))))) ==> (pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, (y) + (Result))); // type:check tag:function_precondition line:38 cid:190 rid:3250
  ensures (((x) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))) || (((y) + (Result)) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) + (1))) || ((fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, (x) + (Result))) != (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, (y) + (Result)))); // type:post tag:longest_prefix line:38
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, x); // type:check tag:function_precondition line:39 cid:190 rid:3250
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, y); // type:check tag:function_precondition line:39 cid:190 rid:3250
  ensures ((fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, x)) != (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, y))) ==> ((Result) == (0)); // type:post tag:empty_prefix line:39
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LCP^INTEGER_32^.lcp(Heap, Current, a, x, y), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LCP^INTEGER_32^.lcp(old(Heap), Current, a, x, y));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LCP^INTEGER_32^.lcp(Heap, Current, a, x, y), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  requires is_closed(Heap, a); // type:pre tag:arg_a_is_closed default:contracts
  free ensures (Result) == (fun.LCP^INTEGER_32^.lcp(old(Heap), Current, a, x, y));



function fun.LCP^INTEGER_32^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref, x: int, y: int :: { fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y) } (pre.fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y)) ==> (((fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y)) >= (0)) && (((x) + (fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y))) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) + (1))) && (((y) + (fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y))) <= ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) + (1))) && ((forall i_26: int :: (((0) <= (i_26)) && ((i_26) <= (subtract(fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y), 1)))) ==> ((fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, a, add(x, i_26))) == (fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, a, add(y, i_26)))))) && ((((x) + (fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y))) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) + (1))) || (((y) + (fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y))) == ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) + (1))) || ((fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, a, (x) + (fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y)))) != (fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, a, (y) + (fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y)))))) && (((fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, a, x)) != (fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, a, y))) ==> ((fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y)) == (0))) && (is_integer_32(fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref, x: int, y: int :: { HeapSucc(h, h'), fun.LCP^INTEGER_32^.lcp(h, current, a, x, y), fun.LCP^INTEGER_32^.lcp(h', current, a, x, y) } ((HeapSucc(h, h')) && (pre.fun.LCP^INTEGER_32^.lcp(h, current, a, x, y)) && (pre.fun.LCP^INTEGER_32^.lcp(h', current, a, x, y)) && (same_inside(h, h', read.fun.LCP^INTEGER_32^.lcp(h, current, a, x, y)))) ==> ((fun.LCP^INTEGER_32^.lcp(h, current, a, x, y)) == (fun.LCP^INTEGER_32^.lcp(h', current, a, x, y)))));
...
procedure LCP^ANY^.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, LCP^ANY^); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LCP^ANY^.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LCP^ANY^.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LCP^ANY^.in_observers(Heap, Current, new_observers, o), readable);



function fun.LCP^ANY^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.LCP^ANY^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LCP^ANY^.in_observers(heap, current, new_observers, o) } { trigger.fun.LCP^ANY^.in_observers(heap, current, new_observers, o) } (pre.fun.LCP^ANY^.in_observers(heap, current, new_observers, o)) ==> ((fun.LCP^ANY^.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LCP^ANY^.in_observers(heap, current, new_observers, o) } (fun.LCP^ANY^.in_observers(heap, current, new_observers, o)) == (fun0.LCP^ANY^.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.LCP^ANY^.in_observers(h, current, new_observers, o), fun0.LCP^ANY^.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.LCP^ANY^.in_observers(h, current, new_observers, o)) && (pre.fun.LCP^ANY^.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.LCP^ANY^.in_observers(h, current, new_observers, o)))) ==> ((fun0.LCP^ANY^.in_observers(h, current, new_observers, o)) == (fun0.LCP^ANY^.in_observers(h', current, new_observers, o)))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T21> $o: ref, $f: Field T21 :: { modify.SIMPLE_ARRAY^ANY^.item(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^ANY^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^ANY^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T22> $o: ref, $f: Field T22 :: { read.fun.SIMPLE_ARRAY^ANY^.item(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^ANY^.item(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, LCP^INTEGER_32^)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, LCP^INTEGER_32^)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, LCP^INTEGER_32^)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.LCP^INTEGER_32^.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, LCP^INTEGER_32^)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.LCP^INTEGER_32^.in_observers(heap, current, v, o)))));

function modify.LCP^INTEGER_32^.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T23> $o: ref, $f: Field T23 :: { modify.LCP^INTEGER_32^.default_create(heap, current)[$o, $f] } (modify.LCP^INTEGER_32^.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.SIMPLE_ARRAY^INTEGER_32^.init(heap: HeapType, current: ref, s: Seq int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, s: Seq int :: (IsHeap(heap)) ==> ((forall <T24> $o: ref, $f: Field T24 :: { modify.SIMPLE_ARRAY^INTEGER_32^.init(heap, current, s)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.init(heap, current, s)[$o, $f]) <==> (($o) == (current))))));
...
function modify.LCP^INTEGER_32^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, x: int, y: int :: (IsHeap(heap)) ==> ((forall <T25> $o: ref, $f: Field T25 :: { modify.LCP^INTEGER_32^.lcp(heap, current, a, x, y)[$o, $f] } (modify.LCP^INTEGER_32^.lcp(heap, current, a, x, y)[$o, $f]) <==> (false)))));

function read.fun.LCP^INTEGER_32^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref, x: int, y: int :: (IsHeap(heap)) ==> ((forall <T26> $o: ref, $f: Field T26 :: { read.fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y)[$o, $f] } (read.fun.LCP^INTEGER_32^.lcp(heap, current, a, x, y)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LCP^INTEGER_32^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (bool) {
  ((1) <= (x)) && ((x) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && ((1) <= (y)) && ((y) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && ((0) < (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) < (2147483647)) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.LCP^INTEGER_32^.lcp(heap: HeapType, current: ref, a: ref, x: int, y: int) returns (bool);
...
function modify.LCP^ANY^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T29> $o: ref, $f: Field T29 :: { modify.LCP^ANY^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.LCP^ANY^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.LCP^ANY^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T30> $o: ref, $f: Field T30 :: { read.fun.LCP^ANY^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.LCP^ANY^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LCP^ANY^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.LCP^ANY^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T31> $o: ref, $f: Field T31 :: { modify.SIMPLE_ARRAY^ANY^.valid_index(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^ANY^.valid_index(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^ANY^.valid_index(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T32> $o: ref, $f: Field T32 :: { read.fun.SIMPLE_ARRAY^ANY^.valid_index(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^ANY^.valid_index(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T33> $o: ref, $f: Field T33 :: { modify.CLIENT.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.CLIENT.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.CLIENT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T34> $o: ref, $f: Field T34 :: { read.fun.CLIENT.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.CLIENT.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
procedure LCP^INTEGER_32^.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, LCP^INTEGER_32^); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.LCP^INTEGER_32^.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.LCP^INTEGER_32^.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.LCP^INTEGER_32^.in_observers(Heap, Current, new_observers, o), readable);



function fun.LCP^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.LCP^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o) } { trigger.fun.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o) } (pre.fun.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o)) ==> ((fun.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o) } (fun.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o)) == (fun0.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.LCP^INTEGER_32^.in_observers(h, current, new_observers, o), fun0.LCP^INTEGER_32^.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.LCP^INTEGER_32^.in_observers(h, current, new_observers, o)) && (pre.fun.LCP^INTEGER_32^.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.LCP^INTEGER_32^.in_observers(h, current, new_observers, o)))) ==> ((fun0.LCP^INTEGER_32^.in_observers(h, current, new_observers, o)) == (fun0.LCP^INTEGER_32^.in_observers(h', current, new_observers, o)))));

function modify.SIMPLE_ARRAY^INTEGER_32^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T35> $o: ref, $f: Field T35 :: { modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T36> $o: ref, $f: Field T36 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T37> $o: ref, $f: Field T37 :: { modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T38> $o: ref, $f: Field T38 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T39> $o: ref, $f: Field T39 :: { modify.SIMPLE_ARRAY^ANY^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_ARRAY^ANY^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^ANY^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T40> $o: ref, $f: Field T40 :: { read.fun.SIMPLE_ARRAY^ANY^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_ARRAY^ANY^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
function modify.LCP^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T41> $o: ref, $f: Field T41 :: { modify.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.LCP^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T42> $o: ref, $f: Field T42 :: { read.fun.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.LCP^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.LCP^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.LCP^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T43> $o: ref, $f: Field T43 :: { modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T44> $o: ref, $f: Field T44 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T45> $o: ref, $f: Field T45 :: { modify.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T46> $o: ref, $f: Field T46 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
