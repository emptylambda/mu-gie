// Automatically generated (12/12/2017 1:55:23.759 PM)
...
const unique OBSERVER: Type;

axiom ((OBSERVER) <: (ANY));

axiom ((forall t: Type :: { (OBSERVER) <: (t) } ((OBSERVER) <: (t)) <==> (((t) == (OBSERVER)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, OBSERVER)) == (-1));

axiom ((FieldId(closed, OBSERVER)) == (-2));

axiom ((FieldId(owner, OBSERVER)) == (-3));

axiom ((FieldId(owns, OBSERVER)) == (-4));

axiom ((FieldId(observers, OBSERVER)) == (-5));

axiom ((FieldId(subjects, OBSERVER)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, OBSERVER) } (IsModelField($f, OBSERVER)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } OBSERVER.user_inv(heap: HeapType, current: ref) returns (bool) {
  ((heap[current, OBSERVER.subject]) != (Void)) && (Set#Equal(heap[current, subjects], Set#Singleton(heap[current, OBSERVER.subject]))) && (heap[heap[current, OBSERVER.subject], observers][current]) && ((heap[current, OBSERVER.cache]) == (heap[heap[current, OBSERVER.subject], SUBJECT.value])) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

function OBSERVER.subjects.static(heap: HeapType, current: ref) returns (Set (ref)) {
  Set#Singleton(heap[current, OBSERVER.subject])
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, OBSERVER)) ==> ((user_inv(heap, current)) <==> (OBSERVER.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, OBSERVER)) ==> ((user_inv(heap, current)) ==> (OBSERVER.user_inv(heap, current)))));

procedure OBSERVER.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, OBSERVER);



implementation OBSERVER.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, OBSERVER.subject]; // type:access tag:attribute_readable line:51 cid:406 fid:81
  assume (Heap[Current, OBSERVER.subject]) != (Void);
  assert user_inv_readable(Heap, Current)[Current, OBSERVER.subject]; // type:access tag:attribute_readable line:52 cid:406 fid:81
  assume Set#Equal(Heap[Current, subjects], Set#Singleton(Heap[Current, OBSERVER.subject]));
  assert user_inv_readable(Heap, Current)[Current, OBSERVER.subject]; // type:access tag:attribute_readable line:53 cid:406 fid:81
  assert {:subsumption 0} (Heap[Current, OBSERVER.subject]) != (Void); // type:attached tag:subject_aware line:53
  assume Heap[Heap[Current, OBSERVER.subject], observers][Current];
  assert user_inv_readable(Heap, Current)[Current, OBSERVER.cache]; // type:access tag:attribute_readable line:54 cid:406 fid:82
  assert user_inv_readable(Heap, Current)[Current, OBSERVER.subject]; // type:access tag:attribute_readable line:54 cid:406 fid:81
  assert {:subsumption 0} (Heap[Current, OBSERVER.subject]) != (Void); // type:attached tag:cache_synchronized line:54
  assert user_inv_readable(Heap, Current)[Heap[Current, OBSERVER.subject], SUBJECT.value]; // type:access tag:attribute_readable line:54 cid:404 fid:81
  assume (Heap[Current, OBSERVER.cache]) == (Heap[Heap[Current, OBSERVER.subject], SUBJECT.value]);
  return;
  a2:
...
procedure create.OBSERVER.make(Current: ref, s: ref);
  free requires attached_exact(Heap, Current, OBSERVER); // info:type property for argument Current
  free requires detachable(Heap, s, SUBJECT); // info:type property for argument s
  modifies Heap;
  requires (s) != (Void); // type:pre tag:s_exists line:17
  ensures (Heap[Current, OBSERVER.subject]) == (s); // type:post tag:subject_set line:24
  ensures (s) != (Void); // type:attached tag:observeing_subject line:25
  ensures Set#Equal(Heap[s, observers], Set#Extended(old(Heap)[s, observers], Current)); // type:post tag:observeing_subject line:25
  ...
  requires Frame#Subset(modify.OBSERVER.make(Heap, Current, s), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.OBSERVER.make(old(Heap), Current, s));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
  requires is_wrapped(Heap, s); // type:pre tag:arg_s_is_wrapped default:contracts
  ensures is_wrapped(Heap, s); // type:post tag:arg_s_is_wrapped default:contracts



implementation create.OBSERVER.make(Current: ref, s: ref)
{
  entry:
  assume {:captureState "create.OBSERVER.make"} true;
  // /home/caf/temp/comcom/repo-observer/observer.e:20
  // subject := s
  call update_heap(Current, OBSERVER.subject, s); // line:20
  // /home/caf/temp/comcom/repo-observer/observer.e:21
  // s.register (Current)
  assert {:subsumption 0} (s) != (Void); // type:attached line:21
  call SUBJECT.register(s, Current); // line:21 cid:404 rid:5410
  // /home/caf/temp/comcom/repo-observer/observer.e:22
  // cache := s.value
  assert {:subsumption 0} (s) != (Void); // type:attached line:22
  call update_heap(Current, OBSERVER.cache, Heap[s, SUBJECT.value]); // line:22
  if (modify.OBSERVER.make(Heap, Current, s)[Current, subjects]) {
    call update_heap(Current, subjects, OBSERVER.subjects.static(Heap, Current)); // default:subjects line:26
  }
  if (*) {
    assert (Heap[Current, OBSERVER.subject]) != (Void); // type:inv tag:subject_exists line:26 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#Equal(Heap[Current, subjects], Set#Singleton(Heap[Current, OBSERVER.subject])); // type:inv tag:subjects_structure line:26 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Heap[Heap[Current, OBSERVER.subject], observers][Current]; // type:inv tag:subject_aware line:26 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert (Heap[Current, OBSERVER.cache]) == (Heap[Heap[Current, OBSERVER.subject], SUBJECT.value]); // type:inv tag:cache_synchronized line:26 cid:1 rid:55
    assume false;
  }
  if (*) {
...
procedure OBSERVER.notify(Current: ref);
  free requires attached_exact(Heap, Current, OBSERVER); // info:type property for argument Current
  modifies Heap;
  requires is_open(Heap, Current); // type:pre tag:open line:41
  requires OBSERVER#E#cache_synchronized.filtered_inv(Heap, Current); // type:pre tag:partially_holds line:42
  ensures user_inv(Heap, Current); // type:post tag:invariant_holds line:47
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.OBSERVER.notify(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.OBSERVER.notify(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);



function { :inline } variant.OBSERVER.notify.1(heap: HeapType, current: ref) returns (int) {
  0
}

implementation OBSERVER.notify(Current: ref)
{
  entry:
  assume {:captureState "OBSERVER.notify"} true;
  // /home/caf/temp/comcom/repo-observer/observer.e:45
  // cache := subject.value
  assert {:subsumption 0} (Heap[Current, OBSERVER.subject]) != (Void); // type:attached line:45
  call update_heap(Current, OBSERVER.cache, Heap[Heap[Current, OBSERVER.subject], SUBJECT.value]); // line:45
}
...
procedure create.CLIENT.test(Current: ref);
...
implementation create.CLIENT.test(Current: ref)
{
  var temp_1: ref;
  var temp_2: ref;
  var temp_3: ref;
  var local1: ref where detachable(Heap, local1, SUBJECT);
  var local2: ref where detachable(Heap, local2, OBSERVER);
  var local3: ref where detachable(Heap, local3, OBSERVER);
  ...
  entry:
  assume {:captureState "create.CLIENT.test"} true;
  // /home/caf/temp/comcom/repo-observer/client.e:20
  // create s.make (1)
  call temp_1 := allocate(SUBJECT); // line:-1
  call create.SUBJECT.make(temp_1, 1); // line:20 cid:404 rid:5406
  local1 := temp_1;
  // /home/caf/temp/comcom/repo-observer/client.e:21
  // create o1.make (s)
  call temp_2 := allocate(OBSERVER); // line:-1
  call create.OBSERVER.make(temp_2, local1); // line:21 cid:406 rid:5401
  local2 := temp_2;
  // /home/caf/temp/comcom/repo-observer/client.e:22
  // create o2.make (s)
  call temp_3 := allocate(OBSERVER); // line:-1
  call create.OBSERVER.make(temp_3, local1); // line:22 cid:406 rid:5401
  local3 := temp_3;
  // /home/caf/temp/comcom/repo-observer/client.e:24
  // s.update (5)
  assert {:subsumption 0} (local1) != (Void); // type:attached line:24
  call SUBJECT.update(local1, 5); // line:24 cid:404 rid:5409
  // /home/caf/temp/comcom/repo-observer/client.e:26
  // check o1_synch: o1.cache = 5 end
  assert {:subsumption 0} (local2) != (Void); // type:attached line:26
  assert (Heap[local2, OBSERVER.cache]) == (5); // type:check tag:o1_synch line:26
  // /home/caf/temp/comcom/repo-observer/client.e:27
  // check o2_synch: o2.cache = 5 end
  assert {:subsumption 0} (local3) != (Void); // type:attached line:27
  assert (Heap[local3, OBSERVER.cache]) == (5); // type:check tag:o2_synch line:27
  if (*) {
    assert Set#IsEmpty(Heap[Current, observers]); // type:inv tag:default_observers line:28 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, subjects]); // type:inv tag:default_subjects line:28 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, owns]); // type:inv tag:default_owns line:28 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert admissibility2(Heap, Current); // type:inv tag:A2 line:28 cid:1 rid:55
    assume false;
  }
  call wrap(Current); // default:wrapping cid:1 rid:55 line:28
}

const unique SUBJECT: Type;

axiom ((SUBJECT) <: (ANY));

axiom ((forall t: Type :: { (SUBJECT) <: (t) } ((SUBJECT) <: (t)) <==> (((t) == (SUBJECT)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, SUBJECT)) == (-1));

axiom ((FieldId(closed, SUBJECT)) == (-2));

axiom ((FieldId(owner, SUBJECT)) == (-3));

axiom ((FieldId(owns, SUBJECT)) == (-4));

axiom ((FieldId(observers, SUBJECT)) == (-5));

axiom ((FieldId(subjects, SUBJECT)) == (-6));

axiom ((forall <T6> $f: Field T6 :: { IsModelField($f, SUBJECT) } (IsModelField($f, SUBJECT)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } SUBJECT.user_inv(heap: HeapType, current: ref) returns (bool) {
  ((heap[current, SUBJECT.subscribers]) != (Void)) && (Set#Equal(heap[current, owns], Set#Singleton(heap[current, SUBJECT.subscribers]))) && (Seq#NonNull(heap[heap[current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence])) && (Set#Equal(heap[current, observers], Seq#Range(heap[heap[current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence]))) && (Set#IsEmpty(heap[current, subjects])) && (admissibility2(heap, current))
}

function SUBJECT.observers.static(heap: HeapType, current: ref) returns (Set (ref)) {
  Seq#Range(heap[heap[current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence])
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, SUBJECT)) ==> ((user_inv(heap, current)) <==> (SUBJECT.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, SUBJECT)) ==> ((user_inv(heap, current)) ==> (SUBJECT.user_inv(heap, current)))));

procedure SUBJECT.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, SUBJECT);



implementation SUBJECT.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
  assert user_inv_readable(Heap, Current)[Current, SUBJECT.subscribers]; // type:access tag:attribute_readable line:82 cid:404 fid:82
  assume (Heap[Current, SUBJECT.subscribers]) != (Void);
  assert user_inv_readable(Heap, Current)[Current, SUBJECT.subscribers]; // type:access tag:attribute_readable line:83 cid:404 fid:82
  assume Set#Equal(Heap[Current, owns], Set#Singleton(Heap[Current, SUBJECT.subscribers]));
  assert user_inv_readable(Heap, Current)[Current, SUBJECT.subscribers]; // type:access tag:attribute_readable line:84 cid:404 fid:82
  assert {:subsumption 0} (Heap[Current, SUBJECT.subscribers]) != (Void); // type:attached tag:all_subscribers_exist line:84
  assert user_inv_readable(Heap, Current)[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence]; // type:access tag:attribute_readable line:84 cid:331 fid:81
  assume Seq#NonNull(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence]);
  assert user_inv_readable(Heap, Current)[Current, SUBJECT.subscribers]; // type:access tag:attribute_readable line:85 cid:404 fid:82
  assert {:subsumption 0} (Heap[Current, SUBJECT.subscribers]) != (Void); // type:attached tag:observers_structure line:85
  assert user_inv_readable(Heap, Current)[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence]; // type:access tag:attribute_readable line:85 cid:331 fid:81
  assume Set#Equal(Heap[Current, observers], Seq#Range(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence]));
  return;
  a2:
  assume user_inv(Heap, Current);
  assert admissibility2(Heap, Current); // type:A2
...
procedure create.SUBJECT.make(Current: ref, v: int);
  free requires attached_exact(Heap, Current, SUBJECT); // info:type property for argument Current
  free requires is_integer_32(v); // info:type property for argument v
  modifies Heap;
  ensures (Heap[Current, SUBJECT.value]) == (v); // type:post tag:value_set line:21
  ensures (Heap[Current, SUBJECT.subscribers]) != (Void); // type:attached tag:no_subscribers line:22
  ensures pre.fun.SIMPLE_LIST^OBSERVER^.is_empty(Heap, Heap[Current, SUBJECT.subscribers]); // type:check tag:function_precondition line:22 cid:331 rid:3196
  ensures fun.SIMPLE_LIST^OBSERVER^.is_empty(Heap, Heap[Current, SUBJECT.subscribers]); // type:post tag:no_subscribers line:22
  requires (forall <T7> $f: Field T7 :: (($f) != (allocated)) ==> ((Heap[Current, $f]) == (Default($f))));
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUBJECT.make(Heap, Current, v), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUBJECT.make(old(Heap), Current, v));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.SUBJECT.make(Current: ref, v: int)
{
  var temp_4: ref;
  ...
  entry:
  assume {:captureState "create.SUBJECT.make"} true;
  // /home/caf/temp/comcom/repo-observer/subject.e:17
  // value := v
  call update_heap(Current, SUBJECT.value, v); // line:17
  // /home/caf/temp/comcom/repo-observer/subject.e:18
  // create subscribers.make
  call temp_4 := allocate(SIMPLE_LIST^OBSERVER^); // line:-1
  call create.SIMPLE_LIST^OBSERVER^.make(temp_4); // line:18 cid:331 rid:3194
  call update_heap(Current, SUBJECT.subscribers, temp_4); // line:18
  // /home/caf/temp/comcom/repo-observer/subject.e:19
  // set_owns ([subscribers])
  call update_heap(Current, owns, Set#Singleton(Heap[Current, SUBJECT.subscribers])); // line:19
  if (modify.SUBJECT.make(Heap, Current, v)[Current, observers]) {
    call update_heap(Current, observers, SUBJECT.observers.static(Heap, Current)); // default:observers line:23
  }
  if (*) {
    assert (Heap[Current, SUBJECT.subscribers]) != (Void); // type:inv tag:subscribers_exists line:63 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#Equal(Heap[Current, owns], Set#Singleton(Heap[Current, SUBJECT.subscribers])); // type:inv tag:owns_structure line:63 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Seq#NonNull(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence]); // type:inv tag:all_subscribers_exist line:63 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#Equal(Heap[Current, observers], Seq#Range(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence])); // type:inv tag:observers_structure line:63 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, subjects]); // type:inv tag:default_subjects line:63 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert admissibility2(Heap, Current); // type:inv tag:A2 line:63 cid:1 rid:55
    assume false;
  }
  call wrap(Current); // default:wrapping cid:1 rid:55 line:23
}

procedure SUBJECT.update(Current: ref, v: int);
  free requires attached_exact(Heap, Current, SUBJECT); // info:type property for argument Current
  free requires is_integer_32(v); // info:type property for argument v
  modifies Heap;
  requires (forall i_5: ref :: (Heap[Current, observers][i_5]) ==> (is_wrapped(Heap, i_5))); // type:pre tag:observers_wrapped line:38
  ensures (forall i_6: ref :: (Heap[Current, observers][i_6]) ==> (is_wrapped(Heap, i_6))); // type:post tag:observers_wrapped line:61
  ensures (Heap[Current, SUBJECT.value]) == (v); // type:post tag:value_set line:62
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUBJECT.update(Heap, Current, v), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUBJECT.update(old(Heap), Current, v));
  free ensures HeapSucc(old(Heap), Heap);
...
function { :inline } variant.SUBJECT.update.1(heap: HeapType, current: ref, v: int) returns (int) {
  v
}

implementation SUBJECT.update(Current: ref, v: int)
{
  var PreLoopHeap_10: HeapType;
  var LoopFrame_11: Frame;
  var LoopWritable_12: Frame;
  var variant_14: int;
  var temp_15: ref;
  ...
  entry:
  assume {:captureState "SUBJECT.update"} true;
  call unwrap(Current); // default:wrapping cid:1 rid:57 line:35
  assume SUBJECT.user_inv(Heap, Current);
  // /home/caf/temp/comcom/repo-observer/subject.e:44
  // unwrap_all (observers)
  call unwrap_all(Current, Heap[Current, observers]); // line:44 cid:1 rid:59
  // /home/caf/temp/comcom/repo-observer/subject.e:45
  // value := v
  call update_heap(Current, SUBJECT.value, v); // line:45
  // /home/caf/temp/comcom/repo-observer/subject.e:48
  // i := 1
  local1 := 1;
  PreLoopHeap_10 := Heap;
  havoc LoopFrame_11;
  assert {:subsumption 0} (Heap[Current, SUBJECT.subscribers]) != (Void); // type:attached line:0
  assume (forall <T8> $o: ref, $f: Field T8 :: { LoopFrame_11[$o, $f] } (LoopFrame_11[$o, $f]) <==> ((Seq#Range(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence])[$o]) && (($f) == (OBSERVER.cache))));
  assert {:subsumption 0} Frame#Subset(LoopFrame_11, writable); // type:check tag:frame_writable line:51
  havoc LoopWritable_12;
  assume Frame#Subset(LoopFrame_11, LoopWritable_12);
  assume closed_under_domains(LoopWritable_12, Heap);
  goto loop_head_7;
  loop_head_7:
  // /home/caf/temp/comcom/repo-observer/subject.e:50
  // across 1 |..| (i - 1) as j all subscribers.sequence [j.item].inv end
  assert {:subsumption 0} (Heap[Current, SUBJECT.subscribers]) != (Void); // type:attached line:50
  assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= ((local1) - (1)))) ==> (pre.fun.MML_SEQUENCE^OBSERVER^.item(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence], i_13))); // type:check tag:function_precondition line:50 cid:125 rid:3286
  assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= ((local1) - (1)))) ==> ((Seq#Item(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence], i_13)) != (Void))); // type:attached line:50
  assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= ((local1) - (1)))) ==> (user_inv(Heap, Seq#Item(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence], i_13)))); // type:loop_inv line:50
  assume HeapSucc(PreLoopHeap_10, Heap);
  assume same_outside(PreLoopHeap_10, Heap, LoopFrame_11);
  assume global(Heap);
  // /home/caf/temp/comcom/repo-observer/subject.e:-1
  assert {:subsumption 0} (Heap[Current, SUBJECT.subscribers]) != (Void); // type:attached line:-1
  assert pre.fun.SIMPLE_LIST^OBSERVER^.count(Heap, Heap[Current, SUBJECT.subscribers]); // type:check tag:function_precondition line:-1 cid:331 rid:3197
  goto loop_body_8, loop_end_9;
  loop_body_8:
  assume !((local1) > (fun.SIMPLE_LIST^OBSERVER^.count(Heap, Heap[Current, SUBJECT.subscribers])));
  variant_14 := (fun.SIMPLE_LIST^OBSERVER^.count(Heap, Heap[Current, SUBJECT.subscribers])) - (local1);
  // /home/caf/temp/comcom/repo-observer/subject.e:55
  // subscribers [i].notify
  assert {:subsumption 0} (Heap[Current, SUBJECT.subscribers]) != (Void); // type:attached line:55
  assert {:subsumption 0} Frame#Subset(modify.SIMPLE_LIST^OBSERVER^.item(Heap, Heap[Current, SUBJECT.subscribers], local1), LoopWritable_12); // type:check tag:frame_writable line:55
  call temp_15 := SIMPLE_LIST^OBSERVER^.item(Heap[Current, SUBJECT.subscribers], local1); // line:55 cid:331 rid:3198
  assert {:subsumption 0} (temp_15) != (Void); // type:attached line:55
  assert {:subsumption 0} Frame#Subset(modify.OBSERVER.notify(Heap, temp_15), LoopWritable_12); // type:check tag:frame_writable line:55
  call OBSERVER.notify(temp_15); // line:55 cid:406 rid:5404
  // /home/caf/temp/comcom/repo-observer/subject.e:56
  // i := i + 1
  local1 := (local1) + (1);
  // /home/caf/temp/comcom/repo-observer/subject.e:55
  // subscribers [i].notify
  assert {:subsumption 0} ((((fun.SIMPLE_LIST^OBSERVER^.count(Heap, Heap[Current, SUBJECT.subscribers])) - (local1)) <= (variant_14)) && ((variant_14) <= ((fun.SIMPLE_LIST^OBSERVER^.count(Heap, Heap[Current, SUBJECT.subscribers])) - (local1)))) || ((0) <= (variant_14)); // type:termination tag:bounded line:55 varid:1
  assert {:subsumption 0} (((fun.SIMPLE_LIST^OBSERVER^.count(Heap, Heap[Current, SUBJECT.subscribers])) - (local1)) <= (variant_14)) && (!((variant_14) <= ((fun.SIMPLE_LIST^OBSERVER^.count(Heap, Heap[Current, SUBJECT.subscribers])) - (local1)))); // type:termination tag:variant_decreases line:55
  goto loop_head_7;
  loop_end_9:
  assume (local1) > (fun.SIMPLE_LIST^OBSERVER^.count(Heap, Heap[Current, SUBJECT.subscribers]));
  // /home/caf/temp/comcom/repo-observer/subject.e:59
  // wrap_all (observers)
  call wrap_all(Current, Heap[Current, observers]); // line:59 cid:1 rid:56
  if (modify.SUBJECT.update(Heap, Current, v)[Current, observers]) {
    call update_heap(Current, observers, SUBJECT.observers.static(Heap, Current)); // default:observers line:63
  }
  if (*) {
    assert (Heap[Current, SUBJECT.subscribers]) != (Void); // type:inv tag:subscribers_exists line:63 cid:1 rid:55
    assume false;
...
procedure SUBJECT.register(Current: ref, o: ref);
  free requires attached_exact(Heap, Current, SUBJECT); // info:type property for argument Current
  free requires detachable(Heap, o, OBSERVER); // info:type property for argument o
  modifies Heap;
  requires is_wrapped(Heap, Current); // type:pre tag:wrapped line:70
  requires (o) != (Void); // type:attached tag:o_open line:71
  requires is_open(Heap, o); // type:pre tag:o_open line:71
  ensures Set#Equal(Heap[Current, observers], Set#Extended(old(Heap)[Current, observers], o)); // type:post tag:observers_extended line:77
  ensures is_wrapped(Heap, Current); // type:post tag:wrapped line:78
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUBJECT.register(Heap, Current, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUBJECT.register(old(Heap), Current, o));
  free ensures HeapSucc(old(Heap), Heap);



function { :inline } variant.SUBJECT.register.1(heap: HeapType, current: ref, o: ref) returns (ref) {
  o
}

implementation SUBJECT.register(Current: ref, o: ref)
{
  entry:
  assume {:captureState "SUBJECT.register"} true;
  // /home/caf/temp/comcom/repo-observer/subject.e:73
  // unwrap
  call unwrap(Current); // line:73 cid:1 rid:57
  assume SUBJECT.user_inv(Heap, Current);
  // /home/caf/temp/comcom/repo-observer/subject.e:74
  // subscribers.extend_back (o)
  assert {:subsumption 0} (Heap[Current, SUBJECT.subscribers]) != (Void); // type:attached line:74
  call SIMPLE_LIST^OBSERVER^.extend_back(Heap[Current, SUBJECT.subscribers], o); // line:74 cid:331 rid:3201
  // /home/caf/temp/comcom/repo-observer/subject.e:75
  // wrap
  if (modify.SUBJECT.register(Heap, Current, o)[Current, observers]) {
    call update_heap(Current, observers, SUBJECT.observers.static(Heap, Current)); // default:observers line:75
  }
  if (*) {
    assert (Heap[Current, SUBJECT.subscribers]) != (Void); // type:inv tag:subscribers_exists line:75 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#Equal(Heap[Current, owns], Set#Singleton(Heap[Current, SUBJECT.subscribers])); // type:inv tag:owns_structure line:75 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Seq#NonNull(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence]); // type:inv tag:all_subscribers_exist line:75 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#Equal(Heap[Current, observers], Seq#Range(Heap[Heap[Current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence])); // type:inv tag:observers_structure line:75 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert Set#IsEmpty(Heap[Current, subjects]); // type:inv tag:default_subjects line:75 cid:1 rid:55
    assume false;
  }
  if (*) {
    assert admissibility2(Heap, Current); // type:inv tag:A2 line:75 cid:1 rid:55
    assume false;
  }
  call wrap(Current); // line:75 cid:1 rid:55
}

const OBSERVER.subject: Field (ref);

axiom ((FieldId(OBSERVER.subject, OBSERVER)) == (81));

axiom ((forall heap: HeapType, o: ref :: { heap[o, OBSERVER.subject] } ((IsHeap(heap)) && (attached(heap, o, OBSERVER))) ==> (detachable(heap, heap[o, OBSERVER.subject], SUBJECT))));

axiom ((forall heap: HeapType, current: ref, v: ref, o: ref :: { guard(heap, current, OBSERVER.subject, v, o) } (attached_exact(heap, current, OBSERVER)) ==> ((guard(heap, current, OBSERVER.subject, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, OBSERVER.subject := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: ref, o: ref :: { guard(heap, current, OBSERVER.subject, v, o) } (attached(heap, current, OBSERVER)) ==> ((guard(heap, current, OBSERVER.subject, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, OBSERVER.subject := v], o))))));

const OBSERVER.cache: Field int;

axiom ((FieldId(OBSERVER.cache, OBSERVER)) == (82));

axiom ((forall heap: HeapType, o: ref :: { heap[o, OBSERVER.cache] } ((IsHeap(heap)) && (attached(heap, o, OBSERVER))) ==> (is_integer_32(heap[o, OBSERVER.cache]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, OBSERVER.cache, v, o) } (attached_exact(heap, current, OBSERVER)) ==> ((guard(heap, current, OBSERVER.cache, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, OBSERVER.cache := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, OBSERVER.cache, v, o) } (attached(heap, current, OBSERVER)) ==> ((guard(heap, current, OBSERVER.cache, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, OBSERVER.cache := v], o))))));

const SUBJECT.value: Field int;

axiom ((FieldId(SUBJECT.value, SUBJECT)) == (81));

axiom ((forall heap: HeapType, o: ref :: { heap[o, SUBJECT.value] } ((IsHeap(heap)) && (attached(heap, o, SUBJECT))) ==> (is_integer_32(heap[o, SUBJECT.value]))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, SUBJECT.value, v, o) } (attached_exact(heap, current, SUBJECT)) ==> ((guard(heap, current, SUBJECT.value, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, SUBJECT.value := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: int, o: ref :: { guard(heap, current, SUBJECT.value, v, o) } (attached(heap, current, SUBJECT)) ==> ((guard(heap, current, SUBJECT.value, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, SUBJECT.value := v], o))))));
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, OBSERVER)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, OBSERVER)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, OBSERVER)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.OBSERVER.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, OBSERVER)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.OBSERVER.in_observers(heap, current, v, o)))));

function modify.OBSERVER.make(heap: HeapType, current: ref, s: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, s: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { modify.OBSERVER.make(heap, current, s)[$o, $f] } (modify.OBSERVER.make(heap, current, s)[$o, $f]) <==> ((($o) == (s)) || (($o) == (current)))))));

function OBSERVER#E#cache_synchronized.filtered_inv(heap: HeapType, current: ref) returns (bool) {
  ((heap[current, OBSERVER.subject]) != (Void)) && (Set#Equal(heap[current, subjects], Set#Singleton(heap[current, OBSERVER.subject]))) && (heap[heap[current, OBSERVER.subject], observers][current]) && (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall h: HeapType, o: ref :: { OBSERVER#E#cache_synchronized.filtered_inv(h, o) } ((IsHeap(h)) && (attached(h, o, OBSERVER)) && (h[o, closed])) ==> (OBSERVER#E#cache_synchronized.filtered_inv(h, o))));

function modify.OBSERVER.notify(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { modify.OBSERVER.notify(heap, current)[$o, $f] } (modify.OBSERVER.notify(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) == (OBSERVER.cache)))))));
...
axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.CLIENT.test(heap, current)[$o, $f] } (modify.CLIENT.test(heap, current)[$o, $f]) <==> (($o) == (current))))));

const SUBJECT.subscribers: Field (ref);

axiom ((FieldId(SUBJECT.subscribers, SUBJECT)) == (82));

axiom ((forall heap: HeapType, o: ref :: { heap[o, SUBJECT.subscribers] } ((IsHeap(heap)) && (attached(heap, o, SUBJECT))) ==> (detachable_exact(heap, heap[o, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^))));

axiom ((forall heap: HeapType, current: ref, v: ref, o: ref :: { guard(heap, current, SUBJECT.subscribers, v, o) } (attached_exact(heap, current, SUBJECT)) ==> ((guard(heap, current, SUBJECT.subscribers, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, SUBJECT.subscribers := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: ref, o: ref :: { guard(heap, current, SUBJECT.subscribers, v, o) } (attached(heap, current, SUBJECT)) ==> ((guard(heap, current, SUBJECT.subscribers, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, SUBJECT.subscribers := v], o))))));

const SIMPLE_LIST^OBSERVER^.sequence: Field (Seq (ref));

axiom ((FieldId(SIMPLE_LIST^OBSERVER^.sequence, SIMPLE_LIST^OBSERVER^)) == (81));

axiom ((forall heap: HeapType, o: ref :: { heap[o, SIMPLE_LIST^OBSERVER^.sequence] } ((IsHeap(heap)) && (attached(heap, o, SIMPLE_LIST^OBSERVER^))) ==> (Seq#ItemsType(heap, heap[o, SIMPLE_LIST^OBSERVER^.sequence], OBSERVER))));

axiom ((forall heap: HeapType, current: ref, v: Seq (ref), o: ref :: { guard(heap, current, SIMPLE_LIST^OBSERVER^.sequence, v, o) } (attached_exact(heap, current, SIMPLE_LIST^OBSERVER^)) ==> ((guard(heap, current, SIMPLE_LIST^OBSERVER^.sequence, v, o)) <==> ((user_inv(heap, o)) ==> (user_inv(heap[current, SIMPLE_LIST^OBSERVER^.sequence := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: Seq (ref), o: ref :: { guard(heap, current, SIMPLE_LIST^OBSERVER^.sequence, v, o) } (attached(heap, current, SIMPLE_LIST^OBSERVER^)) ==> ((guard(heap, current, SIMPLE_LIST^OBSERVER^.sequence, v, o)) ==> ((user_inv(heap, o)) ==> (user_inv(heap[current, SIMPLE_LIST^OBSERVER^.sequence := v], o))))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, SUBJECT)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, SUBJECT)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, SUBJECT)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.SUBJECT.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, SUBJECT)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.SUBJECT.in_observers(heap, current, v, o)))));

procedure SIMPLE_LIST^OBSERVER^.is_empty(Current: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SIMPLE_LIST^OBSERVER^); // info:type property for argument Current
  modifies Heap;
  ensures (Result) == (Seq#IsEmpty(Heap[Current, SIMPLE_LIST^OBSERVER^.sequence])); // type:post tag:definition line:45
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_LIST^OBSERVER^.is_empty(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_LIST^OBSERVER^.is_empty(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SIMPLE_LIST^OBSERVER^.is_empty(Heap, Current), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.SIMPLE_LIST^OBSERVER^.is_empty(old(Heap), Current));



function fun.SIMPLE_LIST^OBSERVER^.is_empty(heap: HeapType, current: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref :: { fun.SIMPLE_LIST^OBSERVER^.is_empty(heap, current) } (pre.fun.SIMPLE_LIST^OBSERVER^.is_empty(heap, current)) ==> ((fun.SIMPLE_LIST^OBSERVER^.is_empty(heap, current)) == (Seq#IsEmpty(heap[current, SIMPLE_LIST^OBSERVER^.sequence])))));

axiom ((forall h: HeapType, h': HeapType, current: ref :: { HeapSucc(h, h'), fun.SIMPLE_LIST^OBSERVER^.is_empty(h, current), fun.SIMPLE_LIST^OBSERVER^.is_empty(h', current) } ((HeapSucc(h, h')) && (pre.fun.SIMPLE_LIST^OBSERVER^.is_empty(h, current)) && (pre.fun.SIMPLE_LIST^OBSERVER^.is_empty(h', current)) && (same_inside(h, h', read.fun.SIMPLE_LIST^OBSERVER^.is_empty(h, current)))) ==> ((fun.SIMPLE_LIST^OBSERVER^.is_empty(h, current)) == (fun.SIMPLE_LIST^OBSERVER^.is_empty(h', current)))));

function modify.SUBJECT.make(heap: HeapType, current: ref, v: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, v: int :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { modify.SUBJECT.make(heap, current, v)[$o, $f] } (modify.SUBJECT.make(heap, current, v)[$o, $f]) <==> (($o) == (current))))));

const unique SIMPLE_LIST^OBSERVER^: Type;

axiom (is_frozen(SIMPLE_LIST^OBSERVER^));

axiom ((SIMPLE_LIST^OBSERVER^) <: (ITERABLE^OBSERVER^));

axiom ((forall t: Type :: { (SIMPLE_LIST^OBSERVER^) <: (t) } ((SIMPLE_LIST^OBSERVER^) <: (t)) <==> (((t) == (SIMPLE_LIST^OBSERVER^)) || ((ITERABLE^OBSERVER^) <: (t)))));

axiom ((FieldId(allocated, SIMPLE_LIST^OBSERVER^)) == (-1));

axiom ((FieldId(closed, SIMPLE_LIST^OBSERVER^)) == (-2));

axiom ((FieldId(owner, SIMPLE_LIST^OBSERVER^)) == (-3));

axiom ((FieldId(owns, SIMPLE_LIST^OBSERVER^)) == (-4));

axiom ((FieldId(observers, SIMPLE_LIST^OBSERVER^)) == (-5));

axiom ((FieldId(subjects, SIMPLE_LIST^OBSERVER^)) == (-6));

axiom ((forall <T13> $f: Field T13 :: { IsModelField($f, SIMPLE_LIST^OBSERVER^) } (IsModelField($f, SIMPLE_LIST^OBSERVER^)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } SIMPLE_LIST^OBSERVER^.user_inv(heap: HeapType, current: ref) returns (bool) {
  (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns])) && (admissibility2(heap, current))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, SIMPLE_LIST^OBSERVER^)) ==> ((user_inv(heap, current)) <==> (SIMPLE_LIST^OBSERVER^.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, SIMPLE_LIST^OBSERVER^)) ==> ((user_inv(heap, current)) ==> (SIMPLE_LIST^OBSERVER^.user_inv(heap, current)))));

procedure create.SIMPLE_LIST^OBSERVER^.make(Current: ref);
  free requires attached_exact(Heap, Current, SIMPLE_LIST^OBSERVER^); // info:type property for argument Current
  modifies Heap;
  ensures pre.fun.SIMPLE_LIST^OBSERVER^.is_empty(Heap, Current); // type:check tag:function_precondition line:24 cid:331 rid:3196
  ensures fun.SIMPLE_LIST^OBSERVER^.is_empty(Heap, Current); // type:post tag:empty line:24
  requires (forall <T14> $f: Field T14 :: (($f) != (allocated)) ==> ((Heap[Current, $f]) == (Default($f))));
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_LIST^OBSERVER^.make(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_LIST^OBSERVER^.make(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



function modify.SUBJECT.update(heap: HeapType, current: ref, v: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, v: int :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { modify.SUBJECT.update(heap, current, v)[$o, $f] } (modify.SUBJECT.update(heap, current, v)[$o, $f]) <==> (((($o) == (current)) && ((($f) == (SUBJECT.value)) || (($f) == (closed)))) || ((Seq#Range(heap[heap[current, SUBJECT.subscribers], SIMPLE_LIST^OBSERVER^.sequence])[$o]) && ((($f) == (OBSERVER.cache)) || (($f) == (closed)))))))));

procedure SIMPLE_LIST^OBSERVER^.count(Current: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, SIMPLE_LIST^OBSERVER^); // info:type property for argument Current
  modifies Heap;
  ensures (Result) == (Seq#Length(Heap[Current, SIMPLE_LIST^OBSERVER^.sequence])); // type:post tag:definition line:55
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_LIST^OBSERVER^.count(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_LIST^OBSERVER^.count(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SIMPLE_LIST^OBSERVER^.count(Heap, Current), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.SIMPLE_LIST^OBSERVER^.count(old(Heap), Current));



function fun.SIMPLE_LIST^OBSERVER^.count(heap: HeapType, current: ref) returns (int);

axiom ((forall heap: HeapType, current: ref :: { fun.SIMPLE_LIST^OBSERVER^.count(heap, current) } (pre.fun.SIMPLE_LIST^OBSERVER^.count(heap, current)) ==> (((fun.SIMPLE_LIST^OBSERVER^.count(heap, current)) == (Seq#Length(heap[current, SIMPLE_LIST^OBSERVER^.sequence]))) && (is_integer_32(fun.SIMPLE_LIST^OBSERVER^.count(heap, current))))));

axiom ((forall h: HeapType, h': HeapType, current: ref :: { HeapSucc(h, h'), fun.SIMPLE_LIST^OBSERVER^.count(h, current), fun.SIMPLE_LIST^OBSERVER^.count(h', current) } ((HeapSucc(h, h')) && (pre.fun.SIMPLE_LIST^OBSERVER^.count(h, current)) && (pre.fun.SIMPLE_LIST^OBSERVER^.count(h', current)) && (same_inside(h, h', read.fun.SIMPLE_LIST^OBSERVER^.count(h, current)))) ==> ((fun.SIMPLE_LIST^OBSERVER^.count(h, current)) == (fun.SIMPLE_LIST^OBSERVER^.count(h', current)))));

procedure SIMPLE_LIST^OBSERVER^.item(Current: ref, i: int) returns (Result: ref where detachable(Heap, Result, OBSERVER));
  free requires attached_exact(Heap, Current, SIMPLE_LIST^OBSERVER^); // info:type property for argument Current
  free requires is_integer_32(i); // info:type property for argument i
  modifies Heap;
  requires pre.fun.SIMPLE_LIST^OBSERVER^.count(Heap, Current); // type:check tag:function_precondition line:61 cid:331 rid:3197
  requires ((1) <= (i)) && ((i) <= (fun.SIMPLE_LIST^OBSERVER^.count(Heap, Current))); // type:pre tag:in_bounds line:61
  ensures pre.fun.MML_SEQUENCE^OBSERVER^.item(Heap[Current, SIMPLE_LIST^OBSERVER^.sequence], i); // type:check tag:function_precondition line:66 cid:125 rid:3286
  ensures (Result) == (Seq#Item(Heap[Current, SIMPLE_LIST^OBSERVER^.sequence], i)); // type:post tag:definition line:66
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_LIST^OBSERVER^.item(Heap, Current, i), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_LIST^OBSERVER^.item(old(Heap), Current, i));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SIMPLE_LIST^OBSERVER^.item(Heap, Current, i), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.SIMPLE_LIST^OBSERVER^.item(old(Heap), Current, i));



function fun.SIMPLE_LIST^OBSERVER^.item(heap: HeapType, current: ref, i: int) returns (ref);

axiom ((forall heap: HeapType, current: ref, i: int :: { fun.SIMPLE_LIST^OBSERVER^.item(heap, current, i) } (pre.fun.SIMPLE_LIST^OBSERVER^.item(heap, current, i)) ==> (((fun.SIMPLE_LIST^OBSERVER^.item(heap, current, i)) == (Seq#Item(heap[current, SIMPLE_LIST^OBSERVER^.sequence], i))) && (detachable(heap, fun.SIMPLE_LIST^OBSERVER^.item(heap, current, i), OBSERVER)))));

axiom ((forall h: HeapType, h': HeapType, current: ref, i: int :: { HeapSucc(h, h'), fun.SIMPLE_LIST^OBSERVER^.item(h, current, i), fun.SIMPLE_LIST^OBSERVER^.item(h', current, i) } ((HeapSucc(h, h')) && (pre.fun.SIMPLE_LIST^OBSERVER^.item(h, current, i)) && (pre.fun.SIMPLE_LIST^OBSERVER^.item(h', current, i)) && (same_inside(h, h', read.fun.SIMPLE_LIST^OBSERVER^.item(h, current, i)))) ==> ((fun.SIMPLE_LIST^OBSERVER^.item(h, current, i)) == (fun.SIMPLE_LIST^OBSERVER^.item(h', current, i)))));

function modify.SUBJECT.register(heap: HeapType, current: ref, o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, o: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { modify.SUBJECT.register(heap, current, o)[$o, $f] } (modify.SUBJECT.register(heap, current, o)[$o, $f]) <==> (($o) == (current))))));

procedure SIMPLE_LIST^OBSERVER^.extend_back(Current: ref, v: ref);
  free requires attached_exact(Heap, Current, SIMPLE_LIST^OBSERVER^); // info:type property for argument Current
  free requires detachable(Heap, v, OBSERVER); // info:type property for argument v
  modifies Heap;
  ensures Seq#Equal(Heap[Current, SIMPLE_LIST^OBSERVER^.sequence], Seq#Extended(old(Heap)[Current, SIMPLE_LIST^OBSERVER^.sequence], v)); // type:post tag:sequence_effect line:101
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_LIST^OBSERVER^.extend_back(Heap, Current, v), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_LIST^OBSERVER^.extend_back(old(Heap), Current, v));
  free ensures HeapSucc(old(Heap), Heap);
  requires is_wrapped(Heap, Current); // type:pre tag:default_is_wrapped default:contracts
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts
...
procedure OBSERVER.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, OBSERVER); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.OBSERVER.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.OBSERVER.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.OBSERVER.in_observers(Heap, Current, new_observers, o), readable);



function fun.OBSERVER.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.OBSERVER.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.OBSERVER.in_observers(heap, current, new_observers, o) } { trigger.fun.OBSERVER.in_observers(heap, current, new_observers, o) } (pre.fun.OBSERVER.in_observers(heap, current, new_observers, o)) ==> ((fun.OBSERVER.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.OBSERVER.in_observers(heap, current, new_observers, o) } (fun.OBSERVER.in_observers(heap, current, new_observers, o)) == (fun0.OBSERVER.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.OBSERVER.in_observers(h, current, new_observers, o), fun0.OBSERVER.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.OBSERVER.in_observers(h, current, new_observers, o)) && (pre.fun.OBSERVER.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.OBSERVER.in_observers(h, current, new_observers, o)))) ==> ((fun0.OBSERVER.in_observers(h, current, new_observers, o)) == (fun0.OBSERVER.in_observers(h', current, new_observers, o)))));
...
procedure SUBJECT.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SUBJECT); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SUBJECT.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SUBJECT.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SUBJECT.in_observers(Heap, Current, new_observers, o), readable);



function fun.SUBJECT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.SUBJECT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUBJECT.in_observers(heap, current, new_observers, o) } { trigger.fun.SUBJECT.in_observers(heap, current, new_observers, o) } (pre.fun.SUBJECT.in_observers(heap, current, new_observers, o)) ==> ((fun.SUBJECT.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SUBJECT.in_observers(heap, current, new_observers, o) } (fun.SUBJECT.in_observers(heap, current, new_observers, o)) == (fun0.SUBJECT.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.SUBJECT.in_observers(h, current, new_observers, o), fun0.SUBJECT.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.SUBJECT.in_observers(h, current, new_observers, o)) && (pre.fun.SUBJECT.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.SUBJECT.in_observers(h, current, new_observers, o)))) ==> ((fun0.SUBJECT.in_observers(h, current, new_observers, o)) == (fun0.SUBJECT.in_observers(h', current, new_observers, o)))));

function modify.SIMPLE_LIST^OBSERVER^.is_empty(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T17> $o: ref, $f: Field T17 :: { modify.SIMPLE_LIST^OBSERVER^.is_empty(heap, current)[$o, $f] } (modify.SIMPLE_LIST^OBSERVER^.is_empty(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_LIST^OBSERVER^.is_empty(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T18> $o: ref, $f: Field T18 :: { read.fun.SIMPLE_LIST^OBSERVER^.is_empty(heap, current)[$o, $f] } (read.fun.SIMPLE_LIST^OBSERVER^.is_empty(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SIMPLE_LIST^OBSERVER^.is_empty(heap: HeapType, current: ref) returns (bool) {
  is_closed(heap, current)
}

function trigger.fun.SIMPLE_LIST^OBSERVER^.is_empty(heap: HeapType, current: ref) returns (bool);

const unique ITERABLE^OBSERVER^: Type;

axiom ((ITERABLE^OBSERVER^) <: (ANY));

axiom ((forall t: Type :: { (ITERABLE^OBSERVER^) <: (t) } ((ITERABLE^OBSERVER^) <: (t)) <==> (((t) == (ITERABLE^OBSERVER^)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, ITERABLE^OBSERVER^)) == (-1));

axiom ((FieldId(closed, ITERABLE^OBSERVER^)) == (-2));

axiom ((FieldId(owner, ITERABLE^OBSERVER^)) == (-3));

axiom ((FieldId(owns, ITERABLE^OBSERVER^)) == (-4));

axiom ((FieldId(observers, ITERABLE^OBSERVER^)) == (-5));

axiom ((FieldId(subjects, ITERABLE^OBSERVER^)) == (-6));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, SIMPLE_LIST^OBSERVER^)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, SIMPLE_LIST^OBSERVER^)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, SIMPLE_LIST^OBSERVER^)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, SIMPLE_LIST^OBSERVER^)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, v, o)))));

function modify.SIMPLE_LIST^OBSERVER^.make(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T19> $o: ref, $f: Field T19 :: { modify.SIMPLE_LIST^OBSERVER^.make(heap, current)[$o, $f] } (modify.SIMPLE_LIST^OBSERVER^.make(heap, current)[$o, $f]) <==> (($o) == (current))))));

function pre.fun.MML_SEQUENCE^OBSERVER^.item(current: Seq (ref), i: int) returns (bool) {
  ((1) <= (i)) && ((i) <= (Seq#Length(current)))
}

function trigger.fun.MML_SEQUENCE^OBSERVER^.item(current: Seq (ref), i: int) returns (bool);

function modify.SIMPLE_LIST^OBSERVER^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T20> $o: ref, $f: Field T20 :: { modify.SIMPLE_LIST^OBSERVER^.count(heap, current)[$o, $f] } (modify.SIMPLE_LIST^OBSERVER^.count(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_LIST^OBSERVER^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T21> $o: ref, $f: Field T21 :: { read.fun.SIMPLE_LIST^OBSERVER^.count(heap, current)[$o, $f] } (read.fun.SIMPLE_LIST^OBSERVER^.count(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SIMPLE_LIST^OBSERVER^.count(heap: HeapType, current: ref) returns (bool) {
  is_closed(heap, current)
}

function trigger.fun.SIMPLE_LIST^OBSERVER^.count(heap: HeapType, current: ref) returns (bool);

function modify.SIMPLE_LIST^OBSERVER^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T22> $o: ref, $f: Field T22 :: { modify.SIMPLE_LIST^OBSERVER^.item(heap, current, i)[$o, $f] } (modify.SIMPLE_LIST^OBSERVER^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_LIST^OBSERVER^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T23> $o: ref, $f: Field T23 :: { read.fun.SIMPLE_LIST^OBSERVER^.item(heap, current, i)[$o, $f] } (read.fun.SIMPLE_LIST^OBSERVER^.item(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SIMPLE_LIST^OBSERVER^.item(heap: HeapType, current: ref, i: int) returns (bool) {
  ((1) <= (i)) && ((i) <= (fun.SIMPLE_LIST^OBSERVER^.count(heap, current))) && (is_closed(heap, current))
}

function trigger.fun.SIMPLE_LIST^OBSERVER^.item(heap: HeapType, current: ref, i: int) returns (bool);

function modify.SIMPLE_LIST^OBSERVER^.extend_back(heap: HeapType, current: ref, v: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, v: ref :: (IsHeap(heap)) ==> ((forall <T24> $o: ref, $f: Field T24 :: { modify.SIMPLE_LIST^OBSERVER^.extend_back(heap, current, v)[$o, $f] } (modify.SIMPLE_LIST^OBSERVER^.extend_back(heap, current, v)[$o, $f]) <==> (($o) == (current))))));
...
function modify.OBSERVER.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T27> $o: ref, $f: Field T27 :: { modify.OBSERVER.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.OBSERVER.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.OBSERVER.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T28> $o: ref, $f: Field T28 :: { read.fun.OBSERVER.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.OBSERVER.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.OBSERVER.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.OBSERVER.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
function modify.SUBJECT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T31> $o: ref, $f: Field T31 :: { modify.SUBJECT.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SUBJECT.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SUBJECT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T32> $o: ref, $f: Field T32 :: { read.fun.SUBJECT.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SUBJECT.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SUBJECT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.SUBJECT.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

procedure SIMPLE_LIST^OBSERVER^.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, SIMPLE_LIST^OBSERVER^); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.SIMPLE_LIST^OBSERVER^.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.SIMPLE_LIST^OBSERVER^.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.SIMPLE_LIST^OBSERVER^.in_observers(Heap, Current, new_observers, o), readable);



function fun.SIMPLE_LIST^OBSERVER^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.SIMPLE_LIST^OBSERVER^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o) } { trigger.fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o) } (pre.fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o)) ==> ((fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o) } (fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o)) == (fun0.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.SIMPLE_LIST^OBSERVER^.in_observers(h, current, new_observers, o), fun0.SIMPLE_LIST^OBSERVER^.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.SIMPLE_LIST^OBSERVER^.in_observers(h, current, new_observers, o)) && (pre.fun.SIMPLE_LIST^OBSERVER^.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.SIMPLE_LIST^OBSERVER^.in_observers(h, current, new_observers, o)))) ==> ((fun0.SIMPLE_LIST^OBSERVER^.in_observers(h, current, new_observers, o)) == (fun0.SIMPLE_LIST^OBSERVER^.in_observers(h', current, new_observers, o)))));

function modify.SIMPLE_LIST^OBSERVER^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T33> $o: ref, $f: Field T33 :: { modify.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_LIST^OBSERVER^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T34> $o: ref, $f: Field T34 :: { read.fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_LIST^OBSERVER^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.SIMPLE_LIST^OBSERVER^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.SIMPLE_LIST^OBSERVER^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
