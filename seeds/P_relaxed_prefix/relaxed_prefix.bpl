// Automatically generated (12/12/2017 1:54:44.489 PM)
...
const unique RELAXED_PREFIX: Type;

axiom ((RELAXED_PREFIX) <: (ANY));

axiom ((forall t: Type :: { (RELAXED_PREFIX) <: (t) } ((RELAXED_PREFIX) <: (t)) <==> (((t) == (RELAXED_PREFIX)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, RELAXED_PREFIX)) == (-1));

axiom ((FieldId(closed, RELAXED_PREFIX)) == (-2));

axiom ((FieldId(owner, RELAXED_PREFIX)) == (-3));

axiom ((FieldId(owns, RELAXED_PREFIX)) == (-4));

axiom ((FieldId(observers, RELAXED_PREFIX)) == (-5));

axiom ((FieldId(subjects, RELAXED_PREFIX)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, RELAXED_PREFIX) } (IsModelField($f, RELAXED_PREFIX)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } RELAXED_PREFIX.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, RELAXED_PREFIX)) ==> ((user_inv(heap, current)) <==> (RELAXED_PREFIX.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, RELAXED_PREFIX)) ==> ((user_inv(heap, current)) ==> (RELAXED_PREFIX.user_inv(heap, current)))));

procedure RELAXED_PREFIX.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, RELAXED_PREFIX);



implementation RELAXED_PREFIX.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.RELAXED_PREFIX.default_create(Current: ref);
  free requires attached_exact(Heap, Current, RELAXED_PREFIX); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.RELAXED_PREFIX.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.RELAXED_PREFIX.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.RELAXED_PREFIX.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.RELAXED_PREFIX.default_create"} true;
  if (*) {
...
procedure RELAXED_PREFIX.is_relaxed_prefix(Current: ref, pat: Seq int, a: Seq int) returns (Result: ref where detachable(Heap, Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^));
  free requires attached_exact(Heap, Current, RELAXED_PREFIX); // info:type property for argument Current
  free requires true; // info:type property for argument pat
  modifies Heap;
  ensures (Result) != (Void); // type:attached tag:strict_prefix line:61
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (Seq#Length(pat)))) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) == (0))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, i_1)))); // type:check tag:function_precondition line:61 cid:125 rid:3286
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (Seq#Length(pat)))) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) == (0))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, i_1)))); // type:check tag:function_precondition line:61 cid:125 rid:3286
  ensures ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) == (0))) ==> ((forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (Seq#Length(pat)))) ==> ((Seq#Item(pat, i_1)) == (Seq#Item(a, i_1))))); // type:post tag:strict_prefix line:61
  ensures ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) ==> ((Result) != (Void)); // type:attached tag:relaxed_prefix line:62
  ensures ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) <= (Seq#Length(pat)))) ==> ((Result) != (Void)); // type:attached tag:relaxed_prefix line:62
  ensures (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) <= (Seq#Length(pat)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, i_2)))); // type:check tag:function_precondition line:62 cid:125 rid:3286
  ensures (forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) <= (Seq#Length(pat)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, i_2)))); // type:check tag:function_precondition line:62 cid:125 rid:3286
  ensures ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) <= (Seq#Length(pat))) && ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> ((Seq#Item(pat, i_2)) == (Seq#Item(a, i_2)))))) ==> ((Result) != (Void)); // type:attached tag:relaxed_prefix line:62
  ensures (forall i_3: int :: ((((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) + (1)) <= (i_3)) && ((i_3) <= (Seq#Length(pat)))) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) <= (Seq#Length(pat))) && ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> ((Seq#Item(pat, i_2)) == (Seq#Item(a, i_2)))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, i_3)))); // type:check tag:function_precondition line:62 cid:125 rid:3286
  ensures (forall i_3: int :: ((((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) + (1)) <= (i_3)) && ((i_3) <= (Seq#Length(pat)))) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) <= (Seq#Length(pat))) && ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> ((Seq#Item(pat, i_2)) == (Seq#Item(a, i_2)))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, (i_3) - (1))))); // type:check tag:function_precondition line:62 cid:125 rid:3286
  ensures ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) <= (Seq#Length(pat))) && ((forall i_2: int :: (((1) <= (i_2)) && ((i_2) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> ((Seq#Item(pat, i_2)) == (Seq#Item(a, i_2))))) && ((forall i_3: int :: ((((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) + (1)) <= (i_3)) && ((i_3) <= (Seq#Length(pat)))) ==> ((Seq#Item(pat, i_3)) == (Seq#Item(a, (i_3) - (1))))))); // type:post tag:relaxed_prefix line:62
  ensures (!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) ==> ((Result) != (Void)); // type:attached tag:not_a_prefix line:66
  ensures ((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))))) ==> ((Result) != (Void)); // type:attached tag:not_a_prefix line:66
  ensures ((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])); // type:check tag:function_precondition line:66 cid:125 rid:3286
  ensures ((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])); // type:check tag:function_precondition line:66 cid:125 rid:3286
  ensures ((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) && (!(((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))) || (((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))))) ==> ((Result) != (Void)); // type:attached tag:not_a_prefix line:66
  ensures ((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) && (!(((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))) || (((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])); // type:check tag:function_precondition line:66 cid:125 rid:3286
  ensures ((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) && (!(((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))) || (((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])); // type:check tag:function_precondition line:66 cid:125 rid:3286
  ensures ((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) && (!(((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))) || (((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3])); // type:check tag:function_precondition line:66 cid:125 rid:3286
  ensures ((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) && (!(((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))) || (((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) - (1))); // type:check tag:function_precondition line:66 cid:125 rid:3286
  ensures (!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) ==> (((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) < (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) <= (Seq#Length(pat))) && (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))) || (((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a)))) || (((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3])) != (Seq#Item(a, (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) - (1))))))); // type:post tag:not_a_prefix line:66
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.RELAXED_PREFIX.is_relaxed_prefix(Heap, Current, pat, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.RELAXED_PREFIX.is_relaxed_prefix(old(Heap), Current, pat, a));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.RELAXED_PREFIX.is_relaxed_prefix(Heap, Current, pat, a), readable);
  requires is_closed(Heap, Current); // type:pre tag:default_is_closed default:contracts
  free ensures (Result) == (fun.RELAXED_PREFIX.is_relaxed_prefix(old(Heap), Current, pat, a));



function fun.RELAXED_PREFIX.is_relaxed_prefix(heap: HeapType, current: ref, pat: Seq int, a: Seq int) returns (ref);

axiom ((forall heap: HeapType, current: ref, pat: Seq int, a: Seq int :: { fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a) } (pre.fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a)) ==> ((((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) == (0))) ==> ((forall i_4: int :: (((1) <= (i_4)) && ((i_4) <= (Seq#Length(pat)))) ==> ((Seq#Item(pat, i_4)) == (Seq#Item(a, i_4)))))) && (((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) && ((1) <= (heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) ==> (((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) <= (Seq#Length(pat))) && ((forall i_5: int :: (((1) <= (i_5)) && ((i_5) <= ((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> ((Seq#Item(pat, i_5)) == (Seq#Item(a, i_5))))) && ((forall i_6: int :: ((((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) + (1)) <= (i_6)) && ((i_6) <= (Seq#Length(pat)))) ==> ((Seq#Item(pat, i_6)) == (Seq#Item(a, (i_6) - (1)))))))) && ((!(heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) ==> (((1) <= (heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) < (heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3])) && ((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) <= (Seq#Length(pat))) && (((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))) || (((Seq#Item(pat, heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a)))) || (((Seq#Item(pat, heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))) && ((Seq#Item(pat, heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3])) != (Seq#Item(a, (heap[fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) - (1)))))))) && (detachable(heap, fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a), TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)))));

axiom ((forall h: HeapType, h': HeapType, current: ref, pat: Seq int, a: Seq int :: { HeapSucc(h, h'), fun.RELAXED_PREFIX.is_relaxed_prefix(h, current, pat, a), fun.RELAXED_PREFIX.is_relaxed_prefix(h', current, pat, a) } ((HeapSucc(h, h')) && (pre.fun.RELAXED_PREFIX.is_relaxed_prefix(h, current, pat, a)) && (pre.fun.RELAXED_PREFIX.is_relaxed_prefix(h', current, pat, a)) && (same_inside(h, h', read.fun.RELAXED_PREFIX.is_relaxed_prefix(h, current, pat, a)))) ==> ((fun.RELAXED_PREFIX.is_relaxed_prefix(h, current, pat, a)) == (fun.RELAXED_PREFIX.is_relaxed_prefix(h', current, pat, a)))));

function { :inline } variant.RELAXED_PREFIX.is_relaxed_prefix.1(heap: HeapType, current: ref, pat: Seq int, a: Seq int) returns (Seq int) {
  pat
}

function { :inline } variant.RELAXED_PREFIX.is_relaxed_prefix.2(heap: HeapType, current: ref, pat: Seq int, a: Seq int) returns (Seq int) {
  a
}

implementation RELAXED_PREFIX.is_relaxed_prefix(Current: ref, pat: Seq int, a: Seq int) returns (Result: ref)
{
  var temp_7: ref;
  var temp_11: ref;
  ...
  entry:
  assume {:captureState "RELAXED_PREFIX.is_relaxed_prefix"} true;
  // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:16
  // if pat.count > a.count + 1 then
  if ((Seq#Length(pat)) > ((Seq#Length(a)) + (1))) {
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:17
    // Result := [False, a.count + 1, a.count + 2]
    call temp_7 := allocate(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^); // line:-1
    call create.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.make(temp_7, false, (Seq#Length(a)) + (1), (Seq#Length(a)) + (2));
    Result := temp_7;
  } else {
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:20
    // Result := [True, 0, 0]
    call temp_11 := allocate(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^); // line:-1
    call create.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.make(temp_11, true, 0, 0);
    Result := temp_11;
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:21
    // i := 1
    local1 := 1;
    PreLoopHeap_12 := Heap;
    goto loop_head_8;
    loop_head_8:
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:23
    // i_in_bounds: 1 <= i and i <= pat.count + 1
    assert ((1) <= (local1)) && ((local1) <= ((Seq#Length(pat)) + (1))); // type:loop_inv tag:i_in_bounds line:23
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:24
    // shift_up_to_two: 0 <= shift and shift <= 2
    assert ((0) <= (local2)) && ((local2) <= (2)); // type:loop_inv tag:shift_up_to_two line:24
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:25
    // shift_zero: (shift = 0) = (Result.idx1 = 0)
    assert {:subsumption 0} (Result) != (Void); // type:attached line:25
    assert ((local2) == (0)) == ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) == (0)); // type:loop_inv tag:shift_zero line:25
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:26
    // shift_one: (shift = 1) = (1 <= Result.idx1 and Result.idx1 < i and Result.idx2 = 0)
    assert {:subsumption 0} (Result) != (Void); // type:attached line:26
    assert {:subsumption 0} (Result) != (Void); // type:attached line:26
    assert {:subsumption 0} (Result) != (Void); // type:attached line:26
    assert ((local2) == (1)) == (((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) < (local1)) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) == (0))); // type:loop_inv tag:shift_one line:26
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:27
    // shift_two: (shift = 2) = (1 <= Result.idx1 and Result.idx1 < Result.idx2 and Result.idx2 < i)
    assert {:subsumption 0} (Result) != (Void); // type:attached line:27
    assert {:subsumption 0} (Result) != (Void); // type:attached line:27
    assert {:subsumption 0} (Result) != (Void); // type:attached line:27
    assert {:subsumption 0} (Result) != (Void); // type:attached line:27
    assert ((local2) == (2)) == (((1) <= (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) < (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3])) && ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) < (local1))); // type:loop_inv tag:shift_two line:27
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:28
    // shift_result: (shift = 2) = (not Result.res)
    assert {:subsumption 0} (Result) != (Void); // type:attached line:28
    assert ((local2) == (2)) == (!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])); // type:loop_inv tag:shift_result line:28
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:30
    // match_up_to_idx1: across 1 |..| (Result.idx1 - 1) as k all pat [k.item] = a [k.item] end
    assert {:subsumption 0} (Result) != (Void); // type:attached line:30
    assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, i_13))); // type:check tag:function_precondition line:30 cid:125 rid:3286
    assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, i_13))); // type:check tag:function_precondition line:30 cid:125 rid:3286
    assert (forall i_13: int :: (((1) <= (i_13)) && ((i_13) <= ((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) - (1)))) ==> ((Seq#Item(pat, i_13)) == (Seq#Item(a, i_13)))); // type:loop_inv tag:match_up_to_idx1 line:30
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:31
    // no_shift_match: shift = 0 implies across 1 |..| (i - 1) as k all pat [k.item] = a [k.item] end
    assert (forall i_14: int :: (((1) <= (i_14)) && ((i_14) <= ((local1) - (1)))) ==> (((local2) == (0)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, i_14)))); // type:check tag:function_precondition line:31 cid:125 rid:3286
    assert (forall i_14: int :: (((1) <= (i_14)) && ((i_14) <= ((local1) - (1)))) ==> (((local2) == (0)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, i_14)))); // type:check tag:function_precondition line:31 cid:125 rid:3286
    assert ((local2) == (0)) ==> ((forall i_14: int :: (((1) <= (i_14)) && ((i_14) <= ((local1) - (1)))) ==> ((Seq#Item(pat, i_14)) == (Seq#Item(a, i_14))))); // type:loop_inv tag:no_shift_match line:31
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:32
    // one_shift_match: shift = 1 implies across (Result.idx1 + 1) |..| (i - 1) as k all pat [k.item] = a [k.item - 1] end
    assert {:subsumption 0} ((local2) == (1)) ==> ((Result) != (Void)); // type:attached line:32
    assert (forall i_15: int :: ((((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) + (1)) <= (i_15)) && ((i_15) <= ((local1) - (1)))) ==> (((local2) == (1)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, i_15)))); // type:check tag:function_precondition line:32 cid:125 rid:3286
    assert (forall i_15: int :: ((((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) + (1)) <= (i_15)) && ((i_15) <= ((local1) - (1)))) ==> (((local2) == (1)) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, (i_15) - (1))))); // type:check tag:function_precondition line:32 cid:125 rid:3286
    assert ((local2) == (1)) ==> ((forall i_15: int :: ((((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) + (1)) <= (i_15)) && ((i_15) <= ((local1) - (1)))) ==> ((Seq#Item(pat, i_15)) == (Seq#Item(a, (i_15) - (1)))))); // type:loop_inv tag:one_shift_match line:32
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:33
    // first_mismatch: shift >= 1 implies (Result.idx1 > a.count or else pat [Result.idx1] /= a [Result.idx1])
    assert {:subsumption 0} ((local2) >= (1)) ==> ((Result) != (Void)); // type:attached line:33
    assert {:subsumption 0} (((local2) >= (1)) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))))) ==> ((Result) != (Void)); // type:attached line:33
    assert (((local2) >= (1)) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])); // type:check tag:function_precondition line:33 cid:125 rid:3286
    assert {:subsumption 0} (((local2) >= (1)) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))))) ==> ((Result) != (Void)); // type:attached line:33
    assert (((local2) >= (1)) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])); // type:check tag:function_precondition line:33 cid:125 rid:3286
    assert ((local2) >= (1)) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) > (Seq#Length(a))) || ((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])) != (Seq#Item(a, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2])))); // type:loop_inv tag:first_mismatch line:33
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:34
    // second_mismatch: shift = 2 implies (Result.idx2 > a.count or else pat [Result.idx2] /= a [Result.idx2 - 1])
    assert {:subsumption 0} ((local2) == (2)) ==> ((Result) != (Void)); // type:attached line:34
    assert {:subsumption 0} (((local2) == (2)) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))) ==> ((Result) != (Void)); // type:attached line:34
    assert (((local2) == (2)) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3])); // type:check tag:function_precondition line:34 cid:125 rid:3286
    assert {:subsumption 0} (((local2) == (2)) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))) ==> ((Result) != (Void)); // type:attached line:34
    assert (((local2) == (2)) && (!((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) - (1))); // type:check tag:function_precondition line:34 cid:125 rid:3286
    assert ((local2) == (2)) ==> (((Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) > (Seq#Length(a))) || ((Seq#Item(pat, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3])) != (Seq#Item(a, (Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) - (1))))); // type:loop_inv tag:second_mismatch line:34
    assume HeapSucc(PreLoopHeap_12, Heap);
    assume same_outside(old(Heap), Heap, modify.RELAXED_PREFIX.is_relaxed_prefix(old(Heap), Current, pat, a));
    assume global(Heap);
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:-1
    assert {:subsumption 0} (Result) != (Void); // type:attached line:-1
    goto loop_body_9, loop_end_10;
    loop_body_9:
    assume !((!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) || ((local1) > (Seq#Length(pat))));
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:57
    // pat.count - i
    variant_16 := (Seq#Length(pat)) - (local1);
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:38
    // if i > a.count then
    if ((local1) > (Seq#Length(a))) {
      // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:39
      // shift := shift + 1
      local2 := (local2) + (1);
      // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:40
      // if shift = 1 then
      if ((local2) == (1)) {
        // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:41
        // Result := [Result.res, i, 0]
        assert {:subsumption 0} (Result) != (Void); // type:attached line:41
        call temp_17 := allocate(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^); // line:-1
        call create.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.make(temp_17, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1], local1, 0);
        Result := temp_17;
      } else {
        // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:43
        // Result := [False, Result.idx1, i]
        assert {:subsumption 0} (Result) != (Void); // type:attached line:43
        call temp_18 := allocate(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^); // line:-1
        call create.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.make(temp_18, false, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2], local1);
        Result := temp_18;
      }
    } else {
      // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:46
      // if pat [i] /= a [i - shift] then
      assert pre.fun.MML_SEQUENCE^INTEGER_32^.item(pat, local1); // type:check tag:function_precondition line:46 cid:125 rid:3286
      assert pre.fun.MML_SEQUENCE^INTEGER_32^.item(a, (local1) - (local2)); // type:check tag:function_precondition line:46 cid:125 rid:3286
      if ((Seq#Item(pat, local1)) != (Seq#Item(a, (local1) - (local2)))) {
        // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:47
        // shift := shift + 1
        local2 := (local2) + (1);
        // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:48
        // if shift = 1 then
        if ((local2) == (1)) {
          // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:49
          // Result := [Result.res, i, 0]
          assert {:subsumption 0} (Result) != (Void); // type:attached line:49
          call temp_19 := allocate(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^); // line:-1
          call create.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.make(temp_19, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1], local1, 0);
          Result := temp_19;
        } else {
          // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:51
          // Result := [False, Result.idx1, i]
          assert {:subsumption 0} (Result) != (Void); // type:attached line:51
          call temp_20 := allocate(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^); // line:-1
          call create.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.make(temp_20, false, Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2], local1);
          Result := temp_20;
        }
      }
    }
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:55
    // i := i + 1
    local1 := (local1) + (1);
    // /home/caf/temp/comcom/repo-relaxed_prefix/relaxed_prefix.e:57
    // pat.count - i
    assert {:subsumption 0} ((((Seq#Length(pat)) - (local1)) <= (variant_16)) && ((variant_16) <= ((Seq#Length(pat)) - (local1)))) || ((0) <= (variant_16)); // type:termination tag:bounded line:57 varid:1
    assert {:subsumption 0} (((Seq#Length(pat)) - (local1)) <= (variant_16)) && (!((variant_16) <= ((Seq#Length(pat)) - (local1)))); // type:termination tag:variant_decreases line:57
    goto loop_head_8;
    loop_end_10:
    assume (!(Heap[Result, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1])) || ((local1) > (Seq#Length(pat)));
  }
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, RELAXED_PREFIX)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, RELAXED_PREFIX)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, RELAXED_PREFIX)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.RELAXED_PREFIX.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, RELAXED_PREFIX)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.RELAXED_PREFIX.in_observers(heap, current, v, o)))));

function modify.RELAXED_PREFIX.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.RELAXED_PREFIX.default_create(heap, current)[$o, $f] } (modify.RELAXED_PREFIX.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));

const unique TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^: Type;

const TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1: Field bool;

axiom ((FieldId(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (1));

const TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2: Field int;

axiom ((FieldId(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (2));

axiom ((forall heap: HeapType, o: ref :: { heap[o, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2] } ((IsHeap(heap)) && (attached(heap, o, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^))) ==> (is_integer_32(heap[o, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]))));

const TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3: Field int;

axiom ((FieldId(TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (3));

axiom ((forall heap: HeapType, o: ref :: { heap[o, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3] } ((IsHeap(heap)) && (attached(heap, o, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^))) ==> (is_integer_32(heap[o, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]))));

procedure create.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.make(Current: ref, f_1: bool, f_2: int, f_3: int);
  free requires attached_exact(Heap, Current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^); // info:type property for argument Current
  free requires true; // info:type property for argument f_1
  ensures (Heap[Current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_1]) == (f_1);
  free requires is_integer_32(f_2); // info:type property for argument f_2
  ensures (Heap[Current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_2]) == (f_2);
  free requires is_integer_32(f_3); // info:type property for argument f_3
  ensures (Heap[Current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.field_3]) == (f_3);
  modifies Heap;
...
axiom ((FieldId(allocated, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (-1));

axiom ((FieldId(closed, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (-2));

axiom ((FieldId(owner, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (-3));

axiom ((FieldId(owns, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (-4));

axiom ((FieldId(observers, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (-5));

axiom ((FieldId(subjects, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) == (-6));

function { :inline } TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.user_inv(heap: HeapType, current: ref) returns (bool) {
  (Set#IsEmpty(heap[current, observers])) && (Set#IsEmpty(heap[current, subjects])) && (Set#IsEmpty(heap[current, owns]))
}

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) ==> ((user_inv(heap, current)) <==> (TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) ==> ((user_inv(heap, current)) ==> (TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.user_inv(heap, current)))));

function modify.RELAXED_PREFIX.is_relaxed_prefix(heap: HeapType, current: ref, pat: Seq int, a: Seq int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, pat: Seq int, a: Seq int :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a)[$o, $f] } (modify.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a)[$o, $f]) <==> (false)))));

function read.fun.RELAXED_PREFIX.is_relaxed_prefix(heap: HeapType, current: ref, pat: Seq int, a: Seq int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, pat: Seq int, a: Seq int :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { read.fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a)[$o, $f] } (read.fun.RELAXED_PREFIX.is_relaxed_prefix(heap, current, pat, a)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.RELAXED_PREFIX.is_relaxed_prefix(heap: HeapType, current: ref, pat: Seq int, a: Seq int) returns (bool) {
  is_closed(heap, current)
}

function trigger.fun.RELAXED_PREFIX.is_relaxed_prefix(heap: HeapType, current: ref, pat: Seq int, a: Seq int) returns (bool);
...
procedure RELAXED_PREFIX.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, RELAXED_PREFIX); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.RELAXED_PREFIX.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.RELAXED_PREFIX.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.RELAXED_PREFIX.in_observers(Heap, Current, new_observers, o), readable);



function fun.RELAXED_PREFIX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.RELAXED_PREFIX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.RELAXED_PREFIX.in_observers(heap, current, new_observers, o) } { trigger.fun.RELAXED_PREFIX.in_observers(heap, current, new_observers, o) } (pre.fun.RELAXED_PREFIX.in_observers(heap, current, new_observers, o)) ==> ((fun.RELAXED_PREFIX.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.RELAXED_PREFIX.in_observers(heap, current, new_observers, o) } (fun.RELAXED_PREFIX.in_observers(heap, current, new_observers, o)) == (fun0.RELAXED_PREFIX.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.RELAXED_PREFIX.in_observers(h, current, new_observers, o), fun0.RELAXED_PREFIX.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.RELAXED_PREFIX.in_observers(h, current, new_observers, o)) && (pre.fun.RELAXED_PREFIX.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.RELAXED_PREFIX.in_observers(h, current, new_observers, o)))) ==> ((fun0.RELAXED_PREFIX.in_observers(h, current, new_observers, o)) == (fun0.RELAXED_PREFIX.in_observers(h', current, new_observers, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, v, o)))));
...
function modify.RELAXED_PREFIX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.RELAXED_PREFIX.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.RELAXED_PREFIX.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.RELAXED_PREFIX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { read.fun.RELAXED_PREFIX.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.RELAXED_PREFIX.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.RELAXED_PREFIX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.RELAXED_PREFIX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

procedure TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(Heap, Current, new_observers, o), readable);



function fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o) } { trigger.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o) } (pre.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)) ==> ((fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o) } (fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)) == (fun0.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(h, current, new_observers, o), fun0.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(h, current, new_observers, o)) && (pre.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(h, current, new_observers, o)))) ==> ((fun0.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(h, current, new_observers, o)) == (fun0.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(h', current, new_observers, o)))));

function modify.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T13> $o: ref, $f: Field T13 :: { modify.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T14> $o: ref, $f: Field T14 :: { read.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.TUPLE^BOOLEAN#INTEGER_32#INTEGER_32^.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
