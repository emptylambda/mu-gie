// Automatically generated (12/12/2017 1:54:33.500 PM)
...
const unique TWO_WAY_MAX: Type;

axiom ((TWO_WAY_MAX) <: (ANY));

axiom ((forall t: Type :: { (TWO_WAY_MAX) <: (t) } ((TWO_WAY_MAX) <: (t)) <==> (((t) == (TWO_WAY_MAX)) || ((ANY) <: (t)))));

axiom ((FieldId(allocated, TWO_WAY_MAX)) == (-1));

axiom ((FieldId(closed, TWO_WAY_MAX)) == (-2));

axiom ((FieldId(owner, TWO_WAY_MAX)) == (-3));

axiom ((FieldId(owns, TWO_WAY_MAX)) == (-4));

axiom ((FieldId(observers, TWO_WAY_MAX)) == (-5));

axiom ((FieldId(subjects, TWO_WAY_MAX)) == (-6));

axiom ((forall <T0> $f: Field T0 :: { IsModelField($f, TWO_WAY_MAX) } (IsModelField($f, TWO_WAY_MAX)) <==> ((($f) == (subjects)) || (($f) == (observers)))));

function { :inline } TWO_WAY_MAX.user_inv(heap: HeapType, current: ref) returns (bool) {
...
axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached_exact(heap, current, TWO_WAY_MAX)) ==> ((user_inv(heap, current)) <==> (TWO_WAY_MAX.user_inv(heap, current)))));

axiom ((forall heap: HeapType, current: ref :: { user_inv(heap, current) } (attached(heap, current, TWO_WAY_MAX)) ==> ((user_inv(heap, current)) ==> (TWO_WAY_MAX.user_inv(heap, current)))));

procedure TWO_WAY_MAX.invariant_admissibility_check(Current: ref);
  requires attached_exact(Heap, Current, TWO_WAY_MAX);



implementation TWO_WAY_MAX.invariant_admissibility_check(Current: ref)
{
  entry:
  goto pre, a2, a3;
  pre:
...
procedure create.TWO_WAY_MAX.default_create(Current: ref);
  free requires attached_exact(Heap, Current, TWO_WAY_MAX); // info:type property for argument Current
  modifies Heap;
  ...
  requires Frame#Subset(modify.TWO_WAY_MAX.default_create(Heap, Current), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.TWO_WAY_MAX.default_create(old(Heap), Current));
  free ensures HeapSucc(old(Heap), Heap);
  ensures is_wrapped(Heap, Current); // type:post tag:default_is_wrapped default:contracts



implementation create.TWO_WAY_MAX.default_create(Current: ref)
{
  entry:
  assume {:captureState "create.TWO_WAY_MAX.default_create"} true;
  if (*) {
...
procedure TWO_WAY_MAX.two_way_max(Current: ref, a: ref) returns (Result: int where is_integer_32(Result));
  free requires attached_exact(Heap, Current, TWO_WAY_MAX); // info:type property for argument Current
  free requires detachable_exact(Heap, a, SIMPLE_ARRAY^INTEGER_32^); // info:type property for argument a
  modifies Heap;
  requires (a) != (Void); // type:attached tag:a_not_empty line:12
  requires pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:12 cid:190 rid:3249
  requires (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)) > (0); // type:pre tag:a_not_empty line:12
  ensures (a) != (Void); // type:attached tag:result_in_range line:36
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:36 cid:190 rid:3249
  ensures ((1) <= (Result)) && ((Result) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))); // type:post tag:result_in_range line:36
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1))); // type:check tag:function_precondition line:37 cid:125 rid:3286
  ensures pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result); // type:check tag:function_precondition line:37 cid:190 rid:3250
  ensures (forall i_1: int :: (((1) <= (i_1)) && ((i_1) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_1)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result)))); // type:post tag:result_is_max line:37
  ensures (forall i_2: int :: (Seq#Range(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])[i_2]) ==> ((i_2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, Result)))); // type:post tag:result_is_max line:38
  free requires global(Heap);
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.TWO_WAY_MAX.two_way_max(Heap, Current, a), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.TWO_WAY_MAX.two_way_max(old(Heap), Current, a));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.TWO_WAY_MAX.two_way_max(Heap, Current, a), readable);
  ...
  free ensures (Result) == (fun.TWO_WAY_MAX.two_way_max(old(Heap), Current, a));



function fun.TWO_WAY_MAX.two_way_max(heap: HeapType, current: ref, a: ref) returns (int);

axiom ((forall heap: HeapType, current: ref, a: ref :: { fun.TWO_WAY_MAX.two_way_max(heap, current, a) } (pre.fun.TWO_WAY_MAX.two_way_max(heap, current, a)) ==> (((1) <= (fun.TWO_WAY_MAX.two_way_max(heap, current, a))) && ((fun.TWO_WAY_MAX.two_way_max(heap, current, a)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a))) && ((forall i_3: int :: (((1) <= (i_3)) && ((i_3) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)))) ==> ((Seq#Item(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_3)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, a, fun.TWO_WAY_MAX.two_way_max(heap, current, a)))))) && ((forall i_4: int :: (Seq#Range(heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence])[i_4]) ==> ((i_4) <= (fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, a, fun.TWO_WAY_MAX.two_way_max(heap, current, a)))))) && (is_integer_32(fun.TWO_WAY_MAX.two_way_max(heap, current, a))))));

axiom ((forall h: HeapType, h': HeapType, current: ref, a: ref :: { HeapSucc(h, h'), fun.TWO_WAY_MAX.two_way_max(h, current, a), fun.TWO_WAY_MAX.two_way_max(h', current, a) } ((HeapSucc(h, h')) && (pre.fun.TWO_WAY_MAX.two_way_max(h, current, a)) && (pre.fun.TWO_WAY_MAX.two_way_max(h', current, a)) && (same_inside(h, h', read.fun.TWO_WAY_MAX.two_way_max(h, current, a)))) ==> ((fun.TWO_WAY_MAX.two_way_max(h, current, a)) == (fun.TWO_WAY_MAX.two_way_max(h', current, a)))));

function { :inline } variant.TWO_WAY_MAX.two_way_max.1(heap: HeapType, current: ref, a: ref) returns (ref) {
  a
}

implementation TWO_WAY_MAX.two_way_max(Current: ref, a: ref) returns (Result: int)
{
  ...
  entry:
  assume {:captureState "TWO_WAY_MAX.two_way_max"} true;
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:17
  // x := 1
  local1 := 1;
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:18
  // y := a.count
  assert {:subsumption 0} (a) != (Void); // type:attached line:18
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:18 cid:190 rid:3249
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:18 cid:190 rid:3249
  local2 := fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a);
  PreLoopHeap_8 := Heap;
  goto loop_head_5;
  loop_head_5:
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:20
  // x_and_y_in_range: 1 <= x and x <= y and y <= a.count
  assert {:subsumption 0} (a) != (Void); // type:attached line:20
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:20 cid:190 rid:3249
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:20 cid:190 rid:3249
  assert ((1) <= (local1)) && ((local1) <= (local2)) && ((local2) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a))); // type:loop_inv tag:x_and_y_in_range line:20
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:21
  ...
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:21 cid:190 fid:84
  assert (forall i_9: int :: (((1) <= (i_9)) && ((i_9) <= (local1))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_9))); // type:check tag:function_precondition line:21 cid:125 rid:3286
  assert {:subsumption 0} (a) != (Void); // type:attached line:21
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:21 cid:190 rid:3250
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1); // type:check tag:function_precondition line:21 cid:190 rid:3250
  assert {:subsumption 0} (a) != (Void); // type:attached line:21
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:21 cid:190 fid:84
  assert (forall i_9: int :: (((1) <= (i_9)) && ((i_9) <= (local1))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_9))); // type:check tag:function_precondition line:21 cid:125 rid:3286
  assert {:subsumption 0} (a) != (Void); // type:attached line:21
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local2), readable); // type:access tag:frame_readable line:21 cid:190 rid:3250
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local2); // type:check tag:function_precondition line:21 cid:190 rid:3250
  assert (forall i_9: int :: (((1) <= (i_9)) && ((i_9) <= (local1))) ==> (((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_9)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1))) || ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_9)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local2))))); // type:loop_inv tag:max_front line:21
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:22
  ...
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a), readable); // type:access tag:frame_readable line:22 cid:190 rid:3249
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a); // type:check tag:function_precondition line:22 cid:190 rid:3249
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:22 cid:190 fid:84
  assert (forall i_10: int :: (((local2) <= (i_10)) && ((i_10) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10))); // type:check tag:function_precondition line:22 cid:125 rid:3286
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:22 cid:190 rid:3250
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1); // type:check tag:function_precondition line:22 cid:190 rid:3250
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert readable[a, SIMPLE_ARRAY^INTEGER_32^.sequence]; // type:access tag:attribute_readable line:22 cid:190 fid:84
  assert (forall i_10: int :: (((local2) <= (i_10)) && ((i_10) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (pre.fun.MML_SEQUENCE^INTEGER_32^.item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10))); // type:check tag:function_precondition line:22 cid:125 rid:3286
  assert {:subsumption 0} (a) != (Void); // type:attached line:22
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local2), readable); // type:access tag:frame_readable line:22 cid:190 rid:3250
  assert pre.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local2); // type:check tag:function_precondition line:22 cid:190 rid:3250
  assert (forall i_10: int :: (((local2) <= (i_10)) && ((i_10) <= (fun.SIMPLE_ARRAY^INTEGER_32^.count(Heap, a)))) ==> (((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1))) || ((Seq#Item(Heap[a, SIMPLE_ARRAY^INTEGER_32^.sequence], i_10)) <= (fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local2))))); // type:loop_inv tag:max_back line:22
  assume HeapSucc(PreLoopHeap_8, Heap);
  assume same_outside(old(Heap), Heap, modify.TWO_WAY_MAX.two_way_max(old(Heap), Current, a));
  assume global(Heap);
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:-1
  goto loop_body_6, loop_end_7;
  loop_body_6:
  assume !((local1) == (local2));
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:32
  // y - x
  variant_11 := (local2) - (local1);
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:26
  // if a[x] <= a[y] then
  assert {:subsumption 0} (a) != (Void); // type:attached line:26
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local1), readable); // type:access tag:frame_readable line:26 cid:190 rid:3250
  call temp_12 := SIMPLE_ARRAY^INTEGER_32^.item(a, local1); // line:26 cid:190 rid:3250
  assert {:subsumption 0} (a) != (Void); // type:attached line:26
  assert Frame#Subset(read.fun.SIMPLE_ARRAY^INTEGER_32^.item(Heap, a, local2), readable); // type:access tag:frame_readable line:26 cid:190 rid:3250
  call temp_13 := SIMPLE_ARRAY^INTEGER_32^.item(a, local2); // line:26 cid:190 rid:3250
  if ((temp_12) <= (temp_13)) {
    // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:27
    // x := x + 1
    local1 := (local1) + (1);
  } else {
    // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:29
    // y := y - 1
    local2 := (local2) - (1);
  }
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:32
  // y - x
  assert {:subsumption 0} ((((local2) - (local1)) <= (variant_11)) && ((variant_11) <= ((local2) - (local1)))) || ((0) <= (variant_11)); // type:termination tag:bounded line:32 varid:1
  assert {:subsumption 0} (((local2) - (local1)) <= (variant_11)) && (!((variant_11) <= ((local2) - (local1)))); // type:termination tag:variant_decreases line:32
  goto loop_head_5;
  loop_end_7:
  assume (local1) == (local2);
  // /home/caf/temp/comcom/repo-two_way_max/two_way_max.e:34
  // Result := x
  Result := local1;
}
...
axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, owns, v, o) } (attached_exact(heap, current, TWO_WAY_MAX)) ==> ((guard(heap, current, owns, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, subjects, v, o) } (attached_exact(heap, current, TWO_WAY_MAX)) ==> ((guard(heap, current, subjects, v, o)) <==> (true))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached_exact(heap, current, TWO_WAY_MAX)) ==> ((guard(heap, current, observers, v, o)) <==> (fun.TWO_WAY_MAX.in_observers(heap, current, v, o)))));

axiom ((forall heap: HeapType, current: ref, v: Set (ref), o: ref :: { guard(heap, current, observers, v, o) } (attached(heap, current, TWO_WAY_MAX)) ==> ((guard(heap, current, observers, v, o)) ==> (fun.TWO_WAY_MAX.in_observers(heap, current, v, o)))));

function modify.TWO_WAY_MAX.default_create(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T5> $o: ref, $f: Field T5 :: { modify.TWO_WAY_MAX.default_create(heap, current)[$o, $f] } (modify.TWO_WAY_MAX.default_create(heap, current)[$o, $f]) <==> (($o) == (current))))));
...
function modify.TWO_WAY_MAX.two_way_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T7> $o: ref, $f: Field T7 :: { modify.TWO_WAY_MAX.two_way_max(heap, current, a)[$o, $f] } (modify.TWO_WAY_MAX.two_way_max(heap, current, a)[$o, $f]) <==> (false)))));

function read.fun.TWO_WAY_MAX.two_way_max(heap: HeapType, current: ref, a: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, a: ref :: (IsHeap(heap)) ==> ((forall <T8> $o: ref, $f: Field T8 :: { read.fun.TWO_WAY_MAX.two_way_max(heap, current, a)[$o, $f] } (read.fun.TWO_WAY_MAX.two_way_max(heap, current, a)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.TWO_WAY_MAX.two_way_max(heap: HeapType, current: ref, a: ref) returns (bool) {
  ((fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, a)) > (0)) && (is_closed(heap, current)) && (is_closed(heap, a))
}

function trigger.fun.TWO_WAY_MAX.two_way_max(heap: HeapType, current: ref, a: ref) returns (bool);
...
procedure TWO_WAY_MAX.in_observers(Current: ref, new_observers: Set (ref), o: ref) returns (Result: bool where true);
  free requires attached_exact(Heap, Current, TWO_WAY_MAX); // info:type property for argument Current
  free requires Set#ItemsType(Heap, new_observers, ANY); // info:type property for argument new_observers
  free requires Heap[o, allocated]; // info:type property for argument o
  modifies Heap;
  ...
  free requires global_permissive();
  free ensures global(Heap);
  requires Frame#Subset(modify.TWO_WAY_MAX.in_observers(Heap, Current, new_observers, o), writable); // type:pre tag:frame_writable
  free requires closed_under_domains(writable, Heap);
  free ensures same_outside(old(Heap), Heap, modify.TWO_WAY_MAX.in_observers(old(Heap), Current, new_observers, o));
  free ensures HeapSucc(old(Heap), Heap);
  free requires Frame#Subset(read.fun.TWO_WAY_MAX.in_observers(Heap, Current, new_observers, o), readable);



function fun.TWO_WAY_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

function fun0.TWO_WAY_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.TWO_WAY_MAX.in_observers(heap, current, new_observers, o) } { trigger.fun.TWO_WAY_MAX.in_observers(heap, current, new_observers, o) } (pre.fun.TWO_WAY_MAX.in_observers(heap, current, new_observers, o)) ==> ((fun.TWO_WAY_MAX.in_observers(heap, current, new_observers, o)) == (new_observers[o]))));

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: { fun.TWO_WAY_MAX.in_observers(heap, current, new_observers, o) } (fun.TWO_WAY_MAX.in_observers(heap, current, new_observers, o)) == (fun0.TWO_WAY_MAX.in_observers(heap, current, new_observers, o))));

axiom ((forall h: HeapType, h': HeapType, current: ref, new_observers: Set (ref), o: ref :: { HeapSucc(h, h'), fun0.TWO_WAY_MAX.in_observers(h, current, new_observers, o), fun0.TWO_WAY_MAX.in_observers(h', current, new_observers, o) } ((HeapSucc(h, h')) && (pre.fun.TWO_WAY_MAX.in_observers(h, current, new_observers, o)) && (pre.fun.TWO_WAY_MAX.in_observers(h', current, new_observers, o)) && (same_inside(h, h', read.fun.TWO_WAY_MAX.in_observers(h, current, new_observers, o)))) ==> ((fun0.TWO_WAY_MAX.in_observers(h, current, new_observers, o)) == (fun0.TWO_WAY_MAX.in_observers(h', current, new_observers, o)))));
...
axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T9> $o: ref, $f: Field T9 :: { modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap: HeapType, current: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref :: (IsHeap(heap)) ==> ((forall <T10> $o: ref, $f: Field T10 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.count(heap, current)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T11> $o: ref, $f: Field T11 :: { modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T12> $o: ref, $f: Field T12 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.item(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
function modify.TWO_WAY_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T15> $o: ref, $f: Field T15 :: { modify.TWO_WAY_MAX.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.TWO_WAY_MAX.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));

function read.fun.TWO_WAY_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (Frame);

axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T16> $o: ref, $f: Field T16 :: { read.fun.TWO_WAY_MAX.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.TWO_WAY_MAX.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));

function pre.fun.TWO_WAY_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool) {
  true
}

function trigger.fun.TWO_WAY_MAX.in_observers(heap: HeapType, current: ref, new_observers: Set (ref), o: ref) returns (bool);
...
axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T17> $o: ref, $f: Field T17 :: { modify.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f]) <==> (false)))));

function read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap: HeapType, current: ref, i: int) returns (Frame);

axiom ((forall heap: HeapType, current: ref, i: int :: (IsHeap(heap)) ==> ((forall <T18> $o: ref, $f: Field T18 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.valid_index(heap, current, i)[$o, $f]) <==> ((($o) == (current)) && (($f) != (closed)) && (($f) != (owner)))))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T19> $o: ref, $f: Field T19 :: { modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (modify.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> (false)))));
...
axiom ((forall heap: HeapType, current: ref, new_observers: Set (ref), o: ref :: (IsHeap(heap)) ==> ((forall <T20> $o: ref, $f: Field T20 :: { read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f] } (read.fun.SIMPLE_ARRAY^INTEGER_32^.in_observers(heap, current, new_observers, o)[$o, $f]) <==> ((universe[$o]) && (($f) != (closed)) && (($f) != (owner)))))));
